...
public class GS2GC_040_002_RetPeopleConfirmImmigrant implements ALBasicProtocolPack._IALProtocolStructure {
/** 确认移民数量 */
private long num;
/** 获取奖励物品列表 */
...
public GS2GC_040_002_RetPeopleConfirmImmigrant() {
	num = (long)0;
