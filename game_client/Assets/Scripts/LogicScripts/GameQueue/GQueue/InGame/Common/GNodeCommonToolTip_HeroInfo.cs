...
namespace GOE
{
    ...
    /// 骑士信息跟随窗口节点
    /// </summary>
    public class GNodeCommonToolTip_HeroInfo : BaseQueueNode
    {
        /// <summary>
        ...
        private GGUIWndCommonToolTip_HeroInfo _m_wndToolTip;
        private long _m_star;
        private long _m_heroId;


        public GNodeCommonToolTip_HeroInfo(long _assetPathId, long _heroId, long _star, RectTransform _targetTransRoot, float _intervalX, float _intervalY)
        ...
        public override void EnterNode()
        {
            ...
            {
                _m_wndToolTip = new GGUIWndCommonToolTip_HeroInfo(_m_sAssetPath, _m_sAssetName);
                _m_wndToolTip.load();
                _m_wndToolTip.regLoadDoneDelegate(() =>
                {
                    _m_wndToolTip.showWnd();
                    _m_wndToolTip.setInfo(_m_heroId, _m_star, _m_targetTransRoot, _m_intervalX, _m_intervalY);
                });
            }
