...
namespace GOE
{
    public class NPGNodeCommonToolTip_LazyCdItemDetail : BaseQueueNode
    {
        /// <summary>
        ...
        private NPGGUIWndCommonItemToolTip_LazyCdItemDetail _m_wndToolTip;

        public NPGNodeCommonToolTip_LazyCdItemDetail(long _assetPathId, long _itemId, RectTransform _targetTransRoot, float _interval)
        ...
        public override void EnterNode()
        {
            ...
            {
                _m_wndToolTip = new NPGGUIWndCommonItemToolTip_LazyCdItemDetail(_m_sAssetPath, _m_sAssetName);
                _m_wndToolTip.load();
                _m_wndToolTip.regLoadDoneDelegate(() =>
                {
                    _m_wndToolTip.setShowData(_m_itemId, _m_targetTransRoot, _m_interval);
                });
            }
