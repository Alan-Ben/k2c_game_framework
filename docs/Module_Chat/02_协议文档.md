...
```bash
# 抓取聊天协议
tcpdump -i any port 9000 -w chat_protocol.pcap

# 分析协议头
wireshark chat_protocol.pcap

# 过滤聊天模块协议
tcpdump -i any 'tcp port 9000 and (tcp[20:1] = 22)'
```
