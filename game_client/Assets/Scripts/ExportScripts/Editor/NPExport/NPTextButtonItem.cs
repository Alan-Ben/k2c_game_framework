...
namespace GOE
{
	public class NPTextButtonItem : _IALExportMenuInterface
	{
	    ...
	    public NPTextButtonItem(string _text, string _textBtn, Action _delegate)
	    {
	        _m_sText = _text;
	        _m_iHeight = 10;
	    ...
	    public NPTextButtonItem(string _text, int _height, string _textBtn, Action _delegate)
	    {
	        _m_sText = _text;
	        _m_iHeight = _height;
	        _m_sBtnText = _textBtn;
