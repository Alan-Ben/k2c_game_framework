...
public class GS2GC_007_029_RetGachaPublicRollRecord implements ALBasicProtocolPack._IALProtocolStructure {
/** 记录列表 */
private java.util.ArrayList<Common.GachaObj.Gacha_PublicRecordInfo> recordList;


public GS2GC_007_029_RetGachaPublicRollRecord() {
	recordList = new java.util.ArrayList<Common.GachaObj.Gacha_PublicRecordInfo>();
}

public GS2GC_007_029_RetGachaPublicRollRecord(
	 java.util.ArrayList<Common.GachaObj.Gacha_PublicRecordInfo> _recordList
...
/** 记录列表 */
public java.util.ArrayList<Common.GachaObj.Gacha_PublicRecordInfo> getRecordList() { return recordList; }
/** 记录列表 */
...
public final int GetBufSize() {
	...
	_size += 4 + recordList.get(_i).GetBufSize();
	}
