...
public class MjFellowAptitudeSkillLogBO extends MJEventLogBo {
    ...
    public static final int FIELD_f_lv =8;
    @DataBaseField(type = "int(11)", fieldname = "f_lv", comment = "伙伴等级")
    private int f_lv;

    public static final int FIELD_train_type =9;
    @DataBaseField(type = "int(11)", fieldname = "train_type", comment = "培养类型：1=资质；2=经营技能；3=等级")
    ...
    public static final int FIELD_before_attr =11;
    @DataBaseField(type = "int(11)", fieldname = "before_attr", comment = "变更前的属性值")
    private int before_attr;

    public static final int FIELD_final_attr =12;
    ...
    public MjFellowAptitudeSkillLogBO() {
        id = 0;
        cid = 0L;
        uid = "";
        vip_lv = 0;
    ...
    public MjFellowAptitudeSkillLogBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        uid = rs.getString(3);
        vip_lv = rs.getInt(4);
        ...
        event = rs.getInt(12);
        before_attr = rs.getInt(13);
        final_attr = rs.getInt(14);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new MjFellowAptitudeSkillLogBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `uid`, `vip_lv`, `server_id`, `platform`, `region`, `create_time`, `fid`, `f_lv`, `train_type`, `event`, `before_attr`, `final_attr`, `timestamp`";
    }

    @Override
    public String getTableName() {
        return "`mj_fellow_aptitude_skill_log`";
    }
    ...
    public String getItemsValue() {
        ...
        strBuf.append("'").append(f_lv).append("', ");
   ...
   @Override
    ...
    // 伙伴等级
    public int getFLv() { return this.f_lv; }
    public void setFLv(BM _bm, int f_lv) {
        if(f_lv==this.f_lv) 
            return;
        this.f_lv = f_lv; 
        markField(_bm, FIELD_f_lv); 
    }
    public void saveFLv(BM _bm, int f_lv) {
        if(f_lv==this.f_lv) 
            return;
        this.f_lv = f_lv;
        saveField(_bm, "f_lv", f_lv);
    }

    // 培养类型：1=资质；2=经营技能；3=等级
    ...
    protected String getUpdateKeyValue() {
        ...
        sBuilder.append(" `f_lv` = '").append(f_lv).append("',");
    ...
    public String getMarkedUpdateKeyValue() {
        ...
        if(isFieldMarked(FIELD_f_lv)) sBuilder.append(" `f_lv` = '").append(f_lv).append("',");
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `mj_fellow_aptitude_skill_log` ("
                ...
                + "`f_lv` int(11) NOT NULL DEFAULT '0' COMMENT '伙伴等级',"
                + "`train_type` int(11) NOT NULL DEFAULT '0' COMMENT '培养类型：1=资质；2=经营技能；3=等级',"
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='梦加日志-伙伴资质&经营技能变更记录' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
