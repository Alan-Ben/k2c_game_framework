...
public class Opt006002BagUseItemBO extends BaseOptLogBo {
    ...
    public static final int FIELD_item_id =7;
    @DataBaseField(type = "bigint(20)", fieldname = "item_id", comment = "物品id")
    private long item_id;

    public static final int FIELD_count =8;
    @DataBaseField(type = "bigint(20)", fieldname = "count", comment = "数量")
    private long count;

    public Opt006002BagUseItemBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt006002BagUseItemBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt006002BagUseItemBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `item_id`, `count`";
    }

    @Override
    public String getTableName() {
        return "`opt_006_002_bag_use_item`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_006_002_bag_use_item` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='玩家使用道具' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
