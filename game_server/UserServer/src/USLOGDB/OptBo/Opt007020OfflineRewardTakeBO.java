...
public class Opt007020OfflineRewardTakeBO extends BaseOptLogBo {
    ...
    public static final int FIELD_instance_id =7;
    @DataBaseField(type = "bigint(20)", fieldname = "instance_id", comment = "实例id")
    private long instance_id;

    public Opt007020OfflineRewardTakeBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt007020OfflineRewardTakeBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
        ...
        instance_id = rs.getLong(9);
    }

    @Override
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt007020OfflineRewardTakeBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `instance_id`";
    }

    @Override
    public String getTableName() {
        return "`opt_007_020_offline_reward_take`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_007_020_offline_reward_take` ("
