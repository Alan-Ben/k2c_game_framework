...
public class WCGConditionRangeNumberS extends _AWCGBasicSingleCondition
{
    ...
    {
        return EWCGSingleConditionType.RNG_NUM_S_COND;
    }

    public static WCGConditionRangeNumberS read(String _infoStr)
    {
        WCGConditionRangeNumberS obj = new WCGConditionRangeNumberS();
        ...
        {
            CommLog.error("条件配置错误 - RNG_NUM_S_COND example: enum:range:enemy_type Error Str: " + _infoStr);
            return null;
        }
    }
}
