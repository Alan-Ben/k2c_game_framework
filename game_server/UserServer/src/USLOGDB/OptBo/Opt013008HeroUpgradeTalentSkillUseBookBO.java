...
public class Opt013008HeroUpgradeTalentSkillUseBookBO extends BaseOptLogBo {
    ...
    public Opt013008HeroUpgradeTalentSkillUseBookBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt013008HeroUpgradeTalentSkillUseBookBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt013008HeroUpgradeTalentSkillUseBookBO(rs));
    }
    ...
    public String getTableName() {
        return "`opt_013_008_hero_upgrade_talent_skill_use_book`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_013_008_hero_upgrade_talent_skill_use_book` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='大臣-大臣升级天赋技能（使用书）' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
