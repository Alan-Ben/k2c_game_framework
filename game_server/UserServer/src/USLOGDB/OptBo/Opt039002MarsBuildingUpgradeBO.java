...
public class Opt039002MarsBuildingUpgradeBO extends BaseOptLogBo {
    ...
    public Opt039002MarsBuildingUpgradeBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt039002MarsBuildingUpgradeBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt039002MarsBuildingUpgradeBO(rs));
    }
    ...
    public String getTableName() {
        return "`opt_039_002_mars_building_upgrade`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_039_002_mars_building_upgrade` ("
