...
namespace GOE
{
    ...
    /// </summary>
    [System.Serializable]
    public class GGUIMonoMiddayDungeonRankSpecialShow
    {
        [ALHeader("排名")]
        public long rank;
        [ALHeader("需要特殊展示的GO")]
    ...
    /// 宴会排行榜列表item
    /// </summary>
    public class GGUIMonoMiddayDungeonRankGridItem : _TALUGUIMonoGridItem
    {
        [ALHeader("头像")]
        public NPGGUIMonoPlayerIcon monoPlayerIcon;
        [ALHeader("需要特殊展示的排名列表")]
        public List<GGUIMonoMiddayDungeonRankSpecialShow> specialRankShowList;
        [ALHeader("排名")]
        public Text txtRank;
        [ALHeader("影响力")]
