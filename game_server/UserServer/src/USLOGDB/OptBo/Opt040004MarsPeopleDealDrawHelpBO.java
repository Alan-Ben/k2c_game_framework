...
public class Opt040004MarsPeopleDealDrawHelpBO extends BaseOptLogBo {
    ...
    public Opt040004MarsPeopleDealDrawHelpBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt040004MarsPeopleDealDrawHelpBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt040004MarsPeopleDealDrawHelpBO(rs));
    }
    ...
    public String getTableName() {
        return "`opt_040_004_mars_people_deal_draw_help`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_040_004_mars_people_deal_draw_help` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='火星-处理帮助事件（奖励）' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
