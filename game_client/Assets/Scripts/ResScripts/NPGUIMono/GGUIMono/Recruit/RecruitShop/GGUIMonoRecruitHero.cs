...
namespace GOE
{
    ...
    /// 大臣招募窗口
    /// </summary>
    public class GGUIMonoRecruitHero : _AALBasicUIWndMono
    {
        [ALHeader("伙伴名字")]
         ...
         * 资源加载路径
         */
        public static string assetPath { get { return UIResPathAssistant.getAssetPath(2704); } }
        public static string objName { get { return UIResPathAssistant.getObjName(2704);} }
    }
}