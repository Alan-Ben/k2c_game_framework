package MarryMatchServer.NPGeneralListener;
...
public class MarryMatchBasicServerListener extends _AWCGBSReceiverListener
{
    public MarryMatchBasicServerListener(_AWCGBasicServer _server, EServerType _serverType, int _serverTypeId)
    {
    ...
    {
        MarryMatchGeneralMsgDispather.getInstance().DealProtocol(this, _buf);
    }
    ...
    {
        MarryMatchGeneralRequestDispather.getInstance().DealProtocol(_commiter, _buf);
    }
