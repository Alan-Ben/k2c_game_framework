...
public class  MsgDealer_GC2GS_008_009_ReqDealConsortIntimacyTravel extends NPUserMsgDealer<GC2GS_008_009_ReqDealConsortIntimacyTravel>
{
    @Override
    protected void _dealMessage(_ANPUSUserBasicMsgItem _commiter, GC2GS_008_009_ReqDealConsortIntimacyTravel _msg)
    {
        ...
        //处理游历事件数据
        TravelEventDealerResult result = TravelEventDealerMgr.getInstance().dealEvent(ETravelEventType.CONSORT_INTIMACY, info, _msg, context);
        if(!result.isSucc())
        {
        ...
        _commiter.commitSucRes(US2GCWriter_008_TravelOp.make_009_RetDealConsortIntimacyTravel(result.getEventResult()));
