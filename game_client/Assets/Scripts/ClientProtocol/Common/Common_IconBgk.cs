...
public class Common_IconBgk : ALBasicProtocolPack._IALProtocolStructure {
...
public override string ToString() {
	...
	builder.Append("leftTimeS").Append(":").Append(leftTimeS.ToString()).Append(", ");
	builder.Append("}");
