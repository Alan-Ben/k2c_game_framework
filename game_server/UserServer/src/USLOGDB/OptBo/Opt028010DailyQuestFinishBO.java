...
public class Opt028010DailyQuestFinishBO extends BaseOptLogBo {
    ...
    public Opt028010DailyQuestFinishBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
        ...
        quest_id = rs.getLong(9);
        refresh_serial = rs.getLong(10);
    }

    @Override
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt028010DailyQuestFinishBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `quest_id`, `refresh_serial`";
    }

    @Override
    public String getTableName() {
        return "`opt_028_010_daily_quest_finish`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_028_010_daily_quest_finish` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='日常任务-玩家领取完成奖励' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
