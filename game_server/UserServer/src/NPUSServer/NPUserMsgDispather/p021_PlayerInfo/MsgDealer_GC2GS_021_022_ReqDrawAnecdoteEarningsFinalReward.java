...
public class MsgDealer_GC2GS_021_022_ReqDrawAnecdoteEarningsFinalReward extends NPUserMsgDealer<GC2GS_021_022_ReqDrawAnecdoteEarningsFinalReward>
{
    @Override
    protected void _dealMessage(_ANPUSUserBasicMsgItem _commiter, GC2GS_021_022_ReqDrawAnecdoteEarningsFinalReward _msg)
    {
        ...
        Result result = earningsEvent.drawFinalReward(context);
        if (!result.isSucc())
        {
        ...
        _commiter.commitSucRes(US2GCWriter_021_PlayerInfo.make_022_RetDrawAnecdoteEarningsFinalReward(context));
    }
}
