...
namespace GOE
{
    ...
    /// 宴会相关入口场景节点
    /// </summary>
    public class MainAdditionDinnerEntryTDScene : _ABaseHomeEntryAdditionTDScene
    {
        private static MainAdditionDinnerEntryTDScene _g_instance;
        [NotNull] public static MainAdditionDinnerEntryTDScene instance { get { return _g_instance ??= new MainAdditionDinnerEntryTDScene(); } }
