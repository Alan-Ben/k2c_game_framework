 ...
 * 获取US的所有当前排期数据
 **/
public class NP2SS_R_001_011_GetUsActivityScheduleList implements ALBasicProtocolPack._IALProtocolStructure {
private int usId;


public NP2SS_R_001_011_GetUsActivityScheduleList() {
	usId = 0;
}
