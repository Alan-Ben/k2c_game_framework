...
{
    unsafe class System_Collections_Generic_List_1_GOE__AGGUIHotfixBasicSubWndAdapter_Binding_Adapter_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.List<GOE._AGGUIHotfixBasicSubWndAdapter.Adapter>);
            args = new Type[]{};
            ...
            args = new Type[]{typeof(System.Int32), typeof(GOE._AGGUIHotfixBasicSubWndAdapter.Adapter)};
        ...
        static StackObject* get_Count_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Collections.Generic.List<GOE._AGGUIHotfixBasicSubWndAdapter.Adapter> instance_of_this_method = (System.Collections.Generic.List<GOE._AGGUIHotfixBasicSubWndAdapter.Adapter>)typeof(System.Collections.Generic.List<GOE._AGGUIHotfixBasicSubWndAdapter.Adapter>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* Add_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            GOE._AGGUIHotfixBasicSubWndAdapter.Adapter @item = (GOE._AGGUIHotfixBasicSubWndAdapter.Adapter)typeof(GOE._AGGUIHotfixBasicSubWndAdapter.Adapter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* RemoveAt_4(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* set_Item_7(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            GOE._AGGUIHotfixBasicSubWndAdapter.Adapter @value = (GOE._AGGUIHotfixBasicSubWndAdapter.Adapter)typeof(GOE._AGGUIHotfixBasicSubWndAdapter.Adapter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Collections.Generic.List<GOE._AGGUIHotfixBasicSubWndAdapter.Adapter>(@capacity);
        ...
        static StackObject* Ctor_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Collections.Generic.List<GOE._AGGUIHotfixBasicSubWndAdapter.Adapter>();
