...
public class Opt039004MarsBuildingDispatchPeopleBO extends BaseOptLogBo {
    ...
    public static final int FIELD_people_num =8;
    @DataBaseField(type = "int(11)", fieldname = "people_num", comment = "派遣居民数量")
    private int people_num;

    public Opt039004MarsBuildingDispatchPeopleBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt039004MarsBuildingDispatchPeopleBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
        ...
        people_num = rs.getInt(10);
    }

    @Override
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt039004MarsBuildingDispatchPeopleBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `building_id`, `people_num`";
    }

    @Override
    public String getTableName() {
        return "`opt_039_004_mars_building_dispatch_people`";
    }
    ...
    public String getItemsValue() {
        ...
        strBuf.append("'").append(people_num).append("', ");
   ...
   @Override
    ...
    // 派遣居民数量
    public int getPeopleNum() { return this.people_num; }
    public void setPeopleNum(BM _bm, int people_num) {
        if(people_num==this.people_num) 
            return;
        this.people_num = people_num; 
        markField(_bm, FIELD_people_num); 
    }
    public void savePeopleNum(BM _bm, int people_num) {
        if(people_num==this.people_num) 
            return;
        this.people_num = people_num;
        saveField(_bm, "people_num", people_num);
    }
    ...
    protected String getUpdateKeyValue() {
        ...
        sBuilder.append(" `people_num` = '").append(people_num).append("',");
    ...
    public String getMarkedUpdateKeyValue() {
        ...
        if(isFieldMarked(FIELD_people_num)) sBuilder.append(" `people_num` = '").append(people_num).append("',");
        sBuilder.deleteCharAt(sBuilder.length() - 1);
        return sBuilder.toString();
    }
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_039_004_mars_building_dispatch_people` ("
                ...
                + "`people_num` int(11) NOT NULL DEFAULT '0' COMMENT '派遣居民数量',"
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='火星-派遣火星居民' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
