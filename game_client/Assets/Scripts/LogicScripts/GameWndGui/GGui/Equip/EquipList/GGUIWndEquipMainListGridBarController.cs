...
namespace GOE
{
    ...
    /// 藏品列表bar控制器
    /// </summary>
    public class GGUIWndEquipMainListGridBarController : _AALUGUIGridBarController
    {
        private GGUIWndEquipMainListGridBar _m_wBarWnd;//显示的窗体

        public GGUIWndEquipMainListGridBarController(Transform _parent) : base()
        {
            _m_wBarWnd = new GGUIWndEquipMainListGridBar(_parent);
            _m_wBarWnd.load();
        }
