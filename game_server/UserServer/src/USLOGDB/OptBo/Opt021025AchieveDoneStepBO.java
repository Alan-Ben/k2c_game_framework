...
public class Opt021025AchieveDoneStepBO extends BaseOptLogBo {
    ...
    public Opt021025AchieveDoneStepBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt021025AchieveDoneStepBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt021025AchieveDoneStepBO(rs));
    }
    ...
    public String getTableName() {
        return "`opt_021_025_achieve_done_step`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_021_025_achieve_done_step` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='玩家完成成就阶段' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
