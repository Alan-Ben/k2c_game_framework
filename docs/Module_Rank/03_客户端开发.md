...
namespace GOE
{
    ...
    {
        /// <summary>
        /// 是否有公会在排行榜中（用于公会榜单红点判断）
        /// Key: rankFixedId, Value: 是否有公会在榜
        /// </summary>
        ...
        /// <summary>
        /// 是否允许提前初始化
        /// 提前初始化的意思是在依赖项没有完成初始化之前就进行初始化操作
        /// </summary>
...
public void reqRankFixedLike(
    long _rankFixedId,
    Action<Common.RankObj.RankFixed_LikeResult> _callBack)
{
    NPGSClientListener.sendRequestByLog(
...
public void reqRankFixedAKeyLike(
    ...
    Action<List<Common.RankObj.RankFixed_LikeResult>> _callBack)
{
    NPGSClientListener.sendRequestByLog(
...
public void reqInRankPlayerInfoByRank(
    long _rankFixedId,
    int _rank,
    Action<Common.RankObj.Rank_BaseItem> _callBack)
{
    NPGSClientListener.sendRequestByLog(
...
{
    NPGSClientListener.sendRequestByLog(
        GSWriter_031_RankOp.make_003_ReqRankFixedLikeScore(_rankFixedId, _cid),
...
```csharp
// 查询某玩家的点赞积分
NPRankCommonComponent.instance.reqRankLikeScore(1001, 20001, (likeScore) =>
{
    Debug.Log($"玩家 20001 的点赞积分: {likeScore}");
});
```
...
/// 是否有联盟在排行榜中
/// </summary>
/// <param name="_rankFixId">榜单实例ID</param>
/// <returns>是否有公会在榜单中</returns>
...
/// </summary>
/// <param name="_rankFixId">榜单实例ID</param>
/// <param name="_hasGuild">是否有公会</param>
...
/// 冷却时间变化回调
/// </summary>
private void _onFixedCDChg(params object[] args)
{
    // 刷新红点
    NPRankCommonComponent.instance.refreshRedTip();
...
public class RankItem : MonoBehaviour
{
    ...
    /// 获取排名图标
    /// </summary>
    private Sprite GetRankIcon(int rank)
    {
        string iconPath = $"UI/Icon/Rank/rank_{rank}";
