...
public class GS2GC_002_034_RetTargetRewardInit implements ALBasicProtocolPack._IALProtocolStructure {
/** 目标奖励信息列表 */
private java.util.ArrayList<Common.CommonFuncObj.CommonFunc_TargetReward> infoList;


public GS2GC_002_034_RetTargetRewardInit() {
	infoList = new java.util.ArrayList<Common.CommonFuncObj.CommonFunc_TargetReward>();
}

public GS2GC_002_034_RetTargetRewardInit(
	 java.util.ArrayList<Common.CommonFuncObj.CommonFunc_TargetReward> _infoList
) {	infoList = _infoList;
}
...
/** 目标奖励信息列表 */
public java.util.ArrayList<Common.CommonFuncObj.CommonFunc_TargetReward> getInfoList() { return infoList; }
/** 目标奖励信息列表 */
