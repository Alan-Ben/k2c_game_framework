...
{
    @Override
    protected void _dealMessage(_ANPUSUserBasicMsgItem _commiter, GC2GS_002_041_ReqRecruitInfo _msg)
    {
        ...
        //返回数据
        _commiter.commitSucRes(US2GCWriter_002_InitOp.make_041_RetRecuritInfo(userData));
    }
}
