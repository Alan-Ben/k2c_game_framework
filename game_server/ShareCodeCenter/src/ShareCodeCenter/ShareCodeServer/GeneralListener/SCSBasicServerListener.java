package ShareCodeCenter.ShareCodeServer.GeneralListener;
...
public class SCSBasicServerListener extends _AWCGBSReceiverListener
{
    public SCSBasicServerListener(_AWCGBasicServer _server, EServerType _serverType, int _serverTypeId)
    {
    ...
    {
        SCSGeneralMsgDispatcher.getInstance().DealProtocol(this, _buf);
    }
    ...
    {
        SCSGeneralRequestDispather.getInstance().DealProtocol(_commiter, _buf);
    }
