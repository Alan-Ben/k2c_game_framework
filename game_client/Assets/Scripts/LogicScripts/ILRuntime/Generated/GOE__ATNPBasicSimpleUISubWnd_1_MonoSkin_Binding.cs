...
{
    unsafe class GOE__ATNPBasicSimpleUISubWnd_1_MonoSkin_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(GOE._ATNPBasicSimpleUISubWnd<GOE.MonoSkin>);
            args = new Type[]{};
            ...
            app.RegisterCLRMethodRedirection(method, resetWnd_4);
            args = new Type[]{};
            ...
            app.RegisterCLRMethodRedirection(method, get_rectTransform_6);
        ...
        static StackObject* get_wnd_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            GOE._ATNPBasicSimpleUISubWnd<GOE.MonoSkin> instance_of_this_method = (GOE._ATNPBasicSimpleUISubWnd<GOE.MonoSkin>)typeof(GOE._ATNPBasicSimpleUISubWnd<GOE.MonoSkin>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* resetWnd_4(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* get_rectTransform_6(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
