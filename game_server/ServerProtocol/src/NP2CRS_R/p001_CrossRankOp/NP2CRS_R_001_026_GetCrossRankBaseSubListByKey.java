 ...
 * 2级排行榜子数据列表
 **/
public class NP2CRS_R_001_026_GetCrossRankBaseSubListByKey implements ALBasicProtocolPack._IALProtocolStructure {
/** 跨服分组ID */
...
public NP2CRS_R_001_026_GetCrossRankBaseSubListByKey() {
