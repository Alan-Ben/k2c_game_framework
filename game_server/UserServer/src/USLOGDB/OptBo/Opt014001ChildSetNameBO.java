...
public class Opt014001ChildSetNameBO extends BaseOptLogBo {
    ...
    public static final int FIELD_curName =8;
    @DataBaseField(type = "varchar(500)", fieldname = "curName", comment = "设置的子嗣名称")
    private String curName;

    public Opt014001ChildSetNameBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt014001ChildSetNameBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
        ...
        curName = rs.getString(10);
    }

    @Override
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt014001ChildSetNameBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `childId`, `curName`";
    }

    @Override
    public String getTableName() {
        return "`opt_014_001_child_set_name`";
    }
    ...
    public String getItemsValue() {
        ...
        strBuf.append("'").append(curName == null ? null : curName.replace("'","''").replace("\\","\\\\")).append("', ");
   ...
   @Override
    ...
    // 设置的子嗣名称
    public String getCurName() { return this.curName; }
    public void setCurName(BM _bm, String curName) {
        if(curName.equals(this.curName)) 
            return;
        this.curName = curName; 
        markField(_bm, FIELD_curName); 
    }
    public void saveCurName(BM _bm, String curName) {
        if(curName.equals(this.curName)) 
            return;
        this.curName = curName;
        saveField(_bm, "curName", curName);
    }
    ...
    protected String getUpdateKeyValue() {
        ...
        sBuilder.append(" `curName` = '").append(curName == null ? null : curName.replace("'","''").replace("\\","\\\\")).append("',");
    ...
    public String getMarkedUpdateKeyValue() {
        ...
        if(isFieldMarked(FIELD_curName)) sBuilder.append(" `curName` = '").append(curName == null ? null : curName.replace("'","''").replace("\\","\\\\")).append("',");
        sBuilder.deleteCharAt(sBuilder.length() - 1);
        return sBuilder.toString();
    }
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_014_001_child_set_name` ("
                ...
                + "`curName` varchar(500) NOT NULL DEFAULT '' COMMENT '设置的子嗣名称',"
                + "PRIMARY KEY (`id`)"
    ...
    private int getBufferSize()
    {
        ...
        _size+=4;//timestamp
        _size+=8;//childId
        _size += ALBasicProtocolPack.ALProtocolCommon.GetStringBufSize(curName);//curName
         return _size;
    }
    ...
    public ByteBuffer toByteBuffer()
    {
        ...
        ALBasicProtocolPack.ALProtocolCommon.PutStringIntoBuf(buff, curName);        
        return buff;
    }
    ...
    protected void readFromByteBuffer(ByteBuffer buff)
    {
        ...
        curName=ALBasicProtocolPack.ALProtocolCommon.GetStringFromBuf(buff); 
    }
