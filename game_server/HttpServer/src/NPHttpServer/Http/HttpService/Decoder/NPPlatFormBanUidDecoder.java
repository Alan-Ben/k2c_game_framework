 ...
 */
public class NPPlatFormBanUidDecoder extends _ANPPlatFormHttpDataDecoder<NPEntityBanUidList>
{
    //////单例的//////
    private static final NPPlatFormBanUidDecoder _s_instance = new NPPlatFormBanUidDecoder();

    public static NPPlatFormBanUidDecoder getInstance()
    {
        return _s_instance;
    }

    private NPPlatFormBanUidDecoder()
    {
    }
