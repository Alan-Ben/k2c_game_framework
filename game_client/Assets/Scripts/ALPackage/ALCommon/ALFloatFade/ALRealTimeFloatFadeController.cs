 ...
 * 浮点数过度的控制与计算对象
 **/
public class ALRealTimeFloatFadeController
{
    /** 开始数值 */
    ...
    /// <param name="_variableInfo">浮点过度效果的参数结构体</param>
    public ALRealTimeFloatFadeController(float _startNum, float _targetNum, ALFloatFadeTimeInfo _variableInfo)
    {
    ...
    public ALRealTimeFloatFadeController(float _startNum, float _targetNum, float _srcSpeed, float _totalTime, float _firstAccSpeedTime)
    {
        _m_fBinValue = _startNum;
        _m_fTargetValue = _targetNum;
    ...
    /// <param name="_targetNum">目标数值</param>
    /// <param name="_variableInfo">浮点过度效果的参数结构体,</param>
    /// <param name="_startTime">开始运动的时间标记</param>
    public ALRealTimeFloatFadeController(float _startNum, float _targetNum, ALFloatFadeTimeInfo _variableInfo, float _startTime)
    {
        _m_fBinValue = _startNum;
        _m_fTargetValue = _targetNum;
    ...
    /// <param name="_firstAccSpeedTime">过渡过程的加速时间</param>
    /// <param name="_startTime">开始运动的时间标记</param>
    public ALRealTimeFloatFadeController(float _startNum, float _targetNum, float _srcSpeed, float _totalTime, float _firstAccSpeedTime, float _startTime)
    {
        _m_fBinValue = _startNum;
        _m_fTargetValue = _targetNum;
    ...
    {
        resetVariables(_startNum, _targetNum, _srcSpeed, _totalTime, _firstAccSpeedTime, Time.realtimeSinceStartup);
    }
    public void resetVariables(float _startNum, float _targetNum, float _srcSpeed, float _totalTime, float _firstAccSpeedTime, float _startTimeTag)
    {
        _m_fBinValue = _startNum;
        _m_fTargetValue = _targetNum;

        _m_fStartTimeTag = _startTimeTag;
