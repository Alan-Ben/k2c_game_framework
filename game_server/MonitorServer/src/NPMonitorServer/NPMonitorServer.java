...
import WCGBasicMonitorServer.BasicServerListener.OtherBasicServerListener;
 ...
 *
 */
public class NPMonitorServer extends _AWCGBasicMonitorServer
{
    /**
     * 每个服务器通用的钉钉报警对象
     */
     ...
     */
    @Override
    public void dealUndealSenderMsg(OtherBasicServerListener _basicServerListener, ByteBuffer _buf)
    {
     ...
     */
    @Override
    public void dealUndealSenderRequest(OtherBasicServerListener _basicServerListener, _IWCGBasicRequestCommiter _commiter, ByteBuffer _buf)
    {
    ...
    {
        NPMSMonitorInfo monitorInfo = new NPMSMonitorInfo();
        ...
        monitorInfo.setServerTypeId(10000);
