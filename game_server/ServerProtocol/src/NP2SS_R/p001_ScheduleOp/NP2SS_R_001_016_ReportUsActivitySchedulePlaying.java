 ...
 * US上报活动开启
 **/
public class NP2SS_R_001_016_ReportUsActivitySchedulePlaying implements ALBasicProtocolPack._IALProtocolStructure {
private int usId;
/** 排期ID */
...
public NP2SS_R_001_016_ReportUsActivitySchedulePlaying() {
	usId = 0;
	scheduleId = (long)0;
	usGroupId = (long)0;
}
