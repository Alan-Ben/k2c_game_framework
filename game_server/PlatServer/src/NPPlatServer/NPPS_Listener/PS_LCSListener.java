...
public class PS_LCSListener extends _ANPPSBasicServerListener
{
    private static PS_LCSListener _g_instance = null;

    public static PS_LCSListener getObj()
    {
        return _g_instance;
    }
    ...
    public PS_LCSListener()
    {
        super(EServerType.SINGLE, ENPSingleServerType.LOGIN_CHECK.ordinal());
    }

    @Override
    public void login()
    {
        ALServerLog.Sys("Login Check Server: " + getServerTypeId() + " Login!");
        //设置全局变量
        _g_instance = this;
    }
    ...
    {
        ALServerLog.Sys("Login Check Server: " + getServerTypeId() + " Disconnect!");
        //设置全局变量
        if (_g_instance == this)
            _g_instance = null;
    }
