...
public class CTSGetTeamPlayerApplyList_Return implements ALBasicProtocolPack._IALProtocolStructure {
private java.util.ArrayList<Common.CrossTeamObj.CrossTeam_PlayerApplyInfo> applyList;


public CTSGetTeamPlayerApplyList_Return() {
	applyList = new java.util.ArrayList<Common.CrossTeamObj.CrossTeam_PlayerApplyInfo>();
}

public CTSGetTeamPlayerApplyList_Return(
	 java.util.ArrayList<Common.CrossTeamObj.CrossTeam_PlayerApplyInfo> _applyList
...
public java.util.ArrayList<Common.CrossTeamObj.CrossTeam_PlayerApplyInfo> getApplyList() { return applyList; }
