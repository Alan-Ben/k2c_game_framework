 ...
 */
public class NPPlatFormUnBanCidListDecoder extends _ANPPlatFormHttpDataDecoder<NPEntityBanCidList>
{
    //////单例的//////
    private static final NPPlatFormUnBanCidListDecoder _s_instance = new NPPlatFormUnBanCidListDecoder();

    public static NPPlatFormUnBanCidListDecoder getInstance()
    {
        return _s_instance;
    }

    private NPPlatFormUnBanCidListDecoder()
    {
    }
