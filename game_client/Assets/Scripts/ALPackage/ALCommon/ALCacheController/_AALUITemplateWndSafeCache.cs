...
/// 模板窗口cache管理对象
/// </summary>
public abstract class _AALUITemplateWndSafeCache<T_W, T_M> : _AALCacheController<T_W, T_M>
    ...
    where T_W : _ATALBasicUISubWnd<T_M>
{
    ...
    public _AALUITemplateWndSafeCache(Transform _parentTrans, int _minCount, int _maxCount, int _addUnit)
