 ...
 */
public class NPHSMonitorInfo extends _ANPServerBasicMonitorInfo
{
    /**
     * 当前配表的版本号
     */
    ...
    protected JsonElement __makeSubJson()
    {
        ...
        jsObj.addProperty("areaId", HttpServerConf.getInstance().getPlatAreaId());
        jsObj.addProperty("platFormId", HttpServerConf.getInstance().getPlatformId());
        jsObj.addProperty("platUrl", HttpServerConf.getInstance().getPlatUrl());
