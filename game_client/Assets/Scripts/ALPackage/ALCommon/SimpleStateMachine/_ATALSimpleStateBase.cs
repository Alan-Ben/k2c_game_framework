...
namespace ALPackage
{
    ...
    /// </remarks>
    public abstract class _ATALSimpleStateBase<T> where T : Enum
    {
        ...
        protected _ATALSimpleStateBase()
        {
    ...
    /// 切换到这个状态不需要参数
    /// </remarks>
    public abstract class _ASimpleState<T> : _ATALSimpleStateBase<T> where T : Enum
    {
        internal void enter()
        {
            _onEnter();
    ...
    /// 切换到这个状态需要一个参数
    /// </remarks>
    public abstract class _ASimpleState<T, PARAM> : _ATALSimpleStateBase<T> where T : Enum
    {
    ...
    /// 切换到这个状态需要两个参数
    /// </remarks>
    public abstract class _ASimpleState<T, PARAM_1, PARAM_2> : _ATALSimpleStateBase<T> where T : Enum
    {
    ...
    /// 切换到这个状态需要三个参数
    /// </remarks>
    public abstract class _ASimpleState<T, PARAM_1, PARAM_2, PARAM_3> : _ATALSimpleStateBase<T> where T : Enum
    {
    ...
    /// 切换到这个状态需要四个参数
    /// </remarks>
    public abstract class _ASimpleState<T, PARAM_1, PARAM_2, PARAM_3, PARAM_4> : _ATALSimpleStateBase<T> where T : Enum
    {
