...
import Hotfix.V01.GC2GS.p201_TileMatchOp.GC2GS_201_003_ReqTileMatchGameOver;
...
public class MsgDealer_GC2GS_201_003_ReqTileMatchGameOver extends NPUserMsgDealer<GC2GS_201_003_ReqTileMatchGameOver>
{
    @Override
    protected void _dealMessage(_ANPUSUserBasicMsgItem _committer, GC2GS_201_003_ReqTileMatchGameOver _msg)
    {
        ...
        //执行逻辑
        Result runResult = gameInfo.checkGameOver(userData, context);
        if (!runResult.isSucc())
        {
        ...
        _committer.commitSucRes(US2GCWriter_201_TileMatchOp.make_003_RetTileMatchGameOver(gameInfo.makeBlockProto()));
    }
}
