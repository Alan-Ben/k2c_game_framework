...
public class PS_ISListener extends _ANPPSBasicServerListener
{
    private static PS_ISListener _g_instance = null;

    public static PS_ISListener getObj()
    {
        return _g_instance;
    }
    ...
    public PS_ISListener()
    {
        super(EServerType.SINGLE, ENPSingleServerType.INTERFACE.ordinal());
    }
    ...
    public void login()
    {
        ...
        ALServerLog.Sys("Interface Server: " + getServerTypeId() + " Login!");
        _g_instance = this;
    }
    ...
    {
        ALServerLog.Sys("Interface Server: " + getServerTypeId() + " Disconnect!");
        //设置全局变量
        _g_instance = null;
    }
