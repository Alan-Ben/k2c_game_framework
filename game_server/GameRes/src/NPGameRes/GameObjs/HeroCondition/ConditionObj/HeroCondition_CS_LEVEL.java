...
public class HeroCondition_CS_LEVEL extends _ABasicHeroCondition
{
    ...
    public static HeroCondition_CS_LEVEL readCond(NPStringReader _reader)
    {
        ...
        if (null == minVS)
        {
            CommLog.error("Can not read str for EHeroConditionType.CS_LEVEL[" + _reader.getSrcString() + "]");
            return null;
        }
