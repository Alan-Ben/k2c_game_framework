...
namespace GOE
{
    public class GGUISubWndInnGuestListSpecialPageGridItem : _ATALUGUIBasicGridItemWnd<GGUIMonoInnGuestListSpecialPageGridItem>
    {
        private InnSpecialGuestHandbookInfo _m_guestInfo;
        private NPGGuiWndTexture _m_iconWnd;
        
        
        public GGUISubWndInnGuestListSpecialPageGridItem(GGUIMonoInnGuestListSpecialPageGridItem _wnd) 
            : base(_wnd)
        {
            initWnd();
        }
        ...
        private void _onBtnGetRewardClick(GameObject _)
        {
            ...
            NPGSClientListener.sendMsgByLog(new GC2GS_034_011_ReqDrawSpecialGuestHandbookReward(_m_guestInfo.guestId));
        }
        private void _onBtnDetailClick(GameObject _)
        {
            ...
            GGUIWndInnSpecialGuestInfo.instance.refreshWnd(_m_guestInfo);
            QueueMgr.instance.addNode_InGame_SingleWnd(GGUIWndInnSpecialGuestInfo.instance, GGUIWndInnSpecialGuestInfo.instance.showWnd, UINodeTagConst.C_INN_SPECIAL_GUEST_INFO);
        }
    }
}