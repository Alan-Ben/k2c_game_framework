...
{
    /** 窗口对象加载处理对象 */
    public class ALLocalResLoaderMgr
    {
        private static ALLocalResLoaderMgr _g_instance = new ALLocalResLoaderMgr();
        public static ALLocalResLoaderMgr instance
        {
            get
            {
                if (null == _g_instance)
                    _g_instance = new ALLocalResLoaderMgr();
        ...
        private bool _m_bUseLocalVideo;
        ...
        public bool isLoadVideoFromLocal { get { return _m_bUseLocalVideo; } }
        ...
        /** 从本地加载UI */
        public void setLoadFromLocal(string _localResRootPath, bool _useLocalUI, bool _useLocalGameObject, bool _useLocalScene, bool _useLocalRefdata, bool _useLocalVideo
#if AL_ILRUNTIME
            ...
            , bool _ifLocalDisableUseRemote)
        {
            ...
            _m_bUseLocalVideo = _useLocalVideo;
        ...
        public void loadUIAsset(string _assetPath, string _objName, _assetDownloadedDelegate _delegate, _assetDownloadedDelegate _lateDelegate, Action<GameObject> _localLoadDelegate, _AALResourceCore _resourceCore)
        {
            ...
            else
            {
                ...
                {
                    UnityEngine.Debug.LogError("加载" + _resourceCore.ToString() + "本地资源: " + _assetPath.Replace(".unity3d", "") + "/" + _objName + " 失败！");
        ...
        public void loadGameObjectAsset(string _assetPath, string _objName, _assetDownloadedDelegate _delegate, _assetDownloadedDelegate _lateDelegate, Action<GameObject> _localLoadDelegate, _AALResourceCore _resourceCore)
        {
            ...
            else
            {
                ...
                {
                    UnityEngine.Debug.LogError("加载" + _resourceCore.ToString() + "本地资源T: " + _assetPath.Replace(".unity3d", "") + "/" + _objName + " 失败！");
        ...
        public void loadRefdataGameObjectAsset(string _assetPath, string _objName, _assetDownloadedDelegate _delegate, _assetDownloadedDelegate _lateDelegate, Action<GameObject> _localLoadDelegate, _AALResourceCore _resourceCore)
        {
            ...
            where T : UnityEngine.Object
        {
            ...
            else
            {
                ...
                {
                    UnityEngine.Debug.LogError("加载" + _resourceCore.ToString() + "本地资源T: " + _assetPath.Replace(".unity3d", "") + "/" + _objName + _exname + " 失败！");
         ...
         * 加载本地资源对象的处理函数
         **/
        public void loadRefdataObjAsset<T>(string _assetPath, string _objName, _assetDownloadedDelegate _delegate, _assetDownloadedDelegate _lateDelegate, Action<UnityEngine.Object> _localLoadDelegate, _AALResourceCore _resourceCore)
            where T : UnityEngine.Object
        {
            if(null == _resourceCore)
            {
#if UNITY_EDITOR
                UnityEngine.Debug.LogError("加载" + _assetPath + "本地Refdata: " + "/" + _assetPath.Replace(".unity3d", "") + " 失败！");
#endif
                if(null != _delegate)
                {
            ...
            else
            {
                ...
                {
                    UnityEngine.Debug.LogError("加载" + _resourceCore.ToString() + "本地Refdata: " + "/" + _assetPath.Replace(".unity3d", "") + "/" + _objName + " 失败！");
        ...
        public void loadSynRefdataObjAsset<T>(string _assetPath, string _objName, _assetDownloadedDelegate _delegate, _assetDownloadedDelegate _lateDelegate, Action<UnityEngine.Object> _localLoadDelegate, _AALResourceCore _resourceCore)
            where T : UnityEngine.Object
        {
            if(null == _resourceCore)
            {
        ...
        public void loadTextAsset(string _assetPath, string _objName, _assetDownloadedDelegate _delegate, _assetDownloadedDelegate _lateDelegate, Action<UnityEngine.Object> _localLoadDelegate, _AALResourceCore _resourceCore)
        {
            if(null == _resourceCore)
            {
#if UNITY_EDITOR
                UnityEngine.Debug.LogError("加载" + _assetPath + "本地TextAsset: " + "/" + _assetPath.Replace(".unity3d", "") + " 失败！");
#endif
                if(null != _delegate)
                {
                    _delegate(false, null);
            ...
            else
            {
                ...
                {
                    UnityEngine.Debug.LogError("加载" + _resourceCore.ToString() + "本地TextAsset: " + "/" + _assetPath.Replace(".unity3d", "") + "/" + _objName + " 失败！");
        ...
        public void loadSynTextAsset(string _assetPath, string _objName, _assetDownloadedDelegate _delegate, _assetDownloadedDelegate _lateDelegate, Action<UnityEngine.Object> _localLoadDelegate, _AALResourceCore _resourceCore)
        {
            if(null == _resourceCore)
            {
#if UNITY_EDITOR
         ...
         * 加载本地资源对象的处理函数
         **/
        public void loadVideoClipAsset(string _assetPath, string _objName, _assetDownloadedDelegate _delegate, _assetDownloadedDelegate _lateDelegate, Action<VideoClip> _localLoadDelegate, _AALResourceCore _resourceCore)
        {
            if (null == _resourceCore)
            {
#if UNITY_EDITOR
                UnityEngine.Debug.LogError("加载" + _assetPath + "本地GameRes: " + "/" + _assetPath.Replace(".unity3d", "") + " 失败！");
#endif
                if (null != _delegate)
                {
                    _delegate(false, null);
            ...
            if (!_m_bUseLocalVideo || !_resourceCore.canLoadLocalRes)
            {
                //加载rescore资源
                _resourceCore.loadAsset(_assetPath, _delegate, _lateDelegate);
            }
            ...
            {
#if UNITY_EDITOR
                VideoClip clip = _loadVideoClip(_assetPath, _objName);
                //UnityEngine.Object obj = Resources.Load(_m_sLocalGameResRootPath + "/" + _assetPath.Replace(".unity3d", "") + "/" + _objName);
                if (null != clip)
                {
                    if (null != _localLoadDelegate)
                        _localLoadDelegate(clip);
                }
                else
                {
                    UnityEngine.Debug.LogError("加载" + _resourceCore.ToString() + "本地GameRes: " + "/" + _assetPath.Replace(".unity3d", "") + "/" + _objName + " 失败！");
         ...
         * 加载本地资源对象的处理函数
         **/
        public void loadGameResObjAsset(string _assetPath, string _objName, _assetDownloadedDelegate _delegate, _assetDownloadedDelegate _lateDelegate, Action<UnityEngine.Object> _localLoadDelegate, _AALResourceCore _resourceCore)
        {
            if(null == _resourceCore)
            {
#if UNITY_EDITOR
            ...
            {
#if UNITY_EDITOR
                UnityEngine.Object obj = _loadAsset(_assetPath, _objName);
                //UnityEngine.Object obj = Resources.Load(_m_sLocalGameResRootPath + "/" + _assetPath.Replace(".unity3d", "") + "/" + _objName);
                if(null != obj)
                {
                    if(null != _localLoadDelegate)
        ...
        public void loadSynGameResObjAsset(string _assetPath, string _objName, _assetDownloadedDelegate _delegate, _assetDownloadedDelegate _lateDelegate, Action<UnityEngine.Object> _localLoadDelegate, _AALResourceCore _resourceCore)
        {
            if(null == _resourceCore)
            {
#if UNITY_EDITOR
        ...
        public void loadSceneAsset(_AALResourceCore _resCore, string _assetPath, _assetDownloadedDelegate _delegate)
        {
            ...
            {
#if UNITY_EDITOR
                UnityEngine.Debug.LogError("加载" + _assetPath + "场景: " + _assetPath.Replace(".unity3d", "") + " 失败！");
#endif
                if(null != _delegate)
                {
                    _delegate(false, null);
        ...
        /** 从根目录中加载本地资源 */
        protected UnityEngine.Object _loadAsset(string _assetPath, string _objName)
        {
            return _loadPrefab<UnityEngine.Object>(_assetPath, _objName, ".asset", "");
        }
        /** 从根目录中加载本地资源 */
        ...
        /** 从根目录中加载本地资源 */
        protected VideoClip _loadVideoClip(string _assetPath, string _objName)
        {
            return _loadPrefab<VideoClip>(_assetPath, _objName, new string[2]{ ".webm", ".mp4" }
            , "");
        }

        /** 从根目录中加载本地资源 */
        protected T _loadPrefab<T>(string _assetPath, string _objName, string _exname, string _unitySiftStr) where T : UnityEngine.Object
        {
        ...
        private T _loadPrefabByFindAssets<T>(string _assetPath, string _objName, string _exname, string _unitySiftStr) where T : UnityEngine.Object
        {
            string judgeS = _objName + _exname;
            judgeS = judgeS.ToLowerInvariant();
        ...
        private T _getPathAssetsMatch<T>(string _path, string _objName, string judgeS) where T : UnityEngine.Object
        {
            T finalGo = default(T);
