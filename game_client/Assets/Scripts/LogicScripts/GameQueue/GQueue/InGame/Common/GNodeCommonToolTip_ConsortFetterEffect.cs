...
namespace GOE
{
    ...
    /// 羁绊等级效果跟随窗口节点
    /// </summary>
    public class GNodeCommonToolTip_ConsortFetterEffect : BaseQueueNode
    {
        /// <summary>
        ...
        private GGUIWndCommonToolTip_ConsortFetterEffectDetail _m_wndToolTip;
        ...
        public GNodeCommonToolTip_ConsortFetterEffect(long _assetPathId, int _fettersLvl, RectTransform _targetTransRoot, float _intervalX, float _intervalY)
        ...
        public override void EnterNode()
        {
            ...
            {
                _m_wndToolTip = new GGUIWndCommonToolTip_ConsortFetterEffectDetail(_m_sAssetPath, _m_sAssetName);
                _m_wndToolTip.load();
                _m_wndToolTip.regLoadDoneDelegate(() =>
                {
                    _m_wndToolTip.showWnd();
                    _m_wndToolTip.setData(_m_iFettersLvl, _m_targetTransRoot, _m_intervalX, _m_intervalY);
                });
            }
