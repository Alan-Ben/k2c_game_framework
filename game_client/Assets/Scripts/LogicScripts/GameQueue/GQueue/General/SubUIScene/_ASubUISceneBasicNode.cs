...
namespace GOE
{
    ...
    /// </summary>
    public abstract class _ASubUISceneBasicNode : BaseQueueNode
    {
        /// <summary>
        ...
        public _ASubUISceneBasicNode()
            : base(EUIQueueStageType.MAIN)
        {
        }
        public _ASubUISceneBasicNode(string _nodeUITag)
            : base(EUIQueueStageType.MAIN, _nodeUITag)
        {
        }
        public _ASubUISceneBasicNode(EUIQueueStageType _stageType)
            : base(_stageType)
        {
        }
        public _ASubUISceneBasicNode(EUIQueueStageType _stageType, string _nodeUITag)
        ...
        /// 获取基于的主UI场景是哪个
        /// </summary>
        protected abstract _ANPBasicAddContainerUIScene _getBasicUIScene { get; }
        /// <summary>
        /// 获取对应处理的主UI视图对象
        /// </summary>
