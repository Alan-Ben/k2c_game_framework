...
public class WCGConditionRangeAllConditionS extends _AWCGBasicSingleCondition
{
    ...
    {
        return EWCGSingleConditionType.RALL_S_COND;
    }

    public static WCGConditionRangeAllConditionS read(String _infoStr)
    {
        WCGConditionRangeAllConditionS obj = new WCGConditionRangeAllConditionS();
        ...
        {
            CommLog.error("条件配置错误 - RNE_S_COND example: enum:range:enemy_type:conditionStr Error Str: " + _infoStr, e);
            return null;
        }
    }
}
