...
namespace GOE
{
    ...
    /// 宴会排行榜列表item
    /// </summary>
    public class GGUIWndDinnerRankGridItem : _ANPGGUIBasicGridItemWnd<GGUIMonoDinnerRankGridItem>
    {
        //排行榜信息
        ...
        public GGUIWndDinnerRankGridItem(GGUIMonoDinnerRankGridItem  _wnd)
            : base(_wnd)
        {
            initWnd();
        }
