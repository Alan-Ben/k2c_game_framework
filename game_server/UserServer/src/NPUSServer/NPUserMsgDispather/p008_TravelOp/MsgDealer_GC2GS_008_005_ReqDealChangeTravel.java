...
public class  MsgDealer_GC2GS_008_005_ReqDealChangeTravel extends NPUserMsgDealer<GC2GS_008_005_ReqDealChangeTravel>
{
    @Override
    protected void _dealMessage(_ANPUSUserBasicMsgItem _commiter, GC2GS_008_005_ReqDealChangeTravel _msg)
    {
        ...
        //处理游历事件数据
        TravelEventDealerResult result = TravelEventDealerMgr.getInstance().dealEvent(ETravelEventType.CHANGE, info, _msg, context);
        if(!result.isSucc())
        {
        ...
        _commiter.commitSucRes(US2GCWriter_008_TravelOp.make_005_RetDealChangeTravel(result.getEventResult()));
