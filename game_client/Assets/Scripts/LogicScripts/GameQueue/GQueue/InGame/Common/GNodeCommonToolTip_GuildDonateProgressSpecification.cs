...
namespace GOE
{
    ...
    /// 联盟捐赠进度说明 跟随窗口
    /// </summary>
    public class GNodeCommonToolTip_GuildDonateProgressSpecification : BaseQueueNode
    {
        /// <summary>
        ...
        private GGUIWndCommonToolTip_GuildDonateProgressSpecification _m_wndToolTip;
        
        public GNodeCommonToolTip_GuildDonateProgressSpecification(string _assetPath, string _assetName, RectTransform _targetTransRoot, float _intervalX, float _intervalY)
        ...
        public override void EnterNode()
        {
            ...
            {
                _m_wndToolTip = new GGUIWndCommonToolTip_GuildDonateProgressSpecification(_m_sAssetPath, _m_sAssetName);
                _m_wndToolTip.load();
