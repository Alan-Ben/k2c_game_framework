...
public class MjInnUnlockLogBO extends MJEventLogBo {
    ...
    @DataBaseField(type = "bigint(20)", fieldname = "device_id", comment = "货舱/清单/礼物id")
    ...
    public MjInnUnlockLogBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        uid = rs.getString(3);
        vip_lv = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new MjInnUnlockLogBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `uid`, `vip_lv`, `server_id`, `platform`, `region`, `create_time`, `device_id`, `timestamp`";
    }

    @Override
    public String getTableName() {
        return "`mj_inn_unlock_log`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `mj_inn_unlock_log` ("
                ...
                + "`device_id` bigint(20) NOT NULL DEFAULT '0' COMMENT '货舱/清单/礼物id',"
                + "`timestamp` int(11) NOT NULL DEFAULT '0' COMMENT '事件发生时间戳(10位)',"
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='梦加日志-旅店货舱/清单/礼物解锁记录' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
