...
import NP2CRS_R.p001_CrossRankOp.NP2CRS_R_001_020_GetCrossRankListSize;
...
public class NPRequestDealer_001_020_GetCrossRankListSize extends NPRequestDealer<NP2CRS_R_001_020_GetCrossRankListSize>
{
    @Override
    protected void _dealMessage(_IWCGBasicRequestCommiter _commiter, NP2CRS_R_001_020_GetCrossRankListSize _msg)
    {
        //查询跨服排行集合信息
        ...
        _commiter.commitSucRes(NPWriter_001_CrossRankOp.make_020_GetCrossRankListSize(rankList.getRankSize()));
    }
}
