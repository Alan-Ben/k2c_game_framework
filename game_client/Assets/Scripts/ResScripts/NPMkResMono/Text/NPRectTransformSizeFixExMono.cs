 ...
 * 
 **/
public class NPRectTransformSizeFixExMono : MonoBehaviour
{
    //跟随的窗口对象
    ...
    public void fixTransformSize () {
        ...
        followRectTrans.SetSizeWithCurrentAnchors(RectTransform.Axis.Horizontal, Mathf.Clamp(targetObjRectTransform.rect.width + additionSize.x, minSize.x, maxSize.x));
        followRectTrans.SetSizeWithCurrentAnchors(RectTransform.Axis.Vertical, Mathf.Clamp(targetObjRectTransform.rect.height + additionSize.y, minSize.y, maxSize.y));
