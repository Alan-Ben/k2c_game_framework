...
{
    half4 albedo = SampleAlbedo(uv, blendUv, _Color, particleColor, projectedPosition, TEXTURE2D_ARGS(_MainTex, sampler_MainTex));
...
{
    half4 albedo = SampleAlbedo(TEXTURE2D_ARGS(_MainTex, sampler_MainTex), params);
