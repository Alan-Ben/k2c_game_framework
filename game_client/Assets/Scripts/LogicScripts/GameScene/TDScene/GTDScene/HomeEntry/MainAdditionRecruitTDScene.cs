...
namespace GOE
{
    ...
    /// 招募场景
    /// </summary>
    public class MainAdditionRecruitTDScene : _ABaseHomeEntryAdditionTDScene
    {
        private static MainAdditionRecruitTDScene _g_instance;
        [NotNull] public static MainAdditionRecruitTDScene instance { get { return _g_instance ??= new MainAdditionRecruitTDScene(); } }
        ...
        private MainAdditionRecruitTDScene()
        {
        }
        ...
        public override SceneInfoRefObj sceneRefObj
        {
            get
            {
                long sceneId = GRefdataCoreMgr.instance.npGeneral.recruit_scene_id;
