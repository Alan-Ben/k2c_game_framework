...
import NPGameRes.GameObjs.PlayerEffect.EffectObj.NPPlayerEffect_S_GAIN_X_CONSORT_INTIMACY_FROM;
...
public class NPPlayerEffectDealer_S_GAIN_X_CONSORT_INTIMACY_FROM extends _ANPPlayerEffectDealer
{
    @Override
    ...
    {
        NPPlayerEffect_S_GAIN_X_CONSORT_INTIMACY_FROM effect = (NPPlayerEffect_S_GAIN_X_CONSORT_INTIMACY_FROM) _effectInfo;
        ...
        consortInfo.incrIntimacy(count, _context);
    }
}
