...
public class Opt041005MarsExploreStartBO extends BaseOptLogBo {
    ...
    public Opt041005MarsExploreStartBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
        ...
        teamId = rs.getLong(9);
        exploreLvl = rs.getInt(10);
        eventInstanceId = rs.getLong(11);
        eventType = rs.getInt(12);
        eventRefId = rs.getLong(13);
    }

    @Override
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt041005MarsExploreStartBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `teamId`, `exploreLvl`, `eventInstanceId`, `eventType`, `eventRefId`";
    }

    @Override
    public String getTableName() {
        return "`opt_041_005_mars_explore_start`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_041_005_mars_explore_start` ("
                ...
                + "`teamId` bigint(20) NOT NULL DEFAULT '0' COMMENT '玩家CID',"
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='火星-火星探险开始处理事件' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
