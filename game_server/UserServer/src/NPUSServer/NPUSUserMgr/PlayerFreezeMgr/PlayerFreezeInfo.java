...
public class PlayerFreezeInfo
{
     ...
     * 冻结记录
     */
    private PlayerFreezeBO _m_freezeBo;

    public PlayerFreezeInfo(PlayerFreezeMgr _playerFreezeMgr, PlayerFreezeBO _bo)
    {
    ...
    public PlayerFreezeBO getFreezeBo()
    {
        return _m_freezeBo;
    }
    ...
    {
        _m_freezeBo.saveFreezeTimeMs(_m_playerFreezeMgr.getUSServer().getBM(), _freezeTime);
    }
