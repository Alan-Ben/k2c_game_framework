...
| ON_CONSORT_CHARM_POINT_CHG | 加护点变化 |
| ON_CONSORT_SKIN_INFO_ADD | 皮肤添加 |
| ON_CONSORT_CUR_SKIN_INFO_CHG | 当前皮肤变化 |
| ON_CONSORT_FETTER_LEVEL_CHG | 羁绊等级变化 |
| ON_CONSORT_BUSINESS_SKILL_INFO_CHG | 经营技能变化 |
| ON_CONSORT_BLESS_SKILL_INFO_CHG | 加护技能变化 |
| ON_CONSORT_HALO_INFO_CHG | 星辉变化 |
| ON_CONSORT_HALO_UNLOCK_CHG | 星辉解锁状态变化 |
| ON_CONSORT_ADD_CG | 新增CG |
| ON_CONSORT_CG_CHG | CG变化 |
