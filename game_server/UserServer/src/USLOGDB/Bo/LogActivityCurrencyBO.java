...
public class LogActivityCurrencyBO extends BaseLogBo {
    ...
    public LogActivityCurrencyBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        logType = rs.getInt(3);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new LogActivityCurrencyBO(rs));
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `log_activity_currency` ("
