...
public class LogRoomSkinBO extends BaseLogBo {
    ...
    public LogRoomSkinBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        logType = rs.getInt(3);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new LogRoomSkinBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `logType`, `event_id`, `guid`, `date_time`, `timestamp`, `sub_id`, `origin_value`, `chg_value`, `final_value`";
    }

    @Override
    public String getTableName() {
        return "`log_room_skin`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `log_room_skin` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='房间皮肤数据日志表' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
