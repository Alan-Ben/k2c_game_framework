...
import GC2GS.p012_ActivityTeamOp.GC2GS_012_007_ReqKickActivityTeamPlayer;
...
public class MsgDealer_GC2GS_012_007_ReqKickActivityTeamPlayer extends NPUserMsgDealer<GC2GS_012_007_ReqKickActivityTeamPlayer>
{
    @Override
    protected void _dealMessage(_ANPUSUserBasicMsgItem _commiter, GC2GS_012_007_ReqKickActivityTeamPlayer _msg)
    {
        ...
        // 不能踢出自己
        if (userData.getCid() == _msg.getKickCid())
        {
            _commiter.commitFailRes(ActivityErr.TEAM_CANNOT_KICK_SELF.getCode());
            return;
        }

        // 获取玩家当前队伍ID
        dealer.kickActivityTeamPlayer(_msg.getTeamId(), userData.getCid(), _msg.getKickCid(), (_result) ->
        {
            if (!_result.isSucc())
            {
            ...
            _commiter.commitSucRes(US2GCWriter_012_ActivityTeamOp.make_007_RetKickActivityTeamPlayer());
        });
    }
}
