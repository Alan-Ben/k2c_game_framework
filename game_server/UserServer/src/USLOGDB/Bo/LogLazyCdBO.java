...
public class LogLazyCdBO extends BaseLogBo {
    ...
    public static final int FIELD_vip_lvl =10;
    ...
    public LogLazyCdBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        logType = rs.getInt(3);
        ...
        vip_lvl = rs.getInt(12);
    }

    @Override
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new LogLazyCdBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `logType`, `event_id`, `guid`, `date_time`, `timestamp`, `sub_id`, `origin_value`, `chg_value`, `final_value`, `vip_lvl`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `log_lazy_cd` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='cd数据日志表' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
