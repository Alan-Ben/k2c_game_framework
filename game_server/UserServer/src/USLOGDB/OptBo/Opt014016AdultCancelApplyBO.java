...
public class Opt014016AdultCancelApplyBO extends BaseOptLogBo {
    ...
    public Opt014016AdultCancelApplyBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt014016AdultCancelApplyBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt014016AdultCancelApplyBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `adultId`";
    }

    @Override
    public String getTableName() {
        return "`opt_014_016_adult_cancel_apply`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_014_016_adult_cancel_apply` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='成年子嗣-取消玩家指定子嗣请求' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
