...
/// 发送私聊消息
/// </summary>
public class GC2GS_022_005_ReqPlayerSendPrivateMsg : ALBasicProtocolPack._IALProtocolStructure {
/// <summary>
/// 接收玩家CID
/// </summary>
...
public override string ToString() {
	...
	builder.Append("{");
	builder.Append("receiverCid").Append(":").Append(receiverCid.ToString()).Append(", ");
