...
public class PS_SSListener extends _ANPPSBasicServerListener
{
    private static PS_SSListener _g_instance = null;

    public static PS_SSListener getObj()
    {
        return _g_instance;
    }
    ...
    public PS_SSListener()
    {
        super(EServerType.SINGLE, ENPSingleServerType.SCHEDULE.ordinal());
    }

    @Override
    public void login()
    {
        ALServerLog.Sys("Schedule Server: " + getServerTypeId() + " Login!");
        _g_instance = this;
    }
    ...
    {
        ALServerLog.Sys("Schedule Server: " + getServerTypeId() + " Disconnect!");
        //设置全局变量
        _g_instance = null;
    }
