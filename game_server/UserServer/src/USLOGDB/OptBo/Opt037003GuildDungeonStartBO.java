...
public class Opt037003GuildDungeonStartBO extends BaseOptLogBo {
    ...
    public static final int FIELD_startType =9;
    @DataBaseField(type = "int(11)", fieldname = "startType", comment = "开启类型")
    private int startType;

    public Opt037003GuildDungeonStartBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt037003GuildDungeonStartBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
        ...
        startType = rs.getInt(11);
    }

    @Override
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt037003GuildDungeonStartBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `guildId`, `dungeonId`, `startType`";
    }

    @Override
    public String getTableName() {
        return "`opt_037_003_guild_dungeon_start`";
    }
    ...
    public String getItemsValue() {
        ...
        strBuf.append("'").append(startType).append("', ");
   ...
   @Override
    ...
    // 开启类型
    public int getStartType() { return this.startType; }
    public void setStartType(BM _bm, int startType) {
        if(startType==this.startType) 
            return;
        this.startType = startType; 
        markField(_bm, FIELD_startType); 
    }
    public void saveStartType(BM _bm, int startType) {
        if(startType==this.startType) 
            return;
        this.startType = startType;
        saveField(_bm, "startType", startType);
    }
    ...
    protected String getUpdateKeyValue() {
        ...
        sBuilder.append(" `startType` = '").append(startType).append("',");
    ...
    public String getMarkedUpdateKeyValue() {
        ...
        if(isFieldMarked(FIELD_startType)) sBuilder.append(" `startType` = '").append(startType).append("',");
        sBuilder.deleteCharAt(sBuilder.length() - 1);
        return sBuilder.toString();
    }
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_037_003_guild_dungeon_start` ("
                ...
                + "`startType` int(11) NOT NULL DEFAULT '0' COMMENT '开启类型',"
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='开启公会副本' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
