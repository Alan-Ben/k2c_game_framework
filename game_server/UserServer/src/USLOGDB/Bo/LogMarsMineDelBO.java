...
public class LogMarsMineDelBO extends BaseLogBo {
    ...
    public LogMarsMineDelBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        logType = rs.getInt(3);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new LogMarsMineDelBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `logType`, `event_id`, `guid`, `date_time`, `timestamp`, `mineInstanceId`";
    }

    @Override
    public String getTableName() {
        return "`log_mars_mine_del`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `log_mars_mine_del` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='玩家火星矿移除日志表' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
