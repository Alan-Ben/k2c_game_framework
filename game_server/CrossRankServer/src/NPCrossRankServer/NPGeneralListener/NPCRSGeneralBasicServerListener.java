...
public class NPCRSGeneralBasicServerListener extends _ANPCRSBasicServerListener
{
    public NPCRSGeneralBasicServerListener(_AWCGBasicServer _server, EServerType _serverType, int _serverTypeId)
    {
