 ...
 *
 */
public class CrossGameCategoryMsgItem extends _ACrossGameCategoryMsgItem
{
    public CrossGameCategoryMsgItem(long _instanceId, long _cid, ByteBuffer _msgBuffer)
    {
        super(_instanceId, _cid, _msgBuffer, null);
    }
    ...
    public void dealMsg(_ACrossGameInstanceCategory _crossGameCategory)
    {
        ...
        //处理协议
        _crossGameCategory.dealMsg(_m_lInstaceId, _m_lCid, _m_bMsgBuffer);
    }
}
