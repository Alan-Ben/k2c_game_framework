...
namespace Hotfix
{
    ...
    /// 模板窗口cache管理对象
    /// </summary>
    public abstract class _ATHotfixUIWndUnsafeCache<T_W, T_M> : _AHotfixUnsafeCacheController<T_W, T_M>
        ...
        where T_W : _ATALBasicUISubWnd<T_M>
    {
        ...
        public _ATHotfixUIWndUnsafeCache(Transform _parentTrans, int _minCount, int _maxCount, int _addUnit)
