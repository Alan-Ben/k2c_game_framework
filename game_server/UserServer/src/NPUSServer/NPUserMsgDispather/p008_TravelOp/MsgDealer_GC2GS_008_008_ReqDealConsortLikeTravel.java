...
public class  MsgDealer_GC2GS_008_008_ReqDealConsortLikeTravel extends NPUserMsgDealer<GC2GS_008_008_ReqDealConsortLikeTravel>
{
    @Override
    protected void _dealMessage(_ANPUSUserBasicMsgItem _commiter, GC2GS_008_008_ReqDealConsortLikeTravel _msg)
    {
        ...
        //处理游历事件数据
        TravelEventDealerResult result = TravelEventDealerMgr.getInstance().dealEvent(ETravelEventType.CONSORT_LIKE, info, _msg, context);
        if(!result.isSucc())
        {
        ...
        _commiter.commitSucRes(US2GCWriter_008_TravelOp.make_008_RetDealConsortLikeTravel(result.getEventResult()));
