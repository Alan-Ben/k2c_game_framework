...
public class  MsgDealer_GC2GS_008_007_ReqDealAddPowerTravel extends NPUserMsgDealer<GC2GS_008_007_ReqDealAddPowerTravel>
{
    @Override
    protected void _dealMessage(_ANPUSUserBasicMsgItem _commiter, GC2GS_008_007_ReqDealAddPowerTravel _msg)
    {
        ...
        //处理游历事件数据
        TravelEventDealerResult result = TravelEventDealerMgr.getInstance().dealEvent(ETravelEventType.ADD_POWER, info, _msg, context);
        if(!result.isSucc())
        {
        ...
        _commiter.commitSucRes(US2GCWriter_008_TravelOp.make_007_RetDealAddPowerTravel(result.getEventResult()));
