...
namespace GOE
{
    ...
    /// </summary>
    public abstract class _ASubUIAddSceneNode_Var : _ASubUIAddSceneNode
    {
        ...
        public _ASubUIAddSceneNode_Var(_ANPBasicAddContainerUIScene _addContainerUIScene, _ANPBasicAddContainerUIScene _parentScene)
            : base()
        {
        ...
        public _ASubUIAddSceneNode_Var(_ANPBasicAddContainerUIScene _addContainerUIScene, _ANPBasicAddContainerUIScene _parentScene, string _nodeTag)
            : base(_nodeTag)
        {
            _m_addContainerUIScene = _addContainerUIScene;
            _m_scParentScene = _parentScene;
        ...
        public _ASubUIAddSceneNode_Var(_ANPBasicAddContainerUIScene _addContainerUIScene, _ANPBasicAddContainerUIScene _parentScene, string _nodeTag, Action _preEnterDone, Action _onEnterDone)
            : base(_nodeTag)
        {
            _m_addContainerUIScene = _addContainerUIScene;
            _m_scParentScene = _parentScene;
        ...
        public _ASubUIAddSceneNode_Var(_ANPBasicAddContainerUIScene _addContainerUIScene, _ANPBasicAddContainerUIScene _parentScene, EUIQueueStageType _stageType, string _nodeTag, Action _preEnterDone, Action _onEnterDone)
