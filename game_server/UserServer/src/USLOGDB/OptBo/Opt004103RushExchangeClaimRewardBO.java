...
public class Opt004103RushExchangeClaimRewardBO extends BaseOptLogBo {
    ...
    public Opt004103RushExchangeClaimRewardBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt004103RushExchangeClaimRewardBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt004103RushExchangeClaimRewardBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `group_id`, `ref_id`";
    }

    @Override
    public String getTableName() {
        return "`opt_004_103_rush_exchange_claim_reward`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_004_103_rush_exchange_claim_reward` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='限时兑换-领取奖励' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
