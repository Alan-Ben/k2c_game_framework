...
public class PlayerChatRoomGuildDealer implements _IPlayerChatRoomDealer
{
    @Override
    ...
    public void getRoom(NPUSUserData _userData, long _extId, _IGetChatRoomCallBackResult _callback)
    {
        ...
        if(guildId <= 0)
        {
            _callback.onRunOver(GuildErr.GUILD_NOT_EXIST, 0L, 0, 0);
            return;
        }
        ...
        dealer.getRoom(_userData.getUSServer(), guildId, _extId, _callback);
    }
    ...
    public void joinRoom(NPUSUserData _userData, long _extId, _ICallBackResultT<Long> _callback)
    {
        ...
        getRoom(_userData, _extId, (_result, _roomId, _chatServerType, _chatServerTypeId) ->
        {
            ...
            _userData.getUSServer().rpc2us().requestTo(_chatServerTypeId, rpc, new _ARpcCallBack<JoinChatRoom>()
            {
                @Override
    ...
    public void quitRoom(NPUSUserData _userData, long _extId, _ICallBackResult _callback)
    {
        ...
        getRoom(_userData, _extId, (_result, _roomId, _chatServerType, _chatServerTypeId) ->
        {
            ...
            _userData.getUSServer().rpc2us().requestTo(_chatServerTypeId, rpc, new _ARpcCallBack<QuitChatRoom>()
            {
                @Override
