...
namespace GOE
{
    ...
    /// </summary>
    public abstract class _AVideoSimpleMono : MonoBehaviour
    {
        [ALHeader("视频的播放信息")]
        public GVideoClipIndex videoIndex;
        [ALHeader("是否独立背景音乐")]
        ...
        protected void _onVedioEnable()
        {
            ...
            // 提前准备
            VideoController.prepareVideoClip(videoIndex, _m_vpPlayer, VideoController.audioMode
        ...
        public void playAniTag()
        {
            ...
            if (isLoop)
            {
                VideoController.loopPlayVideoClip(videoIndex, _m_vpPlayer, VideoController.audioMode, isBgMusic
                    , () => curSerialize == _m_lSerialize
                    , null);
            }
            else
            {
                VideoController.playVideoClip(videoIndex, _m_vpPlayer, VideoController.audioMode, isBgMusic
                    , () => curSerialize == _m_lSerialize
                    , null);
            }
#endif
