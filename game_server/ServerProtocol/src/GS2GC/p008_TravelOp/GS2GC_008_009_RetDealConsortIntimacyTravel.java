 ...
 * 处理增加妃子亲密度游历事件
 **/
public class GS2GC_008_009_RetDealConsortIntimacyTravel implements ALBasicProtocolPack._IALProtocolStructure {
/** 游历事件结果 */
private Common.TravelObj.Travel_EventResult result;


public GS2GC_008_009_RetDealConsortIntimacyTravel() {
