 ...
 * 同意玩家组队申请
 **/
public class GC2GS_012_013_ReqAgreeActivityTeamApply implements ALBasicProtocolPack._IALProtocolStructure {
/** 队伍实例ID */
private long teamId;
/** 申请玩家CID */
...
public GC2GS_012_013_ReqAgreeActivityTeamApply() {
	teamId = (long)0;
	applyCid = (long)0;
}
