...
/// </summary>
public class WCGConditionUnitTyp_T extends _AWCGBasicSingleCondition
{
    ...
    {
        return EWCGSingleConditionType.UNIT_TYP_T;
    }

    public static WCGConditionUnitTyp_T readCond(String _str)
    {
        WCGConditionUnitTyp_T cond = new WCGConditionUnitTyp_T();
        //解析字符串
        ...
        try
        {
            ...
            {
                EWCGActorUnitType unityTYpe = EWCGActorUnitType.valueOf(strs[i].trim().toUpperCase().trim());
