...
namespace GOE
{
    public class GGUIWndMarsExploreBattleEventTipFollowerController : _ATALGGUICommonFollowItemController<GGUIMonoMarsExploreBattleEventTip, GGUIWndMarsExploreBattleEventTipFollower>
    {
        private readonly GResPathIndex _m_resIndex;
        private MarsExploreBattleEventView _m_eventView;


        public GGUIWndMarsExploreBattleEventTipFollowerController()
        {
            _m_resIndex = new GResPathIndex(7402);
        }
        public GGUIWndMarsExploreBattleEventTipFollowerController(GResPathIndex _resIndex)
        {
        ...
        protected override GGUIWndMarsExploreBattleEventTipFollower _createItemWnd(GGUIMonoMarsExploreBattleEventTip _wndMono)
        {
            GGUIWndMarsExploreBattleEventTipFollower wnd = new GGUIWndMarsExploreBattleEventTipFollower(_wndMono);
            wnd.refreshWnd(_m_eventView);
            wnd.showWnd();
            return wnd;
        }
        public void refreshWnd(MarsExploreBattleEventView _eventView)
        {
    ...
    public class GGUIWndMarsExploreBattleEventTipFollower : _ATALGGUIWndCommonFollowItem<GGUIMonoMarsExploreBattleEventTip>
    {
        private MarsExploreBattleEventView _m_eventView;
        private NPGGuiWndTexture _m_iconWnd;


        public GGUIWndMarsExploreBattleEventTipFollower(GGUIMonoMarsExploreBattleEventTip _wnd) : base(_wnd)
        {
            initWnd();
        }
        ...
        public void refreshWnd()
        {
            ...
            MarsExploreBattleEventInfo eventInfo = _m_eventView.specificEventInfo;
