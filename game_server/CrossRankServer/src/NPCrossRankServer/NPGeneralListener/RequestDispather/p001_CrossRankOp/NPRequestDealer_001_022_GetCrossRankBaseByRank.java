...
import NP2CRS_R.p001_CrossRankOp.NP2CRS_R_001_022_GetCrossRankBaseByRank;
...
public class NPRequestDealer_001_022_GetCrossRankBaseByRank extends NPRequestDealer<NP2CRS_R_001_022_GetCrossRankBaseByRank>
{
    @Override
    protected void _dealMessage(_IWCGBasicRequestCommiter _commiter, NP2CRS_R_001_022_GetCrossRankBaseByRank _msg)
    {
        //查询跨服排行集合信息
        ...
        Rank_BaseItem rankItem = rankList.makeRankObjBaseByRank(_msg.getRank());

        _commiter.commitSucRes(NPWriter_001_CrossRankOp.make_022_GetCrossRankBaseByRank(rankItem));
    }
}
