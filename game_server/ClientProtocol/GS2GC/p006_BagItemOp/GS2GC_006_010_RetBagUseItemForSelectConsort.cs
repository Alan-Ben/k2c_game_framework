...
public class GS2GC_006_010_RetBagUseItemForSelectConsort : ALBasicProtocolPack._IALProtocolStructure {
private List<Common.BagItemUseObj.BagItemUse_ConsortShowInfo> itemList;


public GS2GC_006_010_RetBagUseItemForSelectConsort() {
	itemList = new List<Common.BagItemUseObj.BagItemUse_ConsortShowInfo>();
}

public GS2GC_006_010_RetBagUseItemForSelectConsort(
	List<Common.BagItemUseObj.BagItemUse_ConsortShowInfo> _itemList
) {	itemList = _itemList;
}
...
public List<Common.BagItemUseObj.BagItemUse_ConsortShowInfo> getItemList() { return itemList; }
