...
namespace GOE
{
    ...
    /// 活动阶段奖励步骤列表item
    /// </summary>
    public class GGUIWndActivityStepRewardStepGridItem : _ATALUGUIBasicGridItemWnd<GGUIMonoActivityStepRewardStepGridItem>
    {
        ...
        public GGUIWndActivityStepRewardStepGridItem(GGUIMonoActivityStepRewardStepGridItem _wnd) : base(_wnd)
        {
        }
        ...
        private void _refreshWnd()
        {
            ...
            //设置置灰状态
            if (state == EStepRewardState.AlreadyGet)
            ...
            if (null != curStatInfo)
            {
                ...
                string valueStr = _getValueString(curStatInfo.txtColor, wnd.curProcessTextSize, curStatInfo.isChgAll);
        ...
        /// </summary>
        /// <returns></returns>
        private string _getValueString(Color _txtColor, long _txtSize, bool _chgAllStr = false)
        {
