...
public class LogCurrencySilverBO extends BaseLogBo {
    ...
    public static final int FIELD_outputSpeed =8;
    @DataBaseField(type = "bigint(20)", fieldname = "outputSpeed", comment = "产出速度")
    ...
    public LogCurrencySilverBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new LogCurrencySilverBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `event_id`, `guid`, `date_time`, `timestamp`, `player_level`, `chgValue`, `value`, `outputSpeed`, `lastSettleTimeMs`, `totalGainCount`, `totalConsumeCount`";
    }

    @Override
    public String getTableName() {
        return "`log_currency_silver`";
    }
    ...
    public String getItemsValue() {
        ...
        strBuf.append("'").append(outputSpeed).append("', ");
   ...
   @Override
    ...
    // 产出速度
    public long getOutputSpeed() { return this.outputSpeed; }
    public void setOutputSpeed(BM _bm, long outputSpeed) {
        if(outputSpeed==this.outputSpeed) 
            return;
        this.outputSpeed = outputSpeed; 
        markField(_bm, FIELD_outputSpeed); 
    }
    public void saveOutputSpeed(BM _bm, long outputSpeed) {
        if(outputSpeed==this.outputSpeed) 
            return;
        this.outputSpeed = outputSpeed;
        saveField(_bm, "outputSpeed", outputSpeed);
    }
    ...
    protected String getUpdateKeyValue() {
        ...
        sBuilder.append(" `outputSpeed` = '").append(outputSpeed).append("',");
    ...
    public String getMarkedUpdateKeyValue() {
        ...
        if(isFieldMarked(FIELD_outputSpeed)) sBuilder.append(" `outputSpeed` = '").append(outputSpeed).append("',");
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `log_currency_silver` ("
                ...
                + "`outputSpeed` bigint(20) NOT NULL DEFAULT '0' COMMENT '产出速度',"
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='货币（银币）数据日志表' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
