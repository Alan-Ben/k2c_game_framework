...
public class Opt040003MarsPeopleDealInteBO extends BaseOptLogBo {
    ...
    public static final int FIELD_inteId =7;
    @DataBaseField(type = "bigint(20)", fieldname = "inteId", comment = "决策ID")
    private long inteId;

    public Opt040003MarsPeopleDealInteBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt040003MarsPeopleDealInteBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt040003MarsPeopleDealInteBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `inteId`";
    }

    @Override
    public String getTableName() {
        return "`opt_040_003_mars_people_deal_inte`";
    }
    ...
    public String getItemsValue() {
        ...
        strBuf.append("'").append(inteId).append("', ");
   ...
   @Override
    ...
    // 决策ID
    public long getInteId() { return this.inteId; }
    public void setInteId(BM _bm, long inteId) {
        if(inteId==this.inteId) 
            return;
        this.inteId = inteId; 
        markField(_bm, FIELD_inteId); 
    }
    public void saveInteId(BM _bm, long inteId) {
        if(inteId==this.inteId) 
            return;
        this.inteId = inteId;
        saveField(_bm, "inteId", inteId);
    }
    ...
    protected String getUpdateKeyValue() {
        ...
        sBuilder.append(" `inteId` = '").append(inteId).append("',");
    ...
    public String getMarkedUpdateKeyValue() {
        ...
        if(isFieldMarked(FIELD_inteId)) sBuilder.append(" `inteId` = '").append(inteId).append("',");
        sBuilder.deleteCharAt(sBuilder.length() - 1);
        return sBuilder.toString();
    }
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_040_003_mars_people_deal_inte` ("
                ...
                + "`inteId` bigint(20) NOT NULL DEFAULT '0' COMMENT '决策ID',"
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='火星-处理AI事件' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
