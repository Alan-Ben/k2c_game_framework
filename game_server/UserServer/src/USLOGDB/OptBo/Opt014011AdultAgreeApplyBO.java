...
public class Opt014011AdultAgreeApplyBO extends BaseOptLogBo {
    ...
    public Opt014011AdultAgreeApplyBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
        ...
        applyAdultId = rs.getLong(10);
    }

    @Override
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt014011AdultAgreeApplyBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `adultId`, `applyAdultId`";
    }

    @Override
    public String getTableName() {
        return "`opt_014_011_adult_agree_apply`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_014_011_adult_agree_apply` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='成年子嗣-同意指定联姻' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
