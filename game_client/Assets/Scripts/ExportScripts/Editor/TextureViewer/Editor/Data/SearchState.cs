        ...
        public bool DoesItemMatch(EHeaderColumnId headerId, TextureTreeElement element)
        {
            ...
            switch (headerId)
            {
                ...
                case EHeaderColumnId.DataSize:
                    ...
                    break;
                case EHeaderColumnId.Format:
                    return DoesStringMatch(searchString, element.Texture.format.ToString());
                case EHeaderColumnId.SpriteAtlas:
                    return DoesStringMatch(searchString, element.sptAtlas);
                case EHeaderColumnId.OriginSize:
                    return DoesStringMatch(searchString, element.sptAtlas);
                default:
                    return true;
            }
