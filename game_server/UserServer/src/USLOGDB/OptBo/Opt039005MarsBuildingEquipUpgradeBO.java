...
public class Opt039005MarsBuildingEquipUpgradeBO extends BaseOptLogBo {
    ...
    public static final int FIELD_equip_id =8;
    @DataBaseField(type = "bigint(20)", fieldname = "equip_id", comment = "部件ID")
    private long equip_id;

    public static final int FIELD_equip_lvl =9;
    @DataBaseField(type = "int(11)", fieldname = "equip_lvl", comment = "部件当前等级")
    private int equip_lvl;

    public Opt039005MarsBuildingEquipUpgradeBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt039005MarsBuildingEquipUpgradeBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
        ...
        equip_id = rs.getLong(10);
        equip_lvl = rs.getInt(11);
    }

    @Override
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt039005MarsBuildingEquipUpgradeBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `building_id`, `equip_id`, `equip_lvl`";
    }

    @Override
    public String getTableName() {
        return "`opt_039_005_mars_building_equip_upgrade`";
    }
    ...
    public String getItemsValue() {
        ...
        strBuf.append("'").append(equip_lvl).append("', ");
   ...
   @Override
    ...
    // 部件当前等级
    public int getEquipLvl() { return this.equip_lvl; }
    public void setEquipLvl(BM _bm, int equip_lvl) {
        if(equip_lvl==this.equip_lvl) 
            return;
        this.equip_lvl = equip_lvl; 
        markField(_bm, FIELD_equip_lvl); 
    }
    public void saveEquipLvl(BM _bm, int equip_lvl) {
        if(equip_lvl==this.equip_lvl) 
            return;
        this.equip_lvl = equip_lvl;
        saveField(_bm, "equip_lvl", equip_lvl);
    }
    ...
    protected String getUpdateKeyValue() {
        ...
        sBuilder.append(" `equip_lvl` = '").append(equip_lvl).append("',");
    ...
    public String getMarkedUpdateKeyValue() {
        ...
        if(isFieldMarked(FIELD_equip_lvl)) sBuilder.append(" `equip_lvl` = '").append(equip_lvl).append("',");
        sBuilder.deleteCharAt(sBuilder.length() - 1);
        return sBuilder.toString();
    }
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_039_005_mars_building_equip_upgrade` ("
                ...
                + "`equip_id` bigint(20) NOT NULL DEFAULT '0' COMMENT '部件ID',"
                + "`equip_lvl` int(11) NOT NULL DEFAULT '0' COMMENT '部件当前等级',"
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='火星-升级火星建筑' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
