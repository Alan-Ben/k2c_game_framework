...
public enum ENPPlayer_CS_SpecialCondition {
	...
	;
public static final ENPPlayer_CS_SpecialCondition[]  ENPPlayer_CS_SpecialCondition_Values = ENPPlayer_CS_SpecialCondition.values();
public static final int ENPPlayer_CS_SpecialCondition_Length = ENPPlayer_CS_SpecialCondition_Values.length;
public static ENPPlayer_CS_SpecialCondition ENPPlayer_CS_SpecialCondition_FromInt(int _ivalue) {
	if(_ivalue < 0 || _ivalue >= ENPPlayer_CS_SpecialCondition_Length){ return null; }
	return ENPPlayer_CS_SpecialCondition_Values[_ivalue];
}
}
