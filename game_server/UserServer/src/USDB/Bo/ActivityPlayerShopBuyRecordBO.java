...
@RefBo(isIdAuto= true)
public class ActivityPlayerShopBuyRecordBO extends BaseBO {
    ...
    public ActivityPlayerShopBuyRecordBO() {
        id = 0;
        instance_id = 0L;
        shop_db_id = 0L;
        shop_id = 0L;
    ...
    public ActivityPlayerShopBuyRecordBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new ActivityPlayerShopBuyRecordBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `instance_id`, `shop_db_id`, `shop_id`, `cid`, `item_id`, `had_buy_count`";
    }

    @Override
    public String getTableName() {
        return "`activity_player_shop_buy_record`";
    }
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `activity_player_shop_buy_record` ("
