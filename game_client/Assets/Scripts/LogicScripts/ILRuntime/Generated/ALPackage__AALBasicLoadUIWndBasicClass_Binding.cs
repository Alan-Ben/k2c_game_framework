...
{
    unsafe class ALPackage__AALBasicLoadUIWndBasicClass_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ALPackage._AALBasicLoadUIWndBasicClass);
            args = new Type[]{};
            ...
            app.RegisterCLRMethodRedirection(method, get_rectTransform_3);
        ...
        static StackObject* showWnd_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ALPackage._AALBasicLoadUIWndBasicClass instance_of_this_method = (ALPackage._AALBasicLoadUIWndBasicClass)typeof(ALPackage._AALBasicLoadUIWndBasicClass).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* get_rectTransform_3(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
