...
@RefBo(isIdAuto= true)
public class NpCrossRankObjBO extends BaseBO {
    ...
    public NpCrossRankObjBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new NpCrossRankObjBO(rs));
    }
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `np_cross_rank_obj` ("
