...
public class Opt039010MarsBuildingSetDoneBO extends BaseOptLogBo {
    ...
    public static final int FIELD_building_id =7;
    @DataBaseField(type = "bigint(20)", fieldname = "building_id", comment = "建筑ID")
    ...
    public Opt039010MarsBuildingSetDoneBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt039010MarsBuildingSetDoneBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt039010MarsBuildingSetDoneBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `building_id`, `is_upgrade`, `pre_lvl`, `cur_lvl`";
    }

    @Override
    public String getTableName() {
        return "`opt_039_010_mars_building_set_done`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_039_010_mars_building_set_done` ("
                ...
                + "`building_id` bigint(20) NOT NULL DEFAULT '0' COMMENT '建筑ID',"
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='火星-确认火星建筑快速完成' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
