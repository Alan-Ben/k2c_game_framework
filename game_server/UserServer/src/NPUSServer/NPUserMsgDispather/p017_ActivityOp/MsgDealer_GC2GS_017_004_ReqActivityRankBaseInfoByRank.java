...
import GC2GS.p017_ActivityOp.GC2GS_017_004_ReqActivityRankBaseInfoByRank;
...
public class MsgDealer_GC2GS_017_004_ReqActivityRankBaseInfoByRank extends NPUserMsgDealer<GC2GS_017_004_ReqActivityRankBaseInfoByRank>
{
    @Override
    protected void _dealMessage(_ANPUSUserBasicMsgItem _committer, GC2GS_017_004_ReqActivityRankBaseInfoByRank _msg)
    {
        ...
        //获取排行榜基础数据
        rankInfo.makeRankBaseByRank(_msg.getRank(), _msg.getIsCross(), (_result, _rankBase) ->
        {
            if (!_result.isSucc())
            {
            ...
            _committer.commitSucRes(US2GCWriter_017_ActivityOp.make_004_RetActivityRankBaseInfoByRank(_rankBase));
        });
    }
}
