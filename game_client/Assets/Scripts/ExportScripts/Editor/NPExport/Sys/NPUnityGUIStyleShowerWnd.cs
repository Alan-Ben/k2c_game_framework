...
namespace GOE
{
	public class UnityGUIStyleShowerWnd : EditorWindow
	{
	    ...
	    {
	        GetWindow(typeof(UnityGUIStyleShowerWnd));
	    }
	    ...
	    void OnGUI()
	    {
	        ...
	        {
	            if (style.name.ToLowerInvariant().Contains(search.ToLowerInvariant()))
	            {
	                DrawStyleItem(style);
	            }
	        }
