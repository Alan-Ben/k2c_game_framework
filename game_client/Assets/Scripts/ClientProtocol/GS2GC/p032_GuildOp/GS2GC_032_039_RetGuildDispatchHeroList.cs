...
public class GS2GC_032_039_RetGuildDispatchHeroList : ALBasicProtocolPack._IALProtocolStructure {
private List<Common.GuildObj.Guild_DispatchHeroDetailInfo> infoList;


public GS2GC_032_039_RetGuildDispatchHeroList() {
	infoList = new List<Common.GuildObj.Guild_DispatchHeroDetailInfo>();
}

public GS2GC_032_039_RetGuildDispatchHeroList(
	List<Common.GuildObj.Guild_DispatchHeroDetailInfo> _infoList
) {	infoList = _infoList;
}
...
public List<Common.GuildObj.Guild_DispatchHeroDetailInfo> getInfoList() { return infoList; }
public void addInfoList(Common.GuildObj.Guild_DispatchHeroDetailInfo _infoList) { infoList.Add(_infoList); }


public int GetBufSize() {
	int _size = 0;
	_size += 2 + (infoList.Count * 40);
