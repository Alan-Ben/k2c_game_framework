...
public class Opt014017AdultCancelGroupBO extends BaseOptLogBo {
    ...
    public Opt014017AdultCancelGroupBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt014017AdultCancelGroupBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt014017AdultCancelGroupBO(rs));
    }
    ...
    public String getTableName() {
        return "`opt_014_017_adult_cancel_group`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_014_017_adult_cancel_group` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='成年子嗣-取消全服联姻池' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
