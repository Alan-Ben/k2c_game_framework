...
import NP2CRS_R.p001_CrossRankOp.NP2CRS_R_001_024_DumpCrossRankListByUs;
...
public class NPRequestDealer_001_024_GetCrossRankBaseListByUs extends NPRequestDealer<NP2CRS_R_001_024_DumpCrossRankListByUs>
{
    @Override
    protected void _dealMessage(_IWCGBasicRequestCommiter _commiter, NP2CRS_R_001_024_DumpCrossRankListByUs _msg)
    {
        //查询跨服排行集合信息
        ...
        _commiter.commitSucRes(NPWriter_001_CrossRankOp.make_024_GetCrossRankBaseListByUs(
                rankList.dumpRankObjListWithLimitRankByUs(_usId -> _msg.getUsId() == _usId, _msg.getLimitRank())));
    }
}
