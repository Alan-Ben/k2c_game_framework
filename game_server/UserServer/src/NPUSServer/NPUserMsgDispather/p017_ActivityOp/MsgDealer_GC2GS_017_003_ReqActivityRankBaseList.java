...
import GC2GS.p017_ActivityOp.GC2GS_017_003_ReqActivityRankBaseList;
...
public class MsgDealer_GC2GS_017_003_ReqActivityRankBaseList extends NPUserMsgDealer<GC2GS_017_003_ReqActivityRankBaseList>
{
    @Override
    protected void _dealMessage(_ANPUSUserBasicMsgItem _committer, GC2GS_017_003_ReqActivityRankBaseList _msg)
    {
        ...
        //获取排行榜基础数据列表
        rankInfo.makeRankBaseList(_msg.getIsCross(), RefGeneral.Ref().rank_show_max_num, (_result, _rankBaseList) ->
        {
            if (!_result.isSucc())
            {
            ...
            _committer.commitSucRes(US2GCWriter_017_ActivityOp.make_003_RetActivityRankBaseList(_rankBaseList));
        });
    }
}
