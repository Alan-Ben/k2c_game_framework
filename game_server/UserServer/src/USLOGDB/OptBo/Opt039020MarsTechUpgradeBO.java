...
public class Opt039020MarsTechUpgradeBO extends BaseOptLogBo {
    ...
    public Opt039020MarsTechUpgradeBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt039020MarsTechUpgradeBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt039020MarsTechUpgradeBO(rs));
    }
    ...
    public String getTableName() {
        return "`opt_039_020_mars_tech_upgrade`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_039_020_mars_tech_upgrade` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='火星-科技升级' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
