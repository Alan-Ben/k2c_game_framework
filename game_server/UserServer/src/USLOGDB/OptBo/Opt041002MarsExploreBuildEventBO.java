...
public class Opt041002MarsExploreBuildEventBO extends BaseOptLogBo {
    ...
    public Opt041002MarsExploreBuildEventBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt041002MarsExploreBuildEventBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt041002MarsExploreBuildEventBO(rs));
    }
    ...
    public String getTableName() {
        return "`opt_041_002_mars_explore_build_event`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_041_002_mars_explore_build_event` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='火星-探险创建事件' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
