 ...
 */
public interface _IEZProcessMonitor extends _IALProcessMonitor
{
    /**
    ...
    {
        CommLog.warn("Process:{} run onTimeout cost:{} extInfo:{}", _processTag, _processTime, _extInfo);
    }
    ...
    {
        //超时但是执行完了
        CommLog.warn("Process:{} run onTimeoutDone cost:{} extInfo:{}", _processTag, _processTime, _extInfo);
    }
    ...
    {
        CommLog.error("Process:{} run onException cost:{} extInfo:{} err:{}", _processTag, _processTimeMS, _exInfo, _ex);
    }
    ...
    {
        CommLog.error("Process:{} onProcessFailStop", _process.getFullProcessTag());
    }
