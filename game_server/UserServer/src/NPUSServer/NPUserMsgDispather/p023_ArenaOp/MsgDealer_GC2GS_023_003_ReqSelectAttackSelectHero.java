...
import GC2GS.p023_ArenaOp.GC2GS_023_003_ReqSelectAttackSelectHero;
...
public class MsgDealer_GC2GS_023_003_ReqSelectAttackSelectHero extends NPUserMsgDealer<GC2GS_023_003_ReqSelectAttackSelectHero>
{
    @Override
    protected void _dealMessage(_ANPUSUserBasicMsgItem _commiter, GC2GS_023_003_ReqSelectAttackSelectHero _msg)
    {
        ...
        promise.then(p->{
            userData.getArenaComponent().checkOpponentCanAttack(_msg.getOpponentCid(), EArenaAttackType.CELEBRITY_RANK, (_result) ->
            {
                if (!_result.isSucc())
                {
        ...
        //先选择对手
        promise.then(p->{
            userData.getArenaComponent().selectOpponent(_msg.getOpponentCid(), EArenaAttackType.CELEBRITY_RANK, _result ->
            {
                if (!_result.isSucc())
                {
                    _commiter.commitFailRes(_result.getCode());
