...
/**
 * 火星人口数量判断:min(:max) CS_MARS_PEOPLE_NUM
 * @author claude
 */
public class NPPlayerCondition_CS_MARS_PEOPLE_NUM extends _ANPBasicPlayerCondition
{
    ...
    public static NPPlayerCondition_CS_MARS_PEOPLE_NUM readStr(NPStringReader _reader)
    {
        ...
        if (null == minVS)
        {
            ALServerLog.Error("Can not read str for ENPPlayerConditionType.CS_MARS_PEOPLE_NUM[" + _reader.getSrcString() + "]");
            return null;
        }
