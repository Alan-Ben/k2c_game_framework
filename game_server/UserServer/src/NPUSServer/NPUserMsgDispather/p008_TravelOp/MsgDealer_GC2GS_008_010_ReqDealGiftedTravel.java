...
public class  MsgDealer_GC2GS_008_010_ReqDealGiftedTravel extends NPUserMsgDealer<GC2GS_008_010_ReqDealGiftedTravel>
{
    @Override
    protected void _dealMessage(_ANPUSUserBasicMsgItem _commiter, GC2GS_008_010_ReqDealGiftedTravel _msg)
    {
        ...
        //处理游历事件数据
        TravelEventDealerResult result = TravelEventDealerMgr.getInstance().dealEvent(ETravelEventType.GIFTDE, info, _msg, context);
        if(!result.isSucc())
        {
        ...
        _commiter.commitSucRes(US2GCWriter_008_TravelOp.make_010_RetDealGiftedTravel(result.getEventResult()));
