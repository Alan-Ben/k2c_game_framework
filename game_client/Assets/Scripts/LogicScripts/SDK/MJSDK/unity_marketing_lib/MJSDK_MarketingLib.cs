...
namespace MJSDK_Package
{
    ...
    /// marketing 组件
    /// </summary>
    public class MJSDK_MarketingLib
    {
        //组件标识符  — 库名
        private static string _g_MJSDK_LibName = "MJSDK_Marketing";
        //组件版本信息
        ...
        /// <summary>
        /// marketing-customEvent自定义事件上报
        /// </summary>
        /// <param name="_2SDK_Marketing_CustomEvent"></param>
        /// <param name="_sucDelegate"></param>
        /// <param name="_failDelegate"></param>
        public static void marketing_customEvent(MJSDK_2SDK_ThirdParty_customEvent_base _2SDK_Marketing_CustomEvent, Action<string> _sucDelegate, Action<int, string> _failDelegate)
        {
            ...
            if (!MJSDK_2SDK_ThirdParty_customEvent_base.checkParam(_2SDK_Marketing_CustomEvent))
            {
                if (_failDelegate != null)
                {
                    _failDelegate(MJSDK_AppleLoginError.C_Unity_Param_Miss, "marketing_customEvent --> Parameters are missing,event_key is null");
                }
                return;
            }

            MJSDK.sendMsgToPhonePlatform("marketing", "customEvent", JsonUtility.ToJson(_2SDK_Marketing_CustomEvent), new MJSDK_CallbackDealer_Action(_sucDelegate, _failDelegate));
        }
    }
}