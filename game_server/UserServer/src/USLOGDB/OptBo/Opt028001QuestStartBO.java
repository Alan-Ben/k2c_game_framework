...
public class Opt028001QuestStartBO extends BaseOptLogBo {
    ...
    public Opt028001QuestStartBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt028001QuestStartBO(rs));
    }
    ...
    public String getTableName() {
        return "`opt_028_001_quest_start`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_028_001_quest_start` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='任务-玩家开启任务' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
