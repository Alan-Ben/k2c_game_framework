...
{
    /// <summary>
    /// 相机正交下的视野范围以 EaseType 的曲线改变到目标值的控制器
    /// </summary>
    public class CameraOrthographicSizeEaseController : _ACameraOrthographicSizeController
    {
        ...
        public CameraOrthographicSizeEaseController(float _targetValue, EaseType _easeType, float _totalTime, Action _complete = null)
        {
        ...
        public CameraOrthographicSizeEaseController(float _targetValue, float _totalTime, Action _complete = null)
        {
            _m_targetValue = _targetValue;
            _m_easeType = GGameCommonInfo.instance.obj == null
                ? EaseType.InOutQuad
                : GGameCommonInfo.instance.obj.defaultValueEaseType;
            _m_totalTime = _totalTime;
            _m_complete = _complete;
        }
        ...
        {
            _m_startValue = _cameraOrthographicSize;
            _m_currentTime = 0;
        }
