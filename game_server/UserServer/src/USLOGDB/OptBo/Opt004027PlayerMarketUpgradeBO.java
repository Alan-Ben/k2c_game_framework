...
public class Opt004027PlayerMarketUpgradeBO extends BaseOptLogBo {
    ...
    public static final int FIELD_market_lvl =8;
    @DataBaseField(type = "bigint(20)", fieldname = "market_lvl", comment = "市场当前等级")
    private long market_lvl;

    public Opt004027PlayerMarketUpgradeBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt004027PlayerMarketUpgradeBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
        ...
        market_lvl = rs.getLong(10);
    }

    @Override
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt004027PlayerMarketUpgradeBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `market_id`, `market_lvl`";
    }

    @Override
    public String getTableName() {
        return "`opt_004_027_player_market_upgrade`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_004_027_player_market_upgrade` ("
                ...
                + "`market_lvl` bigint(20) NOT NULL DEFAULT '0' COMMENT '市场当前等级',"
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='玩家-升级市场' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
