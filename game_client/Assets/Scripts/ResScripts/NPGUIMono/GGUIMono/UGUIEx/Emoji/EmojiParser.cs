...
namespace CEmoji
{
	public class EmojiParser : ScriptableObject
	{
		/**
         *
         * \p{Emoji}
		...
		*/
		...
		protected int GetCurrentCharSize()
		{
			return charUnitList.Count;
		}

		protected List<CharacterNode> GetCharacterList()
		{
			return charUnitList;
		}
		...
		protected void Parse(string str, int end=-1)
		{
			if(end == -1)
			{
				end = str.Length;
