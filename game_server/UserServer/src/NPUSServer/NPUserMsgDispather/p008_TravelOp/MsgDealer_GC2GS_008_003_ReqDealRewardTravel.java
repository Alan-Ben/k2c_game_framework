...
public class  MsgDealer_GC2GS_008_003_ReqDealRewardTravel extends NPUserMsgDealer<GC2GS_008_003_ReqDealRewardTravel>
{
    @Override
    protected void _dealMessage(_ANPUSUserBasicMsgItem _commiter, GC2GS_008_003_ReqDealRewardTravel _msg)
    {
        ...
        //处理游历事件数据
        TravelEventDealerResult result = TravelEventDealerMgr.getInstance().dealEvent(ETravelEventType.REWARD, info, _msg, context);
        if(!result.isSucc())
        {
        ...
        _commiter.commitSucRes(US2GCWriter_008_TravelOp.make_003_RetDealRewardTravel(result.getEventResult()));
