 ...
 * 取消弹劾事件
 */
public class RequestDealer_NP2US_R_032_025_ReqCancelLeaderImpeachEvent extends _ATRequestDealer_GuildOp<GC2GS_032_025_ReqCancelLeaderImpeachEvent>
{
    public RequestDealer_NP2US_R_032_025_ReqCancelLeaderImpeachEvent(NPUserServer _server)
    {
        super(_server);
    }

    @Override
    protected void _dealGuildMessage(GuildMsgCommiter _committer, GC2GS_032_025_ReqCancelLeaderImpeachEvent _msg)
    {
        ...
        Result result = guildInfo.getEventMgr().cancelEvent(_msg.getEventDbId());
        if (!result.isSucc())
        {
        ...
        _committer.commitSucRes(US2GCWriter_032_GuildOp.make_025_RetCancelLeaderImpeachEvent());
    }
