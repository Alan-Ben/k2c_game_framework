...
/// </summary>
public class WCGConditionRangeCondition extends _AWCGBasicSingleCondition
{
    ...
    {
        return EWCGSingleConditionType.RNG_D_COND;
    }

    public static WCGConditionRangeCondition read(String _infoStr)
    {
        WCGConditionRangeCondition obj = new WCGConditionRangeCondition();
