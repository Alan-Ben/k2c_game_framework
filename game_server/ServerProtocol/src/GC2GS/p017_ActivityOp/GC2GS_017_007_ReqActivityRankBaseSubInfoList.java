 ...
 * 请求排行榜子数据列表
 **/
public class GC2GS_017_007_ReqActivityRankBaseSubInfoList implements ALBasicProtocolPack._IALProtocolStructure {
/** 活动实例id */
...
public GC2GS_017_007_ReqActivityRankBaseSubInfoList() {
	instanceId = (long)0;
	rankId = (long)0;
	key = (long)0;
	isCross = false;
