...
import NPGameRes.GameObjs.HeroCondition.ConditionObj.HeroCondition_CS_STAR;
...
public class HeroConditionDealer_CS_STAR extends _AHeroConditionDealer
{
    @Override
    public EHeroConditionType conditionType()
    {
        return EHeroConditionType.CS_STAR;
    }

    @Override
    public boolean isEnable(_ABasicHeroCondition _cond, HeroInfo _heroInfo, NPVarInfo _varVariableInfo)
    {
        HeroCondition_CS_STAR cond = (HeroCondition_CS_STAR) _cond;
        return HeroConditionDealerMgr.isRange(_heroInfo.getStar(), cond.minValue(), cond.maxValue());
    }
}
