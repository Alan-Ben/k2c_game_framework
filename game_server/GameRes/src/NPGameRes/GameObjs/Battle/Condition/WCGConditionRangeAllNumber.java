...
public class WCGConditionRangeAllNumber extends _AWCGBasicSingleCondition
{
    ...
    {
        return EWCGSingleConditionType.RALL_NUM_D_COND;
    }

    public static WCGConditionRangeAllNumber read(String _infoStr)
    {
        WCGConditionRangeAllNumber obj = new WCGConditionRangeAllNumber();
        ...
        } catch (Exception e)
        {
            ...
            CommLog.error("条件配置错误 - Range_Enemy example: enum:range:enemy_type Error Str: " + _infoStr, e);
            return null;
        }
    }
}
