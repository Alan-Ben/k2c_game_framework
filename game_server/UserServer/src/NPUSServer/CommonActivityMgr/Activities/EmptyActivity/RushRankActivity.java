 ...
 * 冲榜活动
 */
public class RushRankActivity extends _AActivityBase
{
    public RushRankActivity(NPUserServer _server, ActivityBaseBO _bo)
    {
        super(_server, _bo);
    }
    ...
    {
        return ECommonActivityType.RUSH_RANK.ordinal();
    }
