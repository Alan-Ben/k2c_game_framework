...
import NPGateServer.RPCDispatcher.GSRpcDispatcher;
import RPC.RPCDataFactoryMgr;
import RPC._ARPCData;
import WCGBasicServerCommon.WCGBasicServerRequestProtocolSys._IWCGBasicRequestCommiter;


public class NPGSGeneral_255_RequestDispatcher extends NPRequestDispatcher
{
    public static void init(NPGSGeneralRequestDispather _dispather)
    {
        _dispather.regHandler(new NPRequestDealer<Common_R_255_001_ReqRpc>()
        {
            ...
            protected void _dealMessage(_IWCGBasicRequestCommiter _committer, Common_R_255_001_ReqRpc _msg)
            {
                ...
                GSRpcDispatcher.getInstance().dispatchRpc(_committer, rpcData);
            }
        });
    }
}
