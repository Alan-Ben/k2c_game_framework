...
/**
 * 给予已拥有的妃子亲密度（妃子id,数量） S_GAIN_X_CONSORT_INTIMACY_FROM:妃子id（高级公式）:数量（高级公式）
 */
public class NPPlayerEffect_S_GAIN_X_CONSORT_INTIMACY_FROM extends _ANPPlayerEffectInfo
{
    ...
    {
        return ENPPlayerEffectType.S_GAIN_X_CONSORT_INTIMACY_FROM;
    }

    public static NPPlayerEffect_S_GAIN_X_CONSORT_INTIMACY_FROM readStr(NPStringReader _reader)
    {
        if (_reader.isEmpty())
        {
        ...
        try
        {
            ...
            NPPlayerEffect_S_GAIN_X_CONSORT_INTIMACY_FROM obj = new NPPlayerEffect_S_GAIN_X_CONSORT_INTIMACY_FROM();
