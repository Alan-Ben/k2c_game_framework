...
public class TreasureHuntCompositeNormalSkillInfo extends _ATreasureHuntSkillInfo
{
    private TreasureHuntCompositeInfo _m_compositeInfo;

    public TreasureHuntCompositeNormalSkillInfo(TreasureHuntCompositeInfo _compositeInfo, RefTreasureHuntSkill _skillRef, int _level)
    {
    ...
    {
        return _m_compositeInfo.hadCollectAllOre();
    }
    ...
    protected void saveLevelToDB(int _level)
    {
        ...
        try
        {
            _m_compositeInfo.getBo().saveIsNormalSkillActive(_m_compositeInfo.getBMObj(), _level > 0);
