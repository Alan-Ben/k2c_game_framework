 ...
 * id 是string类型
 **/
    public class ALBasicSqliteStrKeySetRefCore<T> : _ATALBasicSqliteStrKeySetCore<T> where T : new()
    {
        ...
        public ALBasicSqliteStrKeySetRefCore(_AALSqliteMgr _sqliteMgr, string _assetPath, string _objName, string _tableName, string _keyName)
        {
