...
@RefBo(isIdAuto= true)
public class PlayerSkinBO extends BaseBO {
    ...
    public static final int FIELD_skinId =1;
    @DataBaseField(type = "bigint(20)", fieldname = "skinId", comment = "玩家形象Id")
    private long skinId;

    public static final int FIELD_skinLvl =2;
    @DataBaseField(type = "int(11)", fieldname = "skinLvl", comment = "玩家形象等级")
    private int skinLvl;
    ...
    public PlayerSkinBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        skinId = rs.getLong(3);
        skinLvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new PlayerSkinBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `skinId`, `skinLvl`";
    }
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `player_skin` ("
                + "`id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',"
                + "`cid` bigint(20) NOT NULL DEFAULT '0' COMMENT '玩家账号ID',"
                + "`skinId` bigint(20) NOT NULL DEFAULT '0' COMMENT '玩家形象Id',"
                + "`skinLvl` int(11) NOT NULL DEFAULT '0' COMMENT '玩家形象等级',"
                + "KEY `cid` (`cid`),"
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='玩家形象数据' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
