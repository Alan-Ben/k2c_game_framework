...
/// 模板窗口cache管理对象
/// </summary>
public abstract class _AALUITemplateWndSafeUnExpandCache<T_W, T_M> : _AALCacheUnExpandController<T_W, T_M>
    ...
    where T_W : _ATALBasicUISubWnd<T_M>
{
    ...
    public _AALUITemplateWndSafeUnExpandCache(Transform _parentTrans, int _minCount, int _maxCount)
