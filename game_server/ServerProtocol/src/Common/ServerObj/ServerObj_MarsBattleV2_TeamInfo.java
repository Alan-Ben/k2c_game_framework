 ...
 * 火星探险-队伍战斗信息组成
 **/
public class ServerObj_MarsBattleV2_TeamInfo implements ALBasicProtocolPack._IALProtocolStructure {
/** 队伍主加成，类似车头加成 */
private java.util.ArrayList<Common.ServerObj.ServerObj_MarsBattleV2_PropertyBonus> teamMajorBonus;
/** 参与队伍的所有成员信息 */
private java.util.ArrayList<Common.MarsObj.MarsBattleV2_MemberInfo> memberList;


public ServerObj_MarsBattleV2_TeamInfo() {
	teamMajorBonus = new java.util.ArrayList<Common.ServerObj.ServerObj_MarsBattleV2_PropertyBonus>();
	memberList = new java.util.ArrayList<Common.MarsObj.MarsBattleV2_MemberInfo>();
}

public ServerObj_MarsBattleV2_TeamInfo(
	 java.util.ArrayList<Common.ServerObj.ServerObj_MarsBattleV2_PropertyBonus> _teamMajorBonus
	, java.util.ArrayList<Common.MarsObj.MarsBattleV2_MemberInfo> _memberList
...
/** 参与队伍的所有成员信息 */
public java.util.ArrayList<Common.MarsObj.MarsBattleV2_MemberInfo> getMemberList() { return memberList; }
/** 参与队伍的所有成员信息 */
public void addMemberList(Common.MarsObj.MarsBattleV2_MemberInfo _memberList) { memberList.add(_memberList); }


public final int GetBufSize() {
	int _size = 0;
	_size += 2 + (teamMajorBonus.size() * 16);
	_size += 2 + (memberList.size() * 32);
...
public final void ReadUnzipBuf(ByteBuffer _buf, int _finalPos) {
	...
	for(int _i = 0; _i < _memberListCount; _i++) { 
		Common.MarsObj.MarsBattleV2_MemberInfo _memberList = new Common.MarsObj.MarsBattleV2_MemberInfo();
		if(_buf.remaining() <= 0) return;
