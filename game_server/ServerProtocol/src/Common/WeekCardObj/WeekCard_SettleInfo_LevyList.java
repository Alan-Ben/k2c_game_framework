 ...
 * 周卡-征收结算列表
 **/
public class WeekCard_SettleInfo_LevyList implements ALBasicProtocolPack._IALProtocolStructure {
/** 列表 */
private java.util.ArrayList<Common.WeekCardObj.WeekCard_SettleInfo_LevyInfo> list;


public WeekCard_SettleInfo_LevyList() {
	list = new java.util.ArrayList<Common.WeekCardObj.WeekCard_SettleInfo_LevyInfo>();
}

public WeekCard_SettleInfo_LevyList(
	 java.util.ArrayList<Common.WeekCardObj.WeekCard_SettleInfo_LevyInfo> _list
) {	list = _list;
}
...
/** 列表 */
public java.util.ArrayList<Common.WeekCardObj.WeekCard_SettleInfo_LevyInfo> getList() { return list; }
/** 列表 */
