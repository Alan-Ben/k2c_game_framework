...
public class PS_CSListener extends _ANPPSBasicServerListener
{
    private static PS_CSListener _g_instance = null;

    public static PS_CSListener getObj()
    {
        return _g_instance;
    }
    ...
    public PS_CSListener()
    {
        super(EServerType.SINGLE, ENPSingleServerType.COMMON.ordinal());
    }
    ...
    public void login()
    {
        ...
        ALServerLog.Sys("Common Server: " + getServerTypeId() + " Login!");
        _g_instance = this;
    }
    ...
    {
        ALServerLog.Sys("Common Server: " + getServerTypeId() + " Disconnect!");
        //设置全局变量
        _g_instance = null;
    }
