...
public class Gyro2DSettings
{
    ...
    // 相对屏幕的最大百分比位移
    public float maxDistancePercent;
    // 倾斜方向向量
    public Vector2 directionVector;
}

// 2d陀螺仪
public class NPMono2DGyro : NPMonoGyro
{
    // 目标物体
    public RectTransform target;

    // 水平设置
    public Gyro2DSettings horizontalSettings;
    public Gyro2DSettings verticalSettings;
    ...
    private float _m_fMaxDistanceX;
    private float _m_fMaxDistanceY;
    ...
    protected override void _onInit()
    {
        ...
        // 记录UI的原始位置
        _m_vOriginalPos = target.anchoredPosition;

        if (horizontalSettings != null)
        {
            // 水平方向一侧的最大位移
            _m_fMaxDistanceX = Screen.width * horizontalSettings.maxDistancePercent;
            // 最大旋转值
            _m_fMaxAbsRotationY = _m_fMaxDistanceX / horizontalSettings.sensitivity;
        ...
        {
            // 竖直方向一侧的最大位移
            _m_fMaxDistanceY = Screen.height * verticalSettings.maxDistancePercent;
            // 最大旋转值
            _m_fMaxAbsRotationX = _m_fMaxDistanceY / verticalSettings.sensitivity;
    ...
    protected override void _onMove(Vector3 _xyzAngle)
    {
        ...
        if (horizontalSettings != null && horizontalSettings.enable)
        {
            ...
            {
                _m_fHorizontalFrameMove = _m_fMaxDistanceX - _m_fHorizontalTotalMove;
            }
            // 向左过度旋转
        ...
        if (verticalSettings != null && verticalSettings.enable)
        {
            ...
            {
                _m_fVerticalFrameMove = _m_fMaxDistanceY - _m_fVerticalTotalMove;
            }
            // 向下过度旋转
        ...
        // 做位移
        target.anchoredPosition += new Vector2(_m_fTempValueX, _m_fTempValueY);
    }
    ...
    protected override void _onReset()
    {
        ...
        if (target != null)
            target.anchoredPosition = _m_vOriginalPos;
    }
}
