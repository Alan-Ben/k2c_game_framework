...
namespace GOE
{
    ...
    /// </summary>
    public class SubUIAddWnd_SingleMainNodeAddSceneNode : _AUISingleMainNodeAddSceneNode
    {
        ...
        public SubUIAddWnd_SingleMainNodeAddSceneNode(_AALBasicLoadUIWndBasicClass _addWnd, _AALBasicSubContainerScene _parentScene)
            : base()
        {
            _m_addWnd = _addWnd;
        ...
        public SubUIAddWnd_SingleMainNodeAddSceneNode(_AALBasicLoadUIWndBasicClass _addWnd, _AALBasicSubContainerScene _parentScene, string _nodeTag)
            : base(_nodeTag, true)
        {
            _m_addWnd = _addWnd;
            _m_scParentScene = _parentScene;
        ...
        public SubUIAddWnd_SingleMainNodeAddSceneNode(_AALBasicLoadUIWndBasicClass _addWnd, _AALBasicSubContainerScene _parentScene, string _nodeTag, Action _preEnterDone, Action _onEnterDone, bool _needTransBk)
        ...
        public SubUIAddWnd_SingleMainNodeAddSceneNode(_AALBasicLoadUIWndBasicClass _addWnd, _AALBasicSubContainerScene _parentScene, EUIQueueStageType _stageType, string _nodeTag, Action _preEnterDone, Action _onEnterDone, bool _needTransBk)
        ...
        protected override void _onEnterAddSceneDone()
        {
            ...
            if (null != _m_scParentScene)
                _m_scParentScene.showAddWnd(_m_addWnd, _onWndShowDone);
            else
                _onWndShowDone();
        }
