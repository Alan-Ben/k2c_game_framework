...
public enum ENPPlayerEffectType {
	...
	;
public static final ENPPlayerEffectType[]  ENPPlayerEffectType_Values = ENPPlayerEffectType.values();
public static final int ENPPlayerEffectType_Length = ENPPlayerEffectType_Values.length;
public static ENPPlayerEffectType ENPPlayerEffectType_FromInt(int _ivalue) {
	if(_ivalue < 0 || _ivalue >= ENPPlayerEffectType_Length){ return null; }
	return ENPPlayerEffectType_Values[_ivalue];
}
}
