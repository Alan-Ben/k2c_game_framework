...
import HttpServer.RPCDispatcher.HSRpcDispatcher;
...
public class NPHSGeneral_255_RequestDispatcher extends NPRequestDispatcher
{
    public static void init(NPRequestDispatcher _dispather)
    {
        _dispather.regHandler(new NPRequestDealer<Common_R_255_001_ReqRpc>()
        {
            ...
            protected void _dealMessage(_IWCGBasicRequestCommiter _committer, Common_R_255_001_ReqRpc _msg)
            {
                ...
                HSRpcDispatcher.getInstance().dispatchRpc(_committer, rpcData);
            }
        });
    }
}
