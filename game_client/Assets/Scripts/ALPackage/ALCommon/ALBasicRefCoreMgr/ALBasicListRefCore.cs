...
namespace ALPackage
{
    public class ALBasicListRefCore<T> : _ATALBasicRefListCore<T> where T : _IALBasicRefObj
    {
        ...
        public ALBasicListRefCore(_AALResourceCore _resCore, string _assetPath, string _objName)
        {
