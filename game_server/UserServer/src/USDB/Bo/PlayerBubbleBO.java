...
@RefBo(isIdAuto= true)
public class PlayerBubbleBO extends BaseBO {
    ...
    public static final int FIELD_bubbleId =1;
    @DataBaseField(type = "bigint(20)", fieldname = "bubbleId", comment = "头像ID")
    ...
    public PlayerBubbleBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        bubbleId = rs.getLong(3);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new PlayerBubbleBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `bubbleId`, `expireTimeS`, `viewed`, `need_check_send_mail`";
    }
    ...
    public String getItemsValue() {
        ...
        strBuf.append("'").append(bubbleId).append("', ");
    ...
    // 头像ID
    public long getBubbleId() { return this.bubbleId; }
    public void setBubbleId(BM _bm, long bubbleId) {
        if(bubbleId==this.bubbleId) 
            return;
        this.bubbleId = bubbleId; 
        markField(_bm, FIELD_bubbleId); 
    }
    public void saveBubbleId(BM _bm, long bubbleId) {
        if(bubbleId==this.bubbleId) 
            return;
        this.bubbleId = bubbleId;
        saveField(_bm, "bubbleId", bubbleId);
    }
    ...
    public String getUpdateKeyValue() {
        ...
        sBuilder.append(" `bubbleId` = '").append(bubbleId).append("',");
    ...
    public String getMarkedUpdateKeyValue() {
        ...
        if(isFieldMarked(FIELD_bubbleId)) sBuilder.append(" `bubbleId` = '").append(bubbleId).append("',");
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `player_bubble` ("
                + "`id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',"
                + "`cid` bigint(20) NOT NULL DEFAULT '0' COMMENT '玩家CID',"
                + "`bubbleId` bigint(20) NOT NULL DEFAULT '0' COMMENT '头像ID',"
                ...
                + "KEY `cid` (`cid`),"
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='User Info 玩家气泡框数据' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
