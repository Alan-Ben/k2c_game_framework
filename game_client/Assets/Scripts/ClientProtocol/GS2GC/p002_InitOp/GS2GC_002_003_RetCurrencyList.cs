...
public class GS2GC_002_003_RetCurrencyList : ALBasicProtocolPack._IALProtocolStructure {
private List<NPCommon.NPCommon_CurrencyInfo> currencyList;


public GS2GC_002_003_RetCurrencyList() {
	currencyList = new List<NPCommon.NPCommon_CurrencyInfo>();
}

public GS2GC_002_003_RetCurrencyList(
	List<NPCommon.NPCommon_CurrencyInfo> _currencyList
...
public List<NPCommon.NPCommon_CurrencyInfo> getCurrencyList() { return currencyList; }
public void addCurrencyList(NPCommon.NPCommon_CurrencyInfo _currencyList) { currencyList.Add(_currencyList); }


public int GetBufSize() {
	int _size = 0;
	_size += 2 + (currencyList.Count * 16);
