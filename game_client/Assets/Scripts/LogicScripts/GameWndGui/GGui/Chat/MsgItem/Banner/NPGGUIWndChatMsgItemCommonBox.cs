...
namespace GOE
{
    ...
    /// 宝箱分享banner
    /// </summary>
    public class NPGGUIWndChatMsgItemCommonBox : _ATNPGGUIWndPlayerChatMsgItem<NPGGUIMonoChatMsgItemCommonBox, NPChatMsgCommonBoxInfo>
    {
        private NPGGUIWndChatMsgItemCommonBoxSubPrefab _m_wCommonBoxSubPrefab;//宝箱附加窗口
        public NPGGUIWndChatMsgItemCommonBox(NPChatMsgCommonBoxInfo _detailInfo, Transform _parent, [NotNull] GUICacheMgrChatMsgItem _cacheMgr) : base(_detailInfo, _parent, _cacheMgr)
        {
        }
        ...
        private void _refreshSubPrefab()
        {
            ...
            else
            {
                ...
                _m_wCommonBoxSubPrefab = new NPGGUIWndChatMsgItemCommonBoxSubPrefab(uiResID, wnd.transParent);
