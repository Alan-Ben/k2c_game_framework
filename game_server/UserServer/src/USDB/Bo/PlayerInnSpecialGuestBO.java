...
@RefBo(isIdAuto= true)
public class PlayerInnSpecialGuestBO extends BaseBO {
    ...
    public PlayerInnSpecialGuestBO() {
        id = 0;
        cid = 0L;
        guest_id = 0L;
    ...
    public PlayerInnSpecialGuestBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new PlayerInnSpecialGuestBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `guest_id`, `had_draw_handbook_reward`";
    }

    @Override
    public String getTableName() {
        return "`player_inn_special_guest`";
    }
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `player_inn_special_guest` ("
                ...
                + "KEY `cid` (`cid`),"
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='玩家旅店 特殊客人数据' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
