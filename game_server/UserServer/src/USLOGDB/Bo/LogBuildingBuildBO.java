...
public class LogBuildingBuildBO extends BaseLogBo {
    ...
    public LogBuildingBuildBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        logType = rs.getInt(3);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new LogBuildingBuildBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `logType`, `event_id`, `guid`, `date_time`, `timestamp`, `building_id`";
    }

    @Override
    public String getTableName() {
        return "`log_building_build`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `log_building_build` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='建造建筑' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
