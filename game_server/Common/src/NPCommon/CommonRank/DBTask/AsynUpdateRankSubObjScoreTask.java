 ...
 *
 */
public class AsynUpdateRankSubObjScoreTask implements _IALAsynRunnableTask
{
    //管理器
    ...
    public AsynUpdateRankSubObjScoreTask(_IRankDBOper _rankListMgr, long _dbId, long _newScoreSourceId, long _newScore, long _updateMs)
    {
    ...
    public void run()
    {
        ...
        updateV.addValueObj(_m_rlmRankListMgr.getRankSubObjScoreSourceIdName(), _m_lNewScoreSourceId);
        updateV.addValueObj(_m_rlmRankListMgr.getRankSubObjScoreName(), _m_lNewScore);
        updateV.addValueObj(_m_rlmRankListMgr.getRankSubObjUpdatedMsName(), _m_lUpdateMs);
