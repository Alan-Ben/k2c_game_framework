...
public class Opt038001MarsRouteStartBO extends BaseOptLogBo {
    ...
    public Opt038001MarsRouteStartBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt038001MarsRouteStartBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt038001MarsRouteStartBO(rs));
    }
    ...
    public String getTableName() {
        return "`opt_038_001_mars_route_start`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_038_001_mars_route_start` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='前往火星-开启' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
