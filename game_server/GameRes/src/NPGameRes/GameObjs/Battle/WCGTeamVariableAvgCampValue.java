...
/// </summary>
public class WCGTeamVariableAvgCampValue extends _AWCGBasicTeamVariableObj
{
    ...
    protected WCGTeamVariableAvgCampValue()
    {
    }
    ...
    {
        return EWCGTeamVariableType.AVG_CAMP_VALUE;
    }


    public static WCGTeamVariableAvgCampValue readVariable(String _str)
    {
        WCGTeamVariableAvgCampValue variableObj = new WCGTeamVariableAvgCampValue();
