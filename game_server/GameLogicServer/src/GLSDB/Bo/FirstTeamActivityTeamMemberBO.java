...
@RefBo(isIdAuto= true)
public class FirstTeamActivityTeamMemberBO extends BaseBO {
    ...
    public static final int FIELD_team_id =1;
    @DataBaseField(type = "bigint(20)", fieldname = "team_id", comment = "队伍ID")
    ...
    public FirstTeamActivityTeamMemberBO() {
        id = 0;
        group_id = 0L;
        team_id = 0L;
        cid = 0L;
    ...
    public FirstTeamActivityTeamMemberBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        group_id = rs.getLong(2);
        team_id = rs.getLong(3);
        cid = rs.getLong(4);
    }
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new FirstTeamActivityTeamMemberBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `group_id`, `team_id`, `cid`";
    }

    @Override
    public String getTableName() {
        return "`first_team_activity_team_member`";
    }
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `first_team_activity_team_member` ("
