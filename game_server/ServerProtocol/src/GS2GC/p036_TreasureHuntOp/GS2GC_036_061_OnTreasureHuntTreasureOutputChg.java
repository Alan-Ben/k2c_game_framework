 ...
 * 太空寻宝-奇物产出变更
 **/
public class GS2GC_036_061_OnTreasureHuntTreasureOutputChg implements ALBasicProtocolPack._IALProtocolStructure {
/** 奇物产出信息 */
...
public final void ReadUnzipBuf(ByteBuffer _buf, int _finalPos) {
	...
	int _treasureOutputInfoCurPos = _buf.position();
	treasureOutputInfo.ReadUnzipBuf(_buf, _treasureOutputInfoCurPos + _treasureOutputInfoCustLen);
	_buf.position(_treasureOutputInfoCurPos + _treasureOutputInfoCustLen);
