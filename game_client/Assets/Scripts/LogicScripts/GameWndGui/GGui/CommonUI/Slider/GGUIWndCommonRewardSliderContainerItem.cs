...
namespace GOE
{
    ...
    /// 进度奖励item
    /// </summary>
    public class GGUIWndCommonRewardSliderContainerItem : _ATALBasicUISubWnd<GGUIMonoCommonRewardSliderContainerItem>
    {
        //奖励信息
        private _ISliderRewardItemInfo _m_info;
        //点击事件
        ...
        /// 奖励信息
        /// </summary>
        public _ISliderRewardItemInfo itemInfo { get { return _m_info; } }
        ...
        public GGUIWndCommonRewardSliderContainerItem(GGUIMonoCommonRewardSliderContainerItem _wnd) : base(_wnd)
        {
            initWnd();
        }
        ...
        public void setInfo(_ISliderRewardItemInfo _info)
        {
            if (_info == null)
                return;
