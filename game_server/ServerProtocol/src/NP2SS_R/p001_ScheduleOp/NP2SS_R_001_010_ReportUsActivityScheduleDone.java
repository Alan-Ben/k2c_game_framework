 ...
 * US上报完成活动排期
 **/
public class NP2SS_R_001_010_ReportUsActivityScheduleDone implements ALBasicProtocolPack._IALProtocolStructure {
private int usId;
/** 排期ID */
...
public NP2SS_R_001_010_ReportUsActivityScheduleDone() {
	usId = 0;
	scheduleId = (long)0;
	usGroupId = (long)0;
}
