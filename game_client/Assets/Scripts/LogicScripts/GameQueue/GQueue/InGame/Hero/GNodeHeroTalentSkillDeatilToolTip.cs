...
namespace GOE
{
    ...
    /// 伙伴资质技能详情跟随窗口
    /// </summary>
    public class GNodeHeroTalentSkillDetailToolTip : BaseQueueNode
    {
        /// <summary>
        ...
        private GGUIWndHeroTalentSkillDetailToolTip _m_wndToolTip;
        private long _m_lHeroId;
        private long _m_lTalentSkillId;


        public GNodeHeroTalentSkillDetailToolTip(long _heroId, long _talentSkillId, RectTransform _targetTransRoot, float _intervalX, float _intervalY)
        ...
        public override void EnterNode()
        {
            ...
            {
                _m_wndToolTip = new GGUIWndHeroTalentSkillDetailToolTip();
                _m_wndToolTip.load();
                _m_wndToolTip.regLoadDoneDelegate(() =>
                {
                    _m_wndToolTip.showWnd();
                    _m_wndToolTip.setInfo(_m_lHeroId, _m_lTalentSkillId, _m_targetTransRoot, _m_intervalX, _m_intervalY);
                });
            }
