...
public class LogCollegeSeatBO extends BaseLogBo {
    ...
    public static final int FIELD_seat_idx =6;
    @DataBaseField(type = "int(11)", fieldname = "seat_idx", comment = "席位ID")
    private int seat_idx;

    public static final int FIELD_hero_id =7;
    @DataBaseField(type = "bigint(20)", fieldname = "hero_id", comment = "入座席位的大臣ID")
    private long hero_id;

    public static final int FIELD_start_ms =8;
    @DataBaseField(type = "bigint(20)", fieldname = "start_ms", comment = "入座时间")
    private long start_ms;

    public LogCollegeSeatBO() {
        id = 0;
        event_id = 0;
        guid = 0L;
        date_time = 0;
    ...
    public LogCollegeSeatBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        ...
        cid = rs.getLong(6);
        logType = rs.getInt(7);
        seat_idx = rs.getInt(8);
        hero_id = rs.getLong(9);
        start_ms = rs.getLong(10);
    }

    @Override
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new LogCollegeSeatBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `event_id`, `guid`, `date_time`, `timestamp`, `cid`, `logType`, `seat_idx`, `hero_id`, `start_ms`";
    }

    @Override
    public String getTableName() {
        return "`log_college_seat`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `log_college_seat` ("
                ...
                + "`seat_idx` int(11) NOT NULL DEFAULT '0' COMMENT '席位ID',"
                + "`hero_id` bigint(20) NOT NULL DEFAULT '0' COMMENT '入座席位的大臣ID',"
                + "`start_ms` bigint(20) NOT NULL DEFAULT '0' COMMENT '入座时间',"
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='学院席位数据日志表' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
