...
public class Opt042001GuildMarsSendHelpBO extends BaseOptLogBo {
    ...
    public static final int FIELD_objType =8;
    @DataBaseField(type = "int(11)", fieldname = "objType", comment = "互助目标类型")
    private int objType;

    public static final int FIELD_objId =9;
    @DataBaseField(type = "bigint(20)", fieldname = "objId", comment = "互助目标ID")
    private long objId;

    public Opt042001GuildMarsSendHelpBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt042001GuildMarsSendHelpBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt042001GuildMarsSendHelpBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `guildId`, `objType`, `objId`";
    }

    @Override
    public String getTableName() {
        return "`opt_042_001_guild_mars_send_help`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_042_001_guild_mars_send_help` ("
                ...
                + "`objType` int(11) NOT NULL DEFAULT '0' COMMENT '互助目标类型',"
                + "`objId` bigint(20) NOT NULL DEFAULT '0' COMMENT '互助目标ID',"
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='发起联盟互助' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
