...
namespace GOE
{
    public class GGUIWndMarsExploreBossInfo : _ATALBasicUIWnd<GGUIMonoMarsExploreBattleInfo>, _IMarsExploreTeamSelectDealer
    {
        [NotNull] public static GGUIWndMarsExploreBossInfo instance { get { return _g_instance ??= new GGUIWndMarsExploreBossInfo(); } }
        private static GGUIWndMarsExploreBossInfo _g_instance;
        ...
        public GGUIWndMarsExploreBossInfo() 
        ...
        {
            QueueMgr.instance.forceCloseNodeByTag(UINodeTagConst.C_MARS_EXPLORE_BOSS_INFO);
        }
    }
}