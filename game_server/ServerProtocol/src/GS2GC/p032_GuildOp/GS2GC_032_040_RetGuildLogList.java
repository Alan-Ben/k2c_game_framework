...
public class GS2GC_032_040_RetGuildLogList implements ALBasicProtocolPack._IALProtocolStructure {
private java.util.ArrayList<Common.GuildObj.Guild_LogInfo> infoList;


public GS2GC_032_040_RetGuildLogList() {
	infoList = new java.util.ArrayList<Common.GuildObj.Guild_LogInfo>();
}

public GS2GC_032_040_RetGuildLogList(
	 java.util.ArrayList<Common.GuildObj.Guild_LogInfo> _infoList
) {	infoList = _infoList;
}
...
public java.util.ArrayList<Common.GuildObj.Guild_LogInfo> getInfoList() { return infoList; }
