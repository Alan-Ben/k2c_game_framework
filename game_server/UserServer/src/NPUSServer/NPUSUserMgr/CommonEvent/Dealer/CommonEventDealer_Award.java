...
import NPGameRes.Refs.CommonEvent.SubClass.RefCommonEventAward;
...
public class CommonEventDealer_Award extends _ACommonEventDealerNoExtra<RefCommonEventAward>
{
    @Override
    ...
    @Override
    public List<NPCommonCostItem> _getCmdRewardList(RefCommonEventAward _detailRef)
    {
        return getEventRewardList(_detailRef.event_reward_id);
    }

    @Override
    public ResultOne<CommonEvent_DoneInfo> _dealEvent(NPUSUserData _userData, RefCommonEventAward _eventRef, NPPlayerContext _context)
    {
        //领取奖励
