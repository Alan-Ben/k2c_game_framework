...
namespace GOE
{
    ...
    /// 联盟派遣Node
    /// </summary>
    public class GNodeGuildDispatch : BaseQueueNode
    {
        //回退按钮
        private NPGGUIWndInstanceCommonBack _m_cbCommonBackObj;
        
        public GNodeGuildDispatch() : base(EUIQueueStageType.MAIN)
        {
        }
        ...
        public override void EnterNode()
        {
            ...
            GUISceneMain.instance.showMainScene(GMainGUIAddSceneGuildDispatch.instance, _onAllSceneInited);
        }
