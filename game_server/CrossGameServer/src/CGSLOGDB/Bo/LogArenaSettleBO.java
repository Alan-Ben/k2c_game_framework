...
public class LogArenaSettleBO extends BaseLogBo {
    ...
    public static final int FIELD_rank =7;
    @DataBaseField(type = "int(11)", fieldname = "rank", comment = "名次")
    private int rank;

    public LogArenaSettleBO() {
        id = 0;
        event_id = 0;
        guid = 0L;
        date_time = 0;
    ...
    public LogArenaSettleBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new LogArenaSettleBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `event_id`, `guid`, `date_time`, `timestamp`, `instance_id`, `ref_id`, `cid`, `rank`";
    }

    @Override
    public String getTableName() {
        return "`log_arena_settle`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `log_arena_settle` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='擂台-结算日志' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
