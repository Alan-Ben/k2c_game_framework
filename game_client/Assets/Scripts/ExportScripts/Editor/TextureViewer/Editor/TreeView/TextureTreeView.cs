...
namespace TextureTool
{
    ...
    internal partial class TextureTreeView : TreeView
    {
        ...
        MethodInfo Method_GetWidthAndHeight = typeof(TextureImporter).GetMethod("GetWidthAndHeight", BindingFlags.NonPublic | BindingFlags.Instance);
        ...
        ***********************************************************************************/
        ...
        public Vector2Int getTexOriginSize(TextureImporter ti)
        {
            int width = 0;
            int height = 0;
        ...
        public void GetTextureOriginalSize(TextureImporter ti, out int width, out int height)
        {
            if (ti == null)
            {
                width = 0;
            ...
            if (Method_GetWidthAndHeight != null) 
        ...
        public void SetTexture(Texture2D[] textures, TextureImporter[] importers)
        {
            ...
            for (int i = 0; i < baseElements.Length; i++)
            {
                ...
                baseElements[i] = new TextureTreeElement
                {
                    ...
                    Texture = textures[i],
                    sptAtlas = SpriteAtlasCollect.instance.getAtlas(path),
                    TextureImporter = importers[i],
                    originSize = getTexOriginSize(importers[i]),
                };
            }
