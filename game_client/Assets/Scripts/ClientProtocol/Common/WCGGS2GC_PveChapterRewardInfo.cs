...
public class WCGGS2GC_PveChapterRewardInfo : ALBasicProtocolPack._IALProtocolStructure {
...
public override string ToString() {
	...
	builder.Append("takenRewardIndex").Append(":").Append(takenRewardIndex.ToString()).Append(", ");
	builder.Append("}");
