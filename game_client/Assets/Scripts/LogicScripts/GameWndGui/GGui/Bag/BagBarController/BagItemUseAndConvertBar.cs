...
namespace GOE
{
    ...
    /// 背包物品使用和合成面板
    /// </summary>
    public class BagItemUseAndConvertBar : _ABasicBagItemBar
    {
        /// <summary>
        /// 容器对象
        /// </summary>
        ...
        /// 出售物品的窗口对象
        /// </summary>
        private GGUIWndBagPopItemUseAndConvertSimple _m_siwUseItemWnd;

        public BagItemUseAndConvertBar(GGUIWndBagItemGrid _grid)
        {
            _m_igItemGrid = _grid;
            _m_siwUseItemWnd = new GGUIWndBagPopItemUseAndConvertSimple(_grid.wnd.gridAreaUIObj);
        }
        /// <summary>
        /// 是否在本行结束后才插入
        /// </summary>
