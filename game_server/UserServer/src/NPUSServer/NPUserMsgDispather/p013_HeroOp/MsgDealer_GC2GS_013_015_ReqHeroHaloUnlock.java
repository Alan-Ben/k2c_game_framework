...
import GC2GS.p013_HeroOp.GC2GS_013_015_ReqHeroHaloUnlock;
...
public class MsgDealer_GC2GS_013_015_ReqHeroHaloUnlock extends NPUserMsgDealer<GC2GS_013_015_ReqHeroHaloUnlock>
{
    @Override
    protected void _dealMessage(_ANPUSUserBasicMsgItem _committer, GC2GS_013_015_ReqHeroHaloUnlock _msg)
    {
        ...
        NPPlayerContext context = NPPlayerContext.createNew(ENPGameEvent.HERO_HALO_UNLOCK);
        ...
        //升级逻辑
        Result result = haloInfo.unlock(context);
        if (!result.isSucc())
        {
        ...
        _committer.commitSucRes(US2GCWriter_013_HeroOp.make_015_RetHeroHaloUnlock());
    }
}