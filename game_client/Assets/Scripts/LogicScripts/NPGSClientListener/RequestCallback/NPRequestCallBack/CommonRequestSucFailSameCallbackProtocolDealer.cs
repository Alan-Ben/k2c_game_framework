...
namespace GOE
{
    ...
    public class CommonRequestSucFailSameCallbackProtocolDealer<T> : _ANPRequestCallbackProtocolFailMsgDealer<T, T>
        where T : _IALProtocolStructure, new()
    {
        ...
        public CommonRequestSucFailSameCallbackProtocolDealer(Action<bool, T> _reqCallBack, Action<int> _dealFailErrorCode = null, bool _showErrorCodeTip = true, bool _needDispatch = false)
        {
