...
/// </summary>
public class WCGTeamVariableTeamValue extends _AWCGBasicTeamVariableObj
{
    ...
    protected WCGTeamVariableTeamValue()
    {
    }
    ...
    {
        return EWCGTeamVariableType.TEAM_VALUE;
    }


    public static WCGTeamVariableTeamValue readVariable(String _str)
    {
        WCGTeamVariableTeamValue variableObj = new WCGTeamVariableTeamValue();
