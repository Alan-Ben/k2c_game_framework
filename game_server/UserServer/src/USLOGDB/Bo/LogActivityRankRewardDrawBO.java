...
public class LogActivityRankRewardDrawBO extends BaseLogBo {
    ...
    public LogActivityRankRewardDrawBO() {
        id = 0;
        cid = 0L;
        instance_id = 0L;
        rank_id = 0L;
    ...
    public LogActivityRankRewardDrawBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new LogActivityRankRewardDrawBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `instance_id`, `rank_id`, `event_id`, `guid`, `date_time`, `timestamp`";
    }

    @Override
    public String getTableName() {
        return "`log_activity_rank_reward_draw`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `log_activity_rank_reward_draw` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='活动排行榜奖励领取日志' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
