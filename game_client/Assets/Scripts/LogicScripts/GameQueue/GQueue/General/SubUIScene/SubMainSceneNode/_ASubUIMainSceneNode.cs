...
namespace GOE
{
    ...
    /// </summary>
    public abstract class _ASubUIMainSceneNode : _ASubUISceneBasicNode
    {
        //是否纯UI界面
        ...
        public _ASubUIMainSceneNode()
            : base()
        {
            _m_bIsOnlyUINode = true;
        }
        public _ASubUIMainSceneNode(string _nodeUITag)
            : base(_nodeUITag)
        {
            _m_bIsOnlyUINode = true;
        }
        public _ASubUIMainSceneNode(string _nodeUITag, bool _isOnlyUINode)
            : base(_nodeUITag)
        {
            _m_bIsOnlyUINode = _isOnlyUINode;
        }
        public _ASubUIMainSceneNode(EUIQueueStageType _stageType, string _nodeUITag)
            : base(_stageType, _nodeUITag)
        {
            _m_bIsOnlyUINode = true;
        }
        public _ASubUIMainSceneNode(EUIQueueStageType _stageType, string _nodeUITag, bool _isOnlyUINode)
            : base(_stageType, _nodeUITag)
        {
            _m_bIsOnlyUINode = _isOnlyUINode;
        }
