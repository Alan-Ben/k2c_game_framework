...
public class NPISBasicServerListener extends _AWCGBSReceiverListener
{
    public NPISBasicServerListener(_AWCGBasicServer _server, EServerType _serverType, int _serverTypeId)
    {
    ...
    {
        NPISGeneralMsgDispather.getInstance().DealProtocol(this, _buf);
    }
    ...
    {
        NPISGeneralRequestDispather.getInstance().DealProtocol(_commiter, _buf);
    }
