...
public class Opt021026AchieveGainPointRewardBO extends BaseOptLogBo {
    ...
    public static final int FIELD_stepId =7;
    @DataBaseField(type = "bigint(20)", fieldname = "stepId", comment = "成就阶段奖励id")
    private long stepId;

    public Opt021026AchieveGainPointRewardBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt021026AchieveGainPointRewardBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt021026AchieveGainPointRewardBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `stepId`";
    }

    @Override
    public String getTableName() {
        return "`opt_021_026_achieve_gain_point_reward`";
    }
    ...
    public String getItemsValue() {
        ...
        strBuf.append("'").append(stepId).append("', ");
   ...
   @Override
    ...
    public void setStepId(BM _bm, long stepId) {
        if(stepId==this.stepId) 
            return;
        this.stepId = stepId; 
        markField(_bm, FIELD_stepId); 
    }
    public void saveStepId(BM _bm, long stepId) {
        if(stepId==this.stepId) 
            return;
        this.stepId = stepId;
        saveField(_bm, "stepId", stepId);
    }
    ...
    protected String getUpdateKeyValue() {
        ...
        sBuilder.append(" `stepId` = '").append(stepId).append("',");
    ...
    public String getMarkedUpdateKeyValue() {
        ...
        if(isFieldMarked(FIELD_stepId)) sBuilder.append(" `stepId` = '").append(stepId).append("',");
        sBuilder.deleteCharAt(sBuilder.length() - 1);
        return sBuilder.toString();
    }
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_021_026_achieve_gain_point_reward` ("
                ...
                + "`stepId` bigint(20) NOT NULL DEFAULT '0' COMMENT '成就阶段奖励id',"
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='玩家领取成就点奖励' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
