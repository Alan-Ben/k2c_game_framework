...
import NP2CRS_R.p001_CrossRankOp.NP2CRS_R_001_004_UnregCrossRank;
...
public class NPRequestDealer_001_004_UnregCrossRank extends NPRequestDealer<NP2CRS_R_001_004_UnregCrossRank>
{
    @Override
    protected void _dealMessage(_IWCGBasicRequestCommiter _commiter, NP2CRS_R_001_004_UnregCrossRank _msg)
    {
        //查询跨服排行集合信息
        ...
        {
            CommLog.error("remove joiner:[{}] from cross rank rankid:[{}] of cross instance:[{}] fail! can not find cross instance"
        ...
        if(null == rankList)
        {
            CommLog.error("remove joiner:[{}] from cross rank rankid:[{}] of cross instance:[{}] fail! can not find rank list for:[{}]"
        ...
        //移除参与者
        rankList.removeJoiner(_msg.getJoinerId());

        _commiter.commitSucRes(NPWriter_001_CrossRankOp.make_004_UnregCrossRank());
    }
}
