...
public class Opt015003ConsortUpBlessSkillBO extends BaseOptLogBo {
    ...
    public static final int FIELD_newLvl =10;
    @DataBaseField(type = "int(11)", fieldname = "newLvl", comment = "新等级")
    private int newLvl;

    public Opt015003ConsortUpBlessSkillBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt015003ConsortUpBlessSkillBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt015003ConsortUpBlessSkillBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `consortId`, `skillId`, `preLvl`, `newLvl`";
    }

    @Override
    public String getTableName() {
        return "`opt_015_003_consort_up_bless_skill`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_015_003_consort_up_bless_skill` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='妃子-升级祝福技能' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
