...
public class Opt037004GuildDungeonUpgradeLvlBO extends BaseOptLogBo {
    ...
    public static final int FIELD_preLvl =9;
    @DataBaseField(type = "int(11)", fieldname = "preLvl", comment = "原等级")
    private int preLvl;

    public static final int FIELD_curLvl =10;
    @DataBaseField(type = "int(11)", fieldname = "curLvl", comment = "现等级")
    private int curLvl;

    public Opt037004GuildDungeonUpgradeLvlBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt037004GuildDungeonUpgradeLvlBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt037004GuildDungeonUpgradeLvlBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `guildId`, `dungeonId`, `preLvl`, `curLvl`";
    }

    @Override
    public String getTableName() {
        return "`opt_037_004_guild_dungeon_upgrade_lvl`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_037_004_guild_dungeon_upgrade_lvl` ("
                ...
                + "`curLvl` int(11) NOT NULL DEFAULT '0' COMMENT '现等级',"
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='升级公会副本' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
