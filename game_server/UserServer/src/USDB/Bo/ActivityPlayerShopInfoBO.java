...
@RefBo(isIdAuto= true)
public class ActivityPlayerShopInfoBO extends BaseBO {
    ...
    public ActivityPlayerShopInfoBO() {
        id = 0;
        instance_id = 0L;
        shop_id = 0L;
        cid = 0L;
    ...
    public ActivityPlayerShopInfoBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new ActivityPlayerShopInfoBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `instance_id`, `shop_id`, `cid`, `next_refresh_time_ms`";
    }

    @Override
    public String getTableName() {
        return "`activity_player_shop_info`";
    }
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `activity_player_shop_info` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='活动玩家商店数据' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
