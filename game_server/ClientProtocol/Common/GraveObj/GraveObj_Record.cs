...
/// 杰出者记录
/// </summary>
public class GraveObj_Record : ALBasicProtocolPack._IALProtocolStructure {
/// <summary>
/// 玩家CID
/// </summary>
private long cid;
...
public override string ToString() {
	...
	builder.Append("achieveTs").Append(":").Append(achieveTs.ToString()).Append(", ");
	builder.Append("}");
