...
namespace UnityEditor.Rendering.Universal
{
    ...
    public class UniversalRendererDataEditor : ScriptableRendererDataEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.LabelField("GlobalParam", EditorStyles.boldLabel);
            EditorGUI.indentLevel++;
            MJUniversalRenderAPI.uiBlurState = (UIBlurState)EditorGUILayout.EnumPopup("UIBlurState", MJUniversalRenderAPI.uiBlurState);
            EditorGUI.indentLevel--;
