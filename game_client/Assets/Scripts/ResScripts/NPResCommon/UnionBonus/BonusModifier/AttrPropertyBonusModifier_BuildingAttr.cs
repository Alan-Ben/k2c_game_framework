...
namespace GOE
{
    ...
    /// 指定特长建筑
    /// </summary>
    public class AttrPropertyBonusModifier_BuildingAttr : _AAttrPropertyBonusModifier
    {
         ...
         * @return
         */
        public override EBonusFilterType getFilterType() { return EBonusFilterType.BUILDING_ATTR; }

        /**
         * 获取对应的子加成id筛选数据，如无筛选则返回0
         * @return ENPPropBonusType
         */
        public override long getBonusId() { return (long)_m_eAttrType; }
