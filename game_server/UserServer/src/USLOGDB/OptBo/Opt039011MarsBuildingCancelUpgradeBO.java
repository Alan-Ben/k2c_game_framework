...
public class Opt039011MarsBuildingCancelUpgradeBO extends BaseOptLogBo {
    ...
    public static final int FIELD_building_lvl =8;
    @DataBaseField(type = "int(11)", fieldname = "building_lvl", comment = "建筑当前等级")
    private int building_lvl;

    public Opt039011MarsBuildingCancelUpgradeBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt039011MarsBuildingCancelUpgradeBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
        ...
        building_lvl = rs.getInt(10);
    }

    @Override
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt039011MarsBuildingCancelUpgradeBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `building_id`, `building_lvl`";
    }

    @Override
    public String getTableName() {
        return "`opt_039_011_mars_building_cancel_upgrade`";
    }
    ...
    public String getItemsValue() {
        ...
        strBuf.append("'").append(building_lvl).append("', ");
   ...
   @Override
    ...
    // 建筑当前等级
    public int getBuildingLvl() { return this.building_lvl; }
    public void setBuildingLvl(BM _bm, int building_lvl) {
        if(building_lvl==this.building_lvl) 
            return;
        this.building_lvl = building_lvl; 
        markField(_bm, FIELD_building_lvl); 
    }
    public void saveBuildingLvl(BM _bm, int building_lvl) {
        if(building_lvl==this.building_lvl) 
            return;
        this.building_lvl = building_lvl;
        saveField(_bm, "building_lvl", building_lvl);
    }
    ...
    protected String getUpdateKeyValue() {
        ...
        sBuilder.append(" `building_lvl` = '").append(building_lvl).append("',");
    ...
    public String getMarkedUpdateKeyValue() {
        ...
        if(isFieldMarked(FIELD_building_lvl)) sBuilder.append(" `building_lvl` = '").append(building_lvl).append("',");
        sBuilder.deleteCharAt(sBuilder.length() - 1);
        return sBuilder.toString();
    }
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_039_011_mars_building_cancel_upgrade` ("
                ...
                + "`building_lvl` int(11) NOT NULL DEFAULT '0' COMMENT '建筑当前等级',"
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='火星-取消火星建筑升级' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
