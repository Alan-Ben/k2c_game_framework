...
namespace Hotfix
{
    ...
    /// 游戏中的基本信息对象存储对象
    /// </summary>
    public abstract class _ATHotfixBasicRefMapListCore<T> : _ATHotfixTextDefaultRefCore<T> where T : _IBaseHotfixRefObj, new()
    {
        //存储对应id索引的数据映射表
        ...
        public void addRef(T _refObj)
        {
            ...
            _checkInit();
            if(null == _m_refMap || null == _m_refList)
                return;
