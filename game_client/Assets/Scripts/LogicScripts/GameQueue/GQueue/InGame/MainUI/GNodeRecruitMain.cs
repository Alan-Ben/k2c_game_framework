...
namespace GOE
{
    ...
    /// 招募节点
    /// </summary>
    public class GNodeRecruitMain : BaseQueueNode
    {
        //回退按钮
        private NPGGUIWndInstanceCommonBack _m_cbCommonBackObj;

        public GNodeRecruitMain(): base(EUIQueueStageType.MAIN, UINodeTagConst.C_RECRUIT_MAIN)
        {
        ...
        public override void EnterNode()
        {
            ...
            // GTDSceneMain.instance.showMainScene(MainAdditionRecruitTDScene.instance, stepCounter.addDoneStepCount);//进入主界面3D场景
            stepCounter.addDoneStepCount();
            GUISceneMain.instance.showMainScene(GMainGUIAddSceneRecruitEntry.instance, stepCounter.addDoneStepCount);
        ...
        private void _showBackBtn()
        {
            ...
            //加载通用回退按钮
            _m_cbCommonBackObj = NPUIInstanceCommonBackController.instance.showCommonBack(EALUIWndLayer.NORMAL, () => { QueueMgr.instance.forceCloseNodeByTag(UINodeTagConst.C_RECRUIT_MAIN); }, UIResPathConst.WIN_COMMON_BACK);
            
            //处理的窗口加载完再移动到下一级，保证位置
            GMainGUIAddSceneRecruitEntry.instance.regInitDelegate(() =>
            {
                //放到最后
