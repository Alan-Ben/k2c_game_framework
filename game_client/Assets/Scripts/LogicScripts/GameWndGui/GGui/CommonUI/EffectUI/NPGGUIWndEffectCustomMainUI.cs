...
namespace GOE
{
    ...
    /// 效果加载自定义窗口
    /// </summary>
    public class NPGGUIWndEffectCustomMainUI : _ANPGGUIBasicWnd<NPGGUIMonoEffectCustomUI>
    {
        private static NPGGUIWndEffectCustomMainUI _g_instance;
        public static NPGGUIWndEffectCustomMainUI instance
        {
            get
            {
                if (_g_instance == null)
                    _g_instance = new NPGGUIWndEffectCustomMainUI();
                return _g_instance;
            }
        }
        ...
        private NPGGUIWndEffectCustomMainUI() : base(EALUIWndLayer.NORMAL)
        {
        ...
        {
            QueueMgr.instance.forceCloseNodeByTag(UINodeTagConst.C_EFFECT_CUSTOM_MAIN_UI);
        }
    }
}
