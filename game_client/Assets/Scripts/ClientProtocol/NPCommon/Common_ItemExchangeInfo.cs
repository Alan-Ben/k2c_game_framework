...
public class Common_ItemExchangeInfo : ALBasicProtocolPack._IALProtocolStructure {
/// <summary>
/// 兑换配置id
/// </summary>
...
public override string ToString() {
	...
	builder.Append("{");
	builder.Append("exchangeRefId").Append(":").Append(exchangeRefId.ToString()).Append(", ");
