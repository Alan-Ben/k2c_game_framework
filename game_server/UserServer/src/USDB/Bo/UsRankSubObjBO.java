...
@RefBo(isIdAuto= true)
public class UsRankSubObjBO extends BaseBO {
    ...
    public UsRankSubObjBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new UsRankSubObjBO(rs));
    }
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `us_rank_sub_obj` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='排行榜子数据' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
