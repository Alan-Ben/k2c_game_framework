...
public class NPPlayerEffect_S_SPEND_ITEM extends _ANPPlayerEffectInfo
{
    private ArrayList<NPCommonCostItem> _m_alItemObjList;

    public NPPlayerEffect_S_SPEND_ITEM()
    {
    ...
    public static NPPlayerEffect_S_SPEND_ITEM readStr(NPStringReader _reader)
    {
        if (_reader.isEmpty())
        {
            ALServerLog.Error("can not get effect S_SPEND_ITEM[" + _reader.getSrcString() + "]");
            return null;
        }

        NPPlayerEffect_S_SPEND_ITEM effect = new NPPlayerEffect_S_SPEND_ITEM();
        ...
        while (null != itemStr)
        {
            ...
            {
                ALServerLog.Error("can not get effect S_SPEND_ITEM[" + itemStr + "]");
                return null;
            }
