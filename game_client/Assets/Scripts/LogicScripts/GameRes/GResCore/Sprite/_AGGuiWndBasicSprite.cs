...
namespace GOE
{
     ...
     * 基础的图片加载窗口对象
     **/
    public abstract class _AGGuiWndBasicSprite
    {
        /** 本对象的操作序列号 */
        ...
        /** 当前资源对象 */
        private NPGSpriteResObj _m_roSpriteResObj;
        /** 资源管理对象 */
        private ALResObjSingleContainer _m_scSingleResContainer;

        public _AGGuiWndBasicSprite()
        {
            _m_iOpSerialize = 0;
        ...
        * 根据指定ID设置窗口的图片
        **/
        public void setTexture(NPGSpriteIndex _spriteIndex, Action<_ATALObjResObj<Sprite>> _doneDelegate = null)
        {
            ...
            //调用加载函数
            GSpriteResCore.instance.loadObj(_m_iTargetMainId, _m_iTargetSubId, _onSpriteLoaded + _doneDelegate);
        }
        ...
        public void gray()
        {
            GGameCommonInfo.grayImage(_getImage());
        }
        public void disGray()
        {
            GGameCommonInfo.disgrayImage(_getImage());
        }
        ...
        protected internal void _onSpriteLoaded(_ATALObjResObj<Sprite> _spriteResObj)
        {
            ...
            //设置资源对象
            _m_roSpriteResObj = (NPGSpriteResObj)_spriteResObj;
