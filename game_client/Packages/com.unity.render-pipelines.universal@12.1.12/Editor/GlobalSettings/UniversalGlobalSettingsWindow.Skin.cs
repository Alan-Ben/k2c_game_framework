...
namespace UnityEditor.Rendering.Universal
{
    internal partial class UniversalGlobalSettingsPanelIMGUI
    {
        internal class Styles
        {
            ...
            public static readonly GUIContent stripLightCookiesVariants = EditorGUIUtility.TrTextContent("Strip LightCookies Variants", "Controls whether strip disabled keyword variants if the feature is enabled.");
            public static readonly GUIContent forceUseSoftShadowVariants = EditorGUIUtility.TrTextContent("Force Use Soft Shadow Variants", "Controls whether strip disabled keyword variants if the feature is enabled.");
            public static readonly GUIContent stripMainLightShadowsCascade = EditorGUIUtility.TrTextContent("Force Strip Shadow Cascade", "Controls whether strip disabled keyword variants if the feature is enabled.");
            public static readonly GUIContent universalRenderPipelineCustomVariantCombineSetting = EditorGUIUtility.TrTextContent("Variants Combines Stripping");
