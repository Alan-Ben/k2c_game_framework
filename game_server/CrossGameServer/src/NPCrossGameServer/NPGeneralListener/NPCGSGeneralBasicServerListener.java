...
public class NPCGSGeneralBasicServerListener extends _ANPCGSBasicServerListener
{
    public NPCGSGeneralBasicServerListener(_AWCGBasicServer _server, EServerType _serverType, int _serverTypeId)
    {
