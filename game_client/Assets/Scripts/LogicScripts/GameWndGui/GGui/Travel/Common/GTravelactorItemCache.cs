...
{
    /// <summary>
    /// 情报信种可能出现的妃子或者npcitem缓存
    /// </summary>
    public class GTravelactorItemCache<T, TEMP> : _AALUICacheController<T, TEMP>
        ...
        where TEMP : _AALBasicUIWndMono
    {
        ...
        public GTravelactorItemCache(Transform _trans, int _minCount, int _maxCount)
        ...
        // 警告信息文字
        protected override string _warningTxt { get { return "GTravelactorItemCache"; } }
