...
namespace GOE
{
    ...
    /// 通用的物品进度条数字选择子窗口
    /// </summary>
    public class NPGGUIWndCommonItemNumSlider : _ATNPBasicSimpleUISubWnd<NPGGUIMonoCommonItemNumSlider>
    {
        ...
        public NPGGUIWndCommonItemNumSlider(NPGGUIMonoCommonItemNumSlider _wnd) : base(_wnd)
        {
            initWnd();
        }
