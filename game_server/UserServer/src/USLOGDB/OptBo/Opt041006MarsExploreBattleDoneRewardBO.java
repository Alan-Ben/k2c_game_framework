...
public class Opt041006MarsExploreBattleDoneRewardBO extends BaseOptLogBo {
    ...
    public Opt041006MarsExploreBattleDoneRewardBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
        ...
        exploreLvl = rs.getInt(9);
        eventInstanceId = rs.getLong(10);
        eventRefId = rs.getLong(11);
    }

    @Override
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt041006MarsExploreBattleDoneRewardBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `exploreLvl`, `eventInstanceId`, `eventRefId`";
    }

    @Override
    public String getTableName() {
        return "`opt_041_006_mars_explore_battle_done_reward`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_041_006_mars_explore_battle_done_reward` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='火星-火星探险领取完成奖励' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
