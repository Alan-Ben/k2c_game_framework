...
using UnityEngine;
    ...
    /// </summary>
    public abstract class _AFileWebResCore
    {
        ...
        // 资源版本的比对器
        protected _IALMD5FileVersionChecker _m_cMD5VersionChecker
        {
            get
            {
        ...
        private _IALMD5FileVersionChecker __m_cMD5VersionChecker;
        ...
        public _AFileWebResCore(string _remoteResRoot, string _localCacheRoot, string _streamingAssetsRoot, int _failRetryCount, int _downloadMaxDealingCount = 3)
        {
            //创建下载对象对象
            //获取当前系统安全的下载过程大小
        ...
        public void loadFromCacheOrDownload(string _resUrl, _AALWebResCoreLoadedDealer _loadDelegate)
        {
            ...
            _m_cMD5VersionChecker.checkResVersion(_resUrl, result =>
            {
                switch (result)
                {
                    case _IALMD5FileVersionChecker.VersionCheckResult.DeleteLocalFile:
                        // 删除本地文件
                        ...
                        _loadDelegate?.onLoadFail();
                        break;
                    case _IALMD5FileVersionChecker.VersionCheckResult.UpdateFromRemote:
                        // 下载远端文件到本地并使用
                        ...
                        break;
                    case _IALMD5FileVersionChecker.VersionCheckResult.UseLocalFile:
                        // 直接使用本地文件返回
                        ...
                        break;
                    case _IALMD5FileVersionChecker.VersionCheckResult.UseStreamingAssetsFile:
                        // 直接使用本地文件返回
                        ...
                        break;
                    case _IALMD5FileVersionChecker.VersionCheckResult.FileNotExist:
        ...
        // 交由子类生成对应的版本检查器
        protected abstract _IALMD5FileVersionChecker _createMD5FileVersionChecker();
        ...
        {
            private _AFileWebResCore _m_cResCore;
            private int _m_iRetryCount;
            private string _m_sResUrl;
            private long _m_lFileSize;
            private _AALWebResCoreLoadedDealer _m_dLoadDelegate;

            public _HttpDownloadDelegate(_AFileWebResCore _resCore, int _retryCountRemain, string _resUrl, long _fileSize, _AALWebResCoreLoadedDealer _loadDelegate) 
                : base()
            {
