...
public class Opt039022MarsTechCancelUpgradeBO extends BaseOptLogBo {
    ...
    public static final int FIELD_tech_lvl =8;
    @DataBaseField(type = "int(11)", fieldname = "tech_lvl", comment = "科技当前等级")
    private int tech_lvl;

    public Opt039022MarsTechCancelUpgradeBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt039022MarsTechCancelUpgradeBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
        ...
        tech_lvl = rs.getInt(10);
    }

    @Override
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt039022MarsTechCancelUpgradeBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `tech_id`, `tech_lvl`";
    }

    @Override
    public String getTableName() {
        return "`opt_039_022_mars_tech_cancel_upgrade`";
    }
    ...
    public String getItemsValue() {
        ...
        strBuf.append("'").append(tech_lvl).append("', ");
   ...
   @Override
    ...
    // 科技当前等级
    public int getTechLvl() { return this.tech_lvl; }
    public void setTechLvl(BM _bm, int tech_lvl) {
        if(tech_lvl==this.tech_lvl) 
            return;
        this.tech_lvl = tech_lvl; 
        markField(_bm, FIELD_tech_lvl); 
    }
    public void saveTechLvl(BM _bm, int tech_lvl) {
        if(tech_lvl==this.tech_lvl) 
            return;
        this.tech_lvl = tech_lvl;
        saveField(_bm, "tech_lvl", tech_lvl);
    }
    ...
    protected String getUpdateKeyValue() {
        ...
        sBuilder.append(" `tech_lvl` = '").append(tech_lvl).append("',");
    ...
    public String getMarkedUpdateKeyValue() {
        ...
        if(isFieldMarked(FIELD_tech_lvl)) sBuilder.append(" `tech_lvl` = '").append(tech_lvl).append("',");
        sBuilder.deleteCharAt(sBuilder.length() - 1);
        return sBuilder.toString();
    }
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_039_022_mars_tech_cancel_upgrade` ("
                ...
                + "`tech_lvl` int(11) NOT NULL DEFAULT '0' COMMENT '科技当前等级',"
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='火星-科技取消升级' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
