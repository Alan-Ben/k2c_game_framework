...
@RefBo(isIdAuto= true)
public class PlayerMarsSoldierBO extends BaseBO {
    ...
    public PlayerMarsSoldierBO() {
        id = 0;
        cid = 0L;
        lvl = 0;
    }

    public PlayerMarsSoldierBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        lvl = rs.getInt(3);
    }
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new PlayerMarsSoldierBO(rs));
    }
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `player_mars_soldier` ("
                + "`id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',"
                + "`cid` bigint(20) NOT NULL DEFAULT '0' COMMENT '玩家CID',"
                + "`lvl` int(11) NOT NULL DEFAULT '0' COMMENT '等级',"
                + "KEY `cid` (`cid`),"
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='玩家火星士兵数据' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
