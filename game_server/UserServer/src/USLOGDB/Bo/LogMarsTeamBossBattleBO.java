...
public class LogMarsTeamBossBattleBO extends BaseLogBo {
    ...
    public static final int FIELD_bossEventId =8;
    @DataBaseField(type = "bigint(20)", fieldname = "bossEventId", comment = "事件ID")
    private long bossEventId;
    ...
    public LogMarsTeamBossBattleBO() {
        id = 0;
        cid = 0L;
        event_id = 0;
        guid = 0L;
    ...
    public LogMarsTeamBossBattleBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new LogMarsTeamBossBattleBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `event_id`, `guid`, `date_time`, `timestamp`, `player_level`, `teamId`, `eventInstanceId`, `bossEventId`, `isWin`, `troopNum`, `teamPower`, `defencePower`";
    }

    @Override
    public String getTableName() {
        return "`log_mars_team_boss_battle`";
    }
    ...
    public String getItemsValue() {
        ...
        strBuf.append("'").append(bossEventId).append("', ");
   ...
   @Override
    ...
    // 事件ID
    public long getBossEventId() { return this.bossEventId; }
    public void setBossEventId(BM _bm, long bossEventId) {
        if(bossEventId==this.bossEventId) 
            return;
        this.bossEventId = bossEventId; 
        markField(_bm, FIELD_bossEventId); 
    }
    public void saveBossEventId(BM _bm, long bossEventId) {
        if(bossEventId==this.bossEventId) 
            return;
        this.bossEventId = bossEventId;
        saveField(_bm, "bossEventId", bossEventId);
    }
    ...
    protected String getUpdateKeyValue() {
        ...
        sBuilder.append(" `bossEventId` = '").append(bossEventId).append("',");
    ...
    public String getMarkedUpdateKeyValue() {
        ...
        if(isFieldMarked(FIELD_bossEventId)) sBuilder.append(" `bossEventId` = '").append(bossEventId).append("',");
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `log_mars_team_boss_battle` ("
                ...
                + "`bossEventId` bigint(20) NOT NULL DEFAULT '0' COMMENT '事件ID',"
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='火星队伍boss事件数据日志表' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
