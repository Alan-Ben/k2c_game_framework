...
public class NPPlayerCondition_CS_CONSORT_LIKE_COUNT extends _ANPBasicPlayerCondition
{
	//家人ID
    ...
    public static NPPlayerCondition_CS_CONSORT_LIKE_COUNT readStr(NPStringReader _reader)
    {
