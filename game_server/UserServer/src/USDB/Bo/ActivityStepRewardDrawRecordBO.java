...
@RefBo(isIdAuto= true)
public class ActivityStepRewardDrawRecordBO extends BaseBO {
    ...
    public static final int FIELD_step =3;
    @DataBaseField(type = "int(11)", fieldname = "step", comment = "阶段")
    private int step;

    public ActivityStepRewardDrawRecordBO() {
        id = 0;
    ...
    public ActivityStepRewardDrawRecordBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new ActivityStepRewardDrawRecordBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `activity_instance_id`, `step_reward_id`, `cid`, `step`";
    }

    @Override
    public String getTableName() {
        return "`activity_step_reward_draw_record`";
    }
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `activity_step_reward_draw_record` ("
