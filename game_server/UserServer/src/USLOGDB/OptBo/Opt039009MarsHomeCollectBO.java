...
public class Opt039009MarsHomeCollectBO extends BaseOptLogBo {
    ...
    public static final int FIELD_home_lvl =7;
    @DataBaseField(type = "int(11)", fieldname = "home_lvl", comment = "主基地等级")
    private int home_lvl;

    public Opt039009MarsHomeCollectBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt039009MarsHomeCollectBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
        ...
        home_lvl = rs.getInt(9);
    }

    @Override
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt039009MarsHomeCollectBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `home_lvl`";
    }

    @Override
    public String getTableName() {
        return "`opt_039_009_mars_home_collect`";
    }
    ...
    public String getItemsValue() {
        ...
        strBuf.append("'").append(home_lvl).append("', ");
   ...
   @Override
    ...
    // 主基地等级
    public int getHomeLvl() { return this.home_lvl; }
    public void setHomeLvl(BM _bm, int home_lvl) {
        if(home_lvl==this.home_lvl) 
            return;
        this.home_lvl = home_lvl; 
        markField(_bm, FIELD_home_lvl); 
    }
    public void saveHomeLvl(BM _bm, int home_lvl) {
        if(home_lvl==this.home_lvl) 
            return;
        this.home_lvl = home_lvl;
        saveField(_bm, "home_lvl", home_lvl);
    }
    ...
    protected String getUpdateKeyValue() {
        ...
        sBuilder.append(" `home_lvl` = '").append(home_lvl).append("',");
    ...
    public String getMarkedUpdateKeyValue() {
        ...
        if(isFieldMarked(FIELD_home_lvl)) sBuilder.append(" `home_lvl` = '").append(home_lvl).append("',");
        sBuilder.deleteCharAt(sBuilder.length() - 1);
        return sBuilder.toString();
    }
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_039_009_mars_home_collect` ("
                ...
                + "`home_lvl` int(11) NOT NULL DEFAULT '0' COMMENT '主基地等级',"
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='火星-基地资源收集' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
