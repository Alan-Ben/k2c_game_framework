...
namespace GOE
{
    ...
    /// 常驻联盟排行榜主界面
    /// </summary>
    public class GGUIMonoGuildRankFixedDetail : _ANPBasicUIWndResBarMono
    {
        [ALHeader("关闭按钮")]
        ...
        public List<GGUIMonoGuildRankFixedTopGuildInfo> monoTopPlayerList;
        [ALHeader("排名列表")]
        public GGUIMonoGuildRankFixedDetailGrid monoRankListGrid;
        [ALHeader("排名列表自己的信息")]
        public GGUIMonoGuildRankFixedTopGuildInfo monoSelfRankItem;
        [ALHeader("下一排行榜按钮")]
