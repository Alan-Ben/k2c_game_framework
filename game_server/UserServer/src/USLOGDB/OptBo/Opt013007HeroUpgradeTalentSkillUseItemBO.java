...
public class Opt013007HeroUpgradeTalentSkillUseItemBO extends BaseOptLogBo {
    ...
    public static final int FIELD_talent_skill_id =8;
    @DataBaseField(type = "bigint(20)", fieldname = "talent_skill_id", comment = "大臣天赋技能ID")
    private long talent_skill_id;

    public Opt013007HeroUpgradeTalentSkillUseItemBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt013007HeroUpgradeTalentSkillUseItemBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
        ...
        talent_skill_id = rs.getLong(10);
    }

    @Override
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt013007HeroUpgradeTalentSkillUseItemBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `hero_id`, `talent_skill_id`";
    }

    @Override
    public String getTableName() {
        return "`opt_013_007_hero_upgrade_talent_skill_use_item`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_013_007_hero_upgrade_talent_skill_use_item` ("
                ...
                + "`talent_skill_id` bigint(20) NOT NULL DEFAULT '0' COMMENT '大臣天赋技能ID',"
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='大臣-大臣升级天赋技能（使用物品）' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
