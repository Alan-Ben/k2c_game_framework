...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_UI_ScrollRect_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, set_horizontalNormalizedPosition_0);
            args = new Type[]{typeof(System.Single)};
            method = type.GetMethod("set_verticalNormalizedPosition", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_verticalNormalizedPosition_1);


        }


        static StackObject* set_horizontalNormalizedPosition_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* set_verticalNormalizedPosition_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
