...
public class LogDailyQuestBO extends BaseLogBo {
    ...
    public LogDailyQuestBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new LogDailyQuestBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `event_id`, `guid`, `date_time`, `timestamp`, `cid`, `logType`, `quest_id`, `refresh_serial`";
    }

    @Override
    public String getTableName() {
        return "`log_daily_quest`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `log_daily_quest` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='日常任务数据' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
