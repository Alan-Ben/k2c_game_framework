...
namespace GOE
{
    ...
    /// 通用带自定义文本的跟随窗口节点
    /// </summary>
    public class NPGNodeCommonToolTip : BaseQueueNode
    {
        /// <summary>
        ...
        private NPGGUIWndCommonItemToolTip _m_wndToolTip;
        
        public NPGNodeCommonToolTip(string _assetPath, string _assetName, RectTransform _targetTransRoot, float _interval)
        ...
        public override void EnterNode()
        {
            ...
            {
                _m_wndToolTip = new NPGGUIWndCommonItemToolTip(_m_sAssetPath, _m_sAssetName);
                _m_wndToolTip.load();
                _m_wndToolTip.regLoadDoneDelegate(() =>
                {
                    _m_wndToolTip.setPos(_m_targetTransRoot, _m_interval);
                });
            }
