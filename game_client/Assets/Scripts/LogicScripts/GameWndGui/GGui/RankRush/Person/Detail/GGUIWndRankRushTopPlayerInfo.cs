...
namespace GOE
{
    ...
    /// 冲榜详情前几名信息附加窗口
    /// </summary>
    public class GGUIWndRankRushTopPlayerInfo : _AGGUIWndBaseSubRankPlayerInfo<GGUIMonoRankRushTopPlayerInfo, NPRankCommonShowInfo>
    {
        public GGUIWndRankRushTopPlayerInfo(GGUIMonoRankRushTopPlayerInfo _wnd) : base(_wnd)
        {
            initWnd();
        }
