...
namespace UnityEngine.Experimental.Rendering.Universal
{
    public class RenderObjectsPass : ScriptableRenderPass
    {
        ...
        public RenderObjectsPass(string profilerTag, RenderPassEvent renderPassEvent, string[] shaderTags, RenderQueueType renderQueueType, int layerMask, SortingLayerRange sortingLayerRange, RenderObjects.CustomCameraSettings cameraSettings)
        {
            ...
            m_FilteringSettings.sortingLayerRange = sortingLayerRange;
        ...
        internal RenderObjectsPass(URPProfileId profileId, RenderPassEvent renderPassEvent, string[] shaderTags, RenderQueueType renderQueueType, int layerMask, SortingLayerRange sortingLayerRange, RenderObjects.CustomCameraSettings cameraSettings)
            : this(profileId.GetType().Name, renderPassEvent, shaderTags, renderQueueType, layerMask, sortingLayerRange, cameraSettings)
        {
