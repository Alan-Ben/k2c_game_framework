...
import GC2GS.p012_ActivityTeamOp.GC2GS_012_006_ReqJoinActivityTeam;
...
public class MsgDealer_GC2GS_012_006_ReqJoinActivityTeam extends NPUserMsgDealer<GC2GS_012_006_ReqJoinActivityTeam>
{
    @Override
    protected void _dealMessage(_ANPUSUserBasicMsgItem _commiter, GC2GS_012_006_ReqJoinActivityTeam _msg)
    {
        ...
        dealer.joinTeam(userData.toActivityTeamUserProto(), _msg.getTeamId(), userData.makeCrossTeamApplyValueList(), (_result, _team) ->
        {
            if (!_result.isSucc())
            {
            ...
            //返回结果
            _commiter.commitSucRes(US2GCWriter_012_ActivityTeamOp.make_006_RetJoinActivityTeam());
        });
    }
}
