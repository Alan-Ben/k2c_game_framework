...
namespace ALPackage
{
    ...
    /// 带按钮点击的输入框item
    /// </summary>
    public class ALInputFieldConfirmItem : _IALExportMenuInterface
    {
        ...
        public ALInputFieldConfirmItem(string _text, string _defaultValue,string _confirmStr,Action<string> _dealDone,int _btnWidth, int _height)
        {
            _m_sText = _text;
