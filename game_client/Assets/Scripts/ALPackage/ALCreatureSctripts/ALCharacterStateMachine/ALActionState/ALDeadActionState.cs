...
namespace ALPackage
{
    public class ALDeadActionState
        : _AALBaseCharacterActionState
    {
        public ALDeadActionState(_AALBasicCreatureControl _creature)
            : base(_creature)
        {
        }
        public ALDeadActionState(_AALBasicCreatureControl _creature, float _actionSpeed, ALSOCreatureActionInfo _relateAction)
            : base(_creature, _actionSpeed, _relateAction)
        {
        }
        public ALDeadActionState(_AALBasicCreatureControl _creature, float _actionSpeed, List<ALSOCreatureActionInfo> _relateActionList)
        ...
        {
            //死亡切换为死亡是合法的
            if (_newState.getState() == ALCharacterActionStateType.DEAD)
                return _newState;
        ...
        {
            return ALCharacterActionStateType.DEAD;
        }
