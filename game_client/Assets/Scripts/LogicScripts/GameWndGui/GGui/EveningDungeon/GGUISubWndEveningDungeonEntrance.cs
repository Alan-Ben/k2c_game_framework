...
namespace GOE
{
    public class GGUISubWndEveningDungeonEntrance : _ANPGGUIBasicSubWnd<GGUISubMonoEveningDungeonEntrance>
    {
        public GGUISubWndEveningDungeonEntrance(GGUISubMonoEveningDungeonEntrance _wnd) : base(_wnd)
        {
            initWnd();
        }
        ...
        protected override void _onShowWnd()
        {
            ...
            WinMsg.RegisterMsgAct(WinMsgType.SIMULATE_CLICK_EVENING_DUNGEON_ENTER, _onBtnEnter);
        }

        protected override void _onHideWnd()
        {
            WinMsg.UnregisterMsg(WinMsgType.ON_EVENING_DUNGEON_ACTIVITY_STATE_CHG, _onActivityStateChg);
            WinMsg.UnregisterMsgAct(WinMsgType.SIMULATE_CLICK_EVENING_DUNGEON_ENTER, _onBtnEnter);
        }
        ...
        private void _onBtnEnter()
        {
            if (wnd != null) 
                _onGameBtnClick(wnd.btnGame);
        }
        /// <summary>
        /// 点击进入游戏按钮
        /// </summary>
