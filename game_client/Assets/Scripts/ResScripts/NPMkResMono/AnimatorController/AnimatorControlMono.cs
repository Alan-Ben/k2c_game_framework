...
namespace GOE
{
    ...
    /// </summary>
    [Serializable]
    public class AnimatorControlRegInfo : _IAnimatorControlRegInfo, _IAnimatorControlGroupRegInfo
    {
        [ALHeader("动画对象注册名称")]
        ...
        public void playAnimator(string _stateName, float _normalizedTime)
        {
            ...
            for(int n = 0; n < animator.Count; n++)
            {
                ...
                if (_normalizedTime > 0)
                    animator[n].Play(_stateName, -1, _normalizedTime);
                else
                    animator[n].Play(_stateName);
            }
        }
        ...
        public void setBool(string _variableName, bool _value)
        {
            ...
            for(int n = 0; n < animator.Count; n++)
            {
                ...
                animator[n].SetBool(_variableName, _value);
            }
        }
        public void setFloat(string _variableName, float _value)
        {
            ...
            for(int n = 0; n < animator.Count; n++)
            {
                ...
                animator[n].SetFloat(_variableName, _value);
            }
        }
        public void setInteger(string _variableName, int _value)
        {
            ...
            for(int n = 0; n < animator.Count; n++)
            {
                ...
                animator[n].SetInteger(_variableName, _value);
            }
        }
    ...
    /// 注册动画控制对象的mono对象
    /// </summary>
    public class AnimatorControlMono : _ATAniControlMono<AnimatorControlRegInfo>
    {
    }
}
