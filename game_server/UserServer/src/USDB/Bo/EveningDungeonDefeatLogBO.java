...
@RefBo(isIdAuto= true)
public class EveningDungeonDefeatLogBO extends BaseBO {
    ...
    @DataBaseField(type = "bigint(20)", fieldname = "time_ms", comment = "时间戳")
    private long time_ms;

    public EveningDungeonDefeatLogBO() {
        id = 0;
        cid = 0L;
        time_ms = 0L;
    }

    public EveningDungeonDefeatLogBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new EveningDungeonDefeatLogBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `time_ms`";
    }

    @Override
    public String getTableName() {
        return "`evening_dungeon_defeat_log`";
    }
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `evening_dungeon_defeat_log` ("
                + "`id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',"
                + "`cid` bigint(20) NOT NULL DEFAULT '0' COMMENT '玩家ID',"
                + "`time_ms` bigint(20) NOT NULL DEFAULT '0' COMMENT '时间戳',"
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='晚间副本击败日志' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
