...
public class Opt039008MarsBuildingConfirmUpgradeBO extends BaseOptLogBo {
    ...
    public Opt039008MarsBuildingConfirmUpgradeBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt039008MarsBuildingConfirmUpgradeBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt039008MarsBuildingConfirmUpgradeBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `building_id`, `pre_lvl`, `cur_lvl`";
    }

    @Override
    public String getTableName() {
        return "`opt_039_008_mars_building_confirm_upgrade`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_039_008_mars_building_confirm_upgrade` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='火星-确认火星建筑升级完成' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
