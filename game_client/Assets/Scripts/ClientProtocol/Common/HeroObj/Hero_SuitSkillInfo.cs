...
/// 大臣套系技能信息
/// </summary>
public class Hero_SuitSkillInfo : ALBasicProtocolPack._IALProtocolStructure {
/// <summary>
/// 套系技能id
/// </summary>
...
public override string ToString() {
	...
	builder.Append("{");
	builder.Append("suitSkillId").Append(":").Append(suitSkillId.ToString()).Append(", ");
