...
half3 CalculateSimpleLight(Light light, InputData inputData, SurfaceData surfaceData)
{
    half3 lightColor = light.color * (light.distanceAttenuation * light.shadowAttenuation * saturate(dot(inputData.normalWS, light.direction)));
    lightColor *= surfaceData.albedo;
...
////////////////////////////////////////////////////////////////////////////////
/// Simple lighting NoSpecular...
////////////////////////////////////////////////////////////////////////////////
half4 UniversalFragmentSimpleLight(InputData inputData, SurfaceData surfaceData)
{
    #if defined(DEBUG_DISPLAY)
    half4 debugColor;
    ...
    if (IsMatchingLightLayer(mainLight.layerMask, meshRenderingLayers))
    {
        lightingData.mainLightColor += CalculateSimpleLight(mainLight, inputData, surfaceData);
    }
    ...
    for (uint lightIndex = 0; lightIndex < min(_AdditionalLightsDirectionalCount, MAX_VISIBLE_LIGHTS); lightIndex++)
    {
        ...
        if (IsMatchingLightLayer(light.layerMask, meshRenderingLayers))
        {
            lightingData.additionalLightsColor += CalculateSimpleLight(light, inputData, surfaceData);
        }
    }
    #endif
