...
public class MakeFaceShareDataBO extends BaseBO {
    ...
    public MakeFaceShareDataBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        serial = rs.getLong(2);
        data = rs.getBytes(3);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new MakeFaceShareDataBO(rs));
    }
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `make_face_share_data` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='捏脸分享数据' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
