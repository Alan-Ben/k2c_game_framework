...
public class Opt015010ConsortUpHaloLvlBO extends BaseOptLogBo {
    ...
    public Opt015010ConsortUpHaloLvlBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt015010ConsortUpHaloLvlBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt015010ConsortUpHaloLvlBO(rs));
    }
    ...
    public String getTableName() {
        return "`opt_015_010_consort_up_halo_lvl`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_015_010_consort_up_halo_lvl` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='妃子-升级星辉技能' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
