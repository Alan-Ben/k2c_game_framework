...
namespace ALPackage
{
    public abstract class _AGUIWndBasicTexture
    {
        /** 本对象的操作序列号 */
        ...
        **/
        ...
        public void setTexture(int _iMainID, int _iSubID)
        {
            ...
            if (null != rawImage && null == rawImage.texture)
                rawImage.texture = defaultTexture; //WCGGameCommonInfo.instance.obj.defaultTexture;
        ...
        public void gray()
        {
            GGameCommonInfo.grayImage(rawImage);
        }
        public void disGray()
        {
            GGameCommonInfo.disgrayImage(rawImage);
        }
        ...
        protected internal void _onTextureLoaded(int _mainId, int _subId, Texture _textureResObj)
        {
            ...
            {
                //设置图片
                rawImage.texture = _textureResObj;
            }
        ...
        protected abstract Material grayMat{ get; }
