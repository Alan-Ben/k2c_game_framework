...
public class  MsgDealer_GC2GS_008_004_ReqDealConsortBarTravel extends NPUserMsgDealer<GC2GS_008_004_ReqDealConsortBarTravel>
{
    @Override
    protected void _dealMessage(_ANPUSUserBasicMsgItem _commiter, GC2GS_008_004_ReqDealConsortBarTravel _msg)
    {
        ...
        //处理游历事件数据
        TravelEventDealerResult result = TravelEventDealerMgr.getInstance().dealEvent(ETravelEventType.CONSORT_BAR, info, _msg, context);
        if(!result.isSucc())
        {
        ...
        _commiter.commitSucRes(US2GCWriter_008_TravelOp.make_004_RetDealConsortBarTravel(result.getEventResult()));
