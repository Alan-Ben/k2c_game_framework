...
@RefBo(isIdAuto= true)
public class GuildDissolveBO extends BaseBO {
    ...
    public static final int FIELD_week_tag =19;
    @DataBaseField(type = "int(11)", fieldname = "week_tag", comment = "周标记")
    private int week_tag;

    public static final int FIELD_weekly_great_reward_point =20;
    @DataBaseField(type = "int(11)", fieldname = "weekly_great_reward_point", comment = "周清空 大礼进度")
    private int weekly_great_reward_point;

    public GuildDissolveBO() {
        id = 0;
        guild_id = 0L;
        flag_id = 0L;
        name = "";
        ...
        entrust_point = 0;
        week_tag = 0;
        weekly_great_reward_point = 0;
    }

    public GuildDissolveBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        ...
        week_tag = rs.getInt(21);
        weekly_great_reward_point = rs.getInt(22);
    }

    @Override
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new GuildDissolveBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `guild_id`, `flag_id`, `name`, `simple_name`, `declaration`, `announcement`, `level`, `exp`, `join_type`, `join_limit_info`, `is_dissovle`, `wealth`, `construct_list`, `last_proactive_trans_leader_time_ms`, `next_open_recruit_time_ms`, `entrust_ref_id`, `entrust_event_id`, `entrust_weight_base_list`, `entrust_point`, `week_tag`, `weekly_great_reward_point`";
    }

    @Override
    public String getTableName() {
        return "`guild_dissolve`";
    }
    ...
    public String getItemsValue() {
        ...
        strBuf.append("'").append(week_tag).append("', ");
        strBuf.append("'").append(weekly_great_reward_point).append("', ");
    ...
    public ArrayList<byte[]> getInsertValueBytes() {
        ...
        ret.add(construct_list);         return ret;
    }
    ...
    public ArrayList<byte[]> getMarkedValueBytes() {
        ...
        if(isFieldMarked(FIELD_construct_list)) ret.add(construct_list);         return ret;
    }
    ...
    // 周标记
    public int getWeekTag() { return this.week_tag; }
    public void setWeekTag(BM _bm, int week_tag) {
        if(week_tag==this.week_tag) 
            return;
        this.week_tag = week_tag; 
        markField(_bm, FIELD_week_tag); 
    }
    public void saveWeekTag(BM _bm, int week_tag) {
        if(week_tag==this.week_tag) 
            return;
        this.week_tag = week_tag;
        saveField(_bm, "week_tag", week_tag);
    }

    // 周清空 大礼进度
    public int getWeeklyGreatRewardPoint() { return this.weekly_great_reward_point; }
    public void setWeeklyGreatRewardPoint(BM _bm, int weekly_great_reward_point) {
        if(weekly_great_reward_point==this.weekly_great_reward_point) 
            return;
        this.weekly_great_reward_point = weekly_great_reward_point; 
        markField(_bm, FIELD_weekly_great_reward_point); 
    }
    public void saveWeeklyGreatRewardPoint(BM _bm, int weekly_great_reward_point) {
        if(weekly_great_reward_point==this.weekly_great_reward_point) 
            return;
        this.weekly_great_reward_point = weekly_great_reward_point;
        saveField(_bm, "weekly_great_reward_point", weekly_great_reward_point);
    }
    ...
    public String getUpdateKeyValue() {
        ...
        sBuilder.append(" `week_tag` = '").append(week_tag).append("',");
        sBuilder.append(" `weekly_great_reward_point` = '").append(weekly_great_reward_point).append("',");
    ...
    public String getMarkedUpdateKeyValue() {
        ...
        if(isFieldMarked(FIELD_week_tag)) sBuilder.append(" `week_tag` = '").append(week_tag).append("',");
        if(isFieldMarked(FIELD_weekly_great_reward_point)) sBuilder.append(" `weekly_great_reward_point` = '").append(weekly_great_reward_point).append("',");
        sBuilder.deleteCharAt(sBuilder.length() - 1);
        return sBuilder.toString();
    }
	
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `guild_dissolve` ("
                ...
                + "`week_tag` int(11) NOT NULL DEFAULT '0' COMMENT '周标记',"
                + "`weekly_great_reward_point` int(11) NOT NULL DEFAULT '0' COMMENT '周清空 大礼进度',"
    ...
    private int getBufferSize()
    {
        ...
        _size+=4;//week_tag
        _size+=4;//weekly_great_reward_point
         return _size;
    }
    ...
    public ByteBuffer toByteBuffer()
    {
        ...
        buff.putInt(week_tag);
        buff.putInt(weekly_great_reward_point);        
        return buff;
    }
    ...
    protected void readFromByteBuffer(ByteBuffer buff)
    {
        ...
        week_tag=buff.getInt();
        weekly_great_reward_point=buff.getInt(); 
    }
	@Override
