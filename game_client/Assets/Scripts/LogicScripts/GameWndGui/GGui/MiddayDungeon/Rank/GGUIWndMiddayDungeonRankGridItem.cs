...
namespace GOE
{
    ...
    /// 宴会排行榜列表item
    /// </summary>
    public class GGUIWndMiddayDungeonRankGridItem : _ANPGGUIBasicGridItemWnd<GGUIMonoMiddayDungeonRankGridItem>
    {
        //排行榜信息
        ...
        public GGUIWndMiddayDungeonRankGridItem(GGUIMonoMiddayDungeonRankGridItem  _wnd)
            : base(_wnd)
        {
            initWnd();
        }
        ...
        private void _refreshRankInfo()
        {
            ...
            ALUGUICommon.setLabelTxt(wnd.txtRankScore, _m_rankInfo.rankScore.ToLargeString(PrimitiveExtension.ELargeStringType.DEFAULT));
        }
