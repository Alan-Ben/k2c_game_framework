...
public class Opt014004ChildGraduateBO extends BaseOptLogBo {
    ...
    @DataBaseField(type = "bigint(20)", fieldname = "childId", comment = "未成年子嗣实例ID")
    private long childId;

    public static final int FIELD_adultId =8;
    @DataBaseField(type = "bigint(20)", fieldname = "adultId", comment = "成年子嗣实例ID")
    private long adultId;

    public Opt014004ChildGraduateBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt014004ChildGraduateBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
        ...
        adultId = rs.getLong(10);
    }

    @Override
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt014004ChildGraduateBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `childId`, `adultId`";
    }

    @Override
    public String getTableName() {
        return "`opt_014_004_child_graduate`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_014_004_child_graduate` ("
                ...
                + "`childId` bigint(20) NOT NULL DEFAULT '0' COMMENT '未成年子嗣实例ID',"
