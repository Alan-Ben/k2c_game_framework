...
public class Opt038002MarsRouteArriveBO extends BaseOptLogBo {
    ...
    public static final int FIELD_stage =7;
    @DataBaseField(type = "int(11)", fieldname = "stage", comment = "阶段")
    private int stage;

    public Opt038002MarsRouteArriveBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt038002MarsRouteArriveBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt038002MarsRouteArriveBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `stage`";
    }

    @Override
    public String getTableName() {
        return "`opt_038_002_mars_route_arrive`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_038_002_mars_route_arrive` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='前往火星-到达' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
