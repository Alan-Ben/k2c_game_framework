...
namespace GOE
{
    public class EnergyNormalMarsBuildingView : CommonNormalMarsBuildingView<GTDMonoMarsBuildingEnergyNormal>, _IEnergyMarsBuildingView
    {
        private GGUIWndMarsBuildingEnergyBtnFollowerController _m_energyBtnWnd;


        public EnergyNormalMarsBuildingView([NotNull] MarsBuildingInfo _buildingInfo) 
            : base(_buildingInfo)
        {
        }
