...
public class GS2GC_023_010_RetArenaBattleReport implements ALBasicProtocolPack._IALProtocolStructure {
private java.util.ArrayList<Common.ArenaObj.Arena_BattleReport> reportList;


public GS2GC_023_010_RetArenaBattleReport() {
	reportList = new java.util.ArrayList<Common.ArenaObj.Arena_BattleReport>();
}

public GS2GC_023_010_RetArenaBattleReport(
	 java.util.ArrayList<Common.ArenaObj.Arena_BattleReport> _reportList
...
public java.util.ArrayList<Common.ArenaObj.Arena_BattleReport> getReportList() { return reportList; }
public void addReportList(Common.ArenaObj.Arena_BattleReport _reportList) { reportList.add(_reportList); }


public final int GetBufSize() {
	int _size = 0;
	_size += 2 + (reportList.size() * 40);
