...
namespace GOE
{
    ...
    /// 火星实力变化上浮提示
    /// </summary>
    public class GGUIMonoMarsPowerTip : _AALBasicUIWndMono
    {
        [ALHeader("火星实力")]
        public Text txtMarsPower;
        [ALHeader("值的key(一个参数, 增加的实力值(带有大数缩写))")]
        ...
        public static string assetPath { get { return UIResPathAssistant.getAssetPath(2834); } }
        public static string objName { get { return UIResPathAssistant.getObjName(2834); } }
    }
}
