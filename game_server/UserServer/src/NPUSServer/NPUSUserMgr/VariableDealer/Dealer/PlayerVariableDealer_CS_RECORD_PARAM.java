...
import NPGameRes.GameObjs.PlayerVariable.PlayerVariableObj.NPPlayerVariable_CS_RECORD_PARAM;
...
public class PlayerVariableDealer_CS_RECORD_PARAM extends _ANPPlayerVariableDealer
{
    ...
    {
        NPPlayerVariable_CS_RECORD_PARAM obj = (NPPlayerVariable_CS_RECORD_PARAM) _variableObj;

        return _userData.getRecordComponent().getRecordCount(obj.paramType());
    }
}
