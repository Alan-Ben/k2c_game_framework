...
public class NPPlayerEffect_S_CHG_BUFF extends _ANPPlayerEffectInfo
{
    ...
    public static NPPlayerEffect_S_CHG_BUFF readStr(NPStringReader _reader)
    {
        if (_reader.isEmpty())
        {
            ALServerLog.Error("can not get effect S_CHG_BUFF[" + _reader.getSrcString() + "]");
            return null;
        }
        ...
        try
        {
            ...
            NPPlayerEffect_S_CHG_BUFF obj = new NPPlayerEffect_S_CHG_BUFF();
