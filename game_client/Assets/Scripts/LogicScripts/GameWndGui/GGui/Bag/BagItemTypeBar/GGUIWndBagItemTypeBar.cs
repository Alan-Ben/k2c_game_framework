...
{
    // 背包弹窗:类型bar
    public class GGUIWndBagItemTypeBar : _ANPGGUIBasicLoadPrefabSubWnd<GGUIMonoBagItemTypeBar>
    {
        ...
        public GGUIWndBagItemTypeBar(long _uiPathId,Transform _parent,Action _action)
            : base(_parent)
        {
