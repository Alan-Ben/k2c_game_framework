...
namespace GOE
{
    ...
    /// 太空寻宝 - 矿石详情ToolTip节点
    /// </summary>
    public class NPGNodeCommonToolTip_TreasureHuntOreDetail : BaseQueueNode
    {
        /// <summary>
        ...
        private NPGGUIWndCommonToolTip_TreasureHuntOreDetail _m_wndToolTip;
        
        public NPGNodeCommonToolTip_TreasureHuntOreDetail(NPCommonAssetPathInfo _assestPathInfo, _ITreasureHuntOreInfo _oreInfo, RectTransform _targetTransRoot, Vector2 _interval)
        ...
        public override void EnterNode()
        {
            ...
            {
                _m_wndToolTip = new NPGGUIWndCommonToolTip_TreasureHuntOreDetail(_m_iAssetPathInfo?.asset_path, _m_iAssetPathInfo?.obj_name);
                _m_wndToolTip.load();
                _m_wndToolTip.regLoadDoneDelegate(() =>
                {
                    _m_wndToolTip.setInfo(_m_oreInfo, _m_targetTransRoot, _m_interval);
                });
            }
