...
{
    unsafe class GOE_NPCommonPlayerResBarWndMgr_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(GOE.NPCommonPlayerResBarWndMgr);
            args = new Type[]{};
        ...
        static StackObject* get_instance_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = GOE.NPCommonPlayerResBarWndMgr.instance;
        ...
        static StackObject* showBar_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            GOE.NPCommonPlayerResBarWndMgr instance_of_this_method = (GOE.NPCommonPlayerResBarWndMgr)typeof(GOE.NPCommonPlayerResBarWndMgr).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
