...
namespace GOE
{
    ...
    /// 互助建筑正常状态视图
    /// </summary>
    public class AssistUpgradingMarsBuildingView : CommonUpgradingMarsBuildingView
    {
        ...
        public AssistUpgradingMarsBuildingView([NotNull] MarsBuildingInfo _buildingInfo) : base(_buildingInfo)
        {
        }
