...
namespace GOE
{
    ...
    /// 妃子指定邀约buff通用ToolTip
    /// </summary>
    public class GNodeCommonToolTip_ConsortAssignInviteBuff : BaseQueueNode
    {
        /// <summary>
        ...
        private GGUIWndCommonToolTip_ConsortAssignInviteBuff _m_wndToolTip;
        ...
        public GNodeCommonToolTip_ConsortAssignInviteBuff(long _assetPathId, RectTransform _targetTransRoot, float _intervalX, float _intervalY)
        ...
        public override void EnterNode()
        {
            ...
            {
                _m_wndToolTip = new GGUIWndCommonToolTip_ConsortAssignInviteBuff(_m_sAssetPath, _m_sAssetName);
                _m_wndToolTip.load();
                _m_wndToolTip.regLoadDoneDelegate(() =>
                {
                    _m_wndToolTip.showWnd();
                    _m_wndToolTip.setData(_m_targetTransRoot, _m_intervalX, _m_intervalY);
                });
            }
