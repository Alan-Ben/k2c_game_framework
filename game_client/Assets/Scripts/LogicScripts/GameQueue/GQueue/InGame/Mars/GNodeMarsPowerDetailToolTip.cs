...
namespace GOE
{
    ...
    /// 火星实力详情弹窗
    /// </summary>
    public class GNodeMarsPowerDetailToolTip : BaseQueueNode
    {
        /// <summary>
        ...
        private GGUIWndMarsPowerDetail _m_wndToolTip;
        private RectTransform _m_targetTransRoot;
        private float _m_intervalX;
        private float _m_intervalY;

        public GNodeMarsPowerDetailToolTip(RectTransform _targetTransRoot, float _intervalX, float _intervalY) : base(EUIQueueStageType.MAIN, UINodeTagConst.C_MARS_POWER_DETAIL)
        {
        ...
        public override void EnterNode()
        {
            ...
            {
                _m_wndToolTip = new GGUIWndMarsPowerDetail();
                _m_wndToolTip.load();
