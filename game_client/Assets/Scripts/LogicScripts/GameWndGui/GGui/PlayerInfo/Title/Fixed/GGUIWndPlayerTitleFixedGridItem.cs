...
namespace GOE
{
    ...
    /// 固定称号列表item
    /// </summary>
    public class GGUIWndPlayerTitleFixedGridItem : _ATALUGUIBasicGridItemWnd<GGUIMonoPlayerTitleFixedGridItem>
    {
        //称号信息
        private PlayerTitleRefObj _m_titleRef;
        //点击选中
        private Action<GGUIWndPlayerTitleFixedGridItem> _m_onClickSelect;
        //加载的底框
        ...
        public GGUIWndPlayerTitleFixedGridItem(GGUIMonoPlayerTitleFixedGridItem _wnd) : base(_wnd)
        {
        }
