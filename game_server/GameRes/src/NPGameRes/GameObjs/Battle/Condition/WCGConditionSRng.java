 ...
 **/
public class WCGConditionSRng extends _AWCGBasicSingleCondition
{
    /*目标对象高级公式*/
    ...
    {
        return EWCGSingleConditionType.S_RNG;
    }

    /**************
     * ai_value_range:idx:min:max - ai对应索引值的范围(idx索引暂定0-99)，min,max如为-1表示无限制
     **/
    public static WCGConditionSRng readCond(String _infoStr)
    {
        WCGConditionSRng obj = new WCGConditionSRng();
