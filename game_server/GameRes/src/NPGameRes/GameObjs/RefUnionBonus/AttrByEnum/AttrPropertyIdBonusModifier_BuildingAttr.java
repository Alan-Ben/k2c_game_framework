 ...
 *
 */
public class AttrPropertyIdBonusModifier_BuildingAttr extends _AAttrPropertyBonusModifier
{
     ...
     */
    @Override
    public EBonusFilterType getFilterType() {return EBonusFilterType.BUILDING_ATTR;}
