 ...
 */
public class AttrPropertyEnumBonusModifier_HeroArrt extends _AAttrPropertyBonusModifier
{
     ...
     */
    @Override
    public EBonusFilterType getFilterType() {return EBonusFilterType.HERO_ATTR;}
