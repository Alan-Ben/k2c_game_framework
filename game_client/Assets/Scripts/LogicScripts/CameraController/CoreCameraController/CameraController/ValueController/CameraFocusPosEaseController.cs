...
{
    /// <summary>
    /// 以 EaseType 的曲线实现相机焦点坐标移动
    /// </summary>
    public class CameraFocusPosEaseController : _ACameraFocusPosController
    {
        ...
        public CameraFocusPosEaseController(Vector3 _targetPos, EaseType _easeType, float _totalTime, Action _complete = null)
        {
        ...
        public CameraFocusPosEaseController(Vector3 _targetPos, float _totalTime, Action _complete = null)
        {
            _m_targetPos = _targetPos;
        ...
        {
            _m_startPos = _cameraFocusPosBeforeLimitation;
