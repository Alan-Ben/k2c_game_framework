...
public class Opt039001MarsBuildingCreateBO extends BaseOptLogBo {
    ...
    public Opt039001MarsBuildingCreateBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt039001MarsBuildingCreateBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt039001MarsBuildingCreateBO(rs));
    }
    ...
    public String getTableName() {
        return "`opt_039_001_mars_building_create`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_039_001_mars_building_create` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='火星-建造火星建筑' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
