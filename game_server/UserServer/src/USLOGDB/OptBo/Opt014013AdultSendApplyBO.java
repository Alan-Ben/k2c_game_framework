...
public class Opt014013AdultSendApplyBO extends BaseOptLogBo {
    ...
    public static final int FIELD_targetCid =8;
    @DataBaseField(type = "bigint(20)", fieldname = "targetCid", comment = "目标玩家CID")
    private long targetCid;

    public Opt014013AdultSendApplyBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt014013AdultSendApplyBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
        ...
        targetCid = rs.getLong(10);
    }

    @Override
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt014013AdultSendApplyBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `adultId`, `targetCid`";
    }

    @Override
    public String getTableName() {
        return "`opt_014_013_adult_send_apply`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_014_013_adult_send_apply` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='成年子嗣-发起指定联姻' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
