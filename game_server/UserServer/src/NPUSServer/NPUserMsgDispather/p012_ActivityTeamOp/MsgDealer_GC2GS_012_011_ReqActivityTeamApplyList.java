...
import GC2GS.p012_ActivityTeamOp.GC2GS_012_011_ReqActivityTeamApplyList;
...
public class MsgDealer_GC2GS_012_011_ReqActivityTeamApplyList extends NPUserMsgDealer<GC2GS_012_011_ReqActivityTeamApplyList>
{
    @Override
    protected void _dealMessage(_ANPUSUserBasicMsgItem _commiter, GC2GS_012_011_ReqActivityTeamApplyList _msg)
    {
        ...
        dealer.getTeamApplyList(_msg.getTeamId(), (_result, _applyList) ->
        {
            if (!_result.isSucc())
            {
            ...
            _commiter.commitSucRes(US2GCWriter_012_ActivityTeamOp.make_011_RetActivityTeamApplyList(_applyList));
        });
    }
}
