...
import GC2GS.p012_ActivityTeamOp.GC2GS_012_008_ReqDissolveActivityTeam;
...
public class MsgDealer_GC2GS_012_008_ReqDissolveActivityTeam extends NPUserMsgDealer<GC2GS_012_008_ReqDissolveActivityTeam>
{
    @Override
    protected void _dealMessage(_ANPUSUserBasicMsgItem _commiter, GC2GS_012_008_ReqDissolveActivityTeam _msg)
    {
        ...
        dealer.dissolveTeam(_msg.getTeamId(), userData.getCid(), (_result) ->
        {
            if (!_result.isSucc())
            {
            ...
            //返回结果
            _commiter.commitSucRes(US2GCWriter_012_ActivityTeamOp.make_008_RetDissolveActivityTeam());
        });
    }
}
