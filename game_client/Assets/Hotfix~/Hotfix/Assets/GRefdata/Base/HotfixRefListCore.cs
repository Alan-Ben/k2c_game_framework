...
namespace Hotfix
{
    ...
    public class HotfixRefListCore<T> : _ATHotfixBasicRefListCore<T> where T : _IBaseHotfixRefObj, new()
    {
        private _AALResourceCore _m_rcResCore;
        private string _m_sAssetPath;
        private string _m_sObjName;

        public HotfixRefListCore(_AALResourceCore _resCore, string _assetPath, string _objName)
        {
