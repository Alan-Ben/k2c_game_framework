...
import GC2GS.p012_ActivityTeamOp.GC2GS_012_002_ReqActivityTeam;
...
public class MsgDealer_GC2GS_012_002_ReqActivityTeam extends NPUserMsgDealer<GC2GS_012_002_ReqActivityTeam>
{
    @Override
    protected void _dealMessage(_ANPUSUserBasicMsgItem _commiter, GC2GS_012_002_ReqActivityTeam _msg)
    {
        ...
        dealer.getTeam(_msg.getTeamId(), (_result, _team)->
        {
            if (!_result.isSucc())
            {
            ...
            _commiter.commitSucRes(US2GCWriter_012_ActivityTeamOp.make_002_RetActivityTeam(_team));
        });
    }
}
