...
import DinnerServer.RPCDispatcher.DinnerRpcDispatcher;
...
public class NPCSGeneral_255_RequestDispatcher extends NPRequestDispatcher
{
    public static void init(NPCSGeneralRequestDispather _dispather)
    {
        _dispather.regHandler(new NPRequestDealer<Common_R_255_001_ReqRpc>()
        {
            ...
            protected void _dealMessage(_IWCGBasicRequestCommiter _committer, Common_R_255_001_ReqRpc _msg)
            {
                ...
                DinnerRpcDispatcher.getInstance().dispatchRpc(_committer, rpcData);
            }
        });
    }
}
