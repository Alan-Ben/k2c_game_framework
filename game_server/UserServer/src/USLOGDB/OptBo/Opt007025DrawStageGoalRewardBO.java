...
public class Opt007025DrawStageGoalRewardBO extends BaseOptLogBo {
    ...
    @DataBaseField(type = "bigint(20)", fieldname = "step", comment = "阶段")
    private long step;

    public static final int FIELD_task_id =8;
    @DataBaseField(type = "bigint(20)", fieldname = "task_id", comment = "任务ID")
    private long task_id;

    public Opt007025DrawStageGoalRewardBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt007025DrawStageGoalRewardBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
        ...
        step = rs.getLong(9);
        task_id = rs.getLong(10);
    }

    @Override
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt007025DrawStageGoalRewardBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `step`, `task_id`";
    }

    @Override
    public String getTableName() {
        return "`opt_007_025_draw_stage_goal_reward`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_007_025_draw_stage_goal_reward` ("
                ...
                + "`step` bigint(20) NOT NULL DEFAULT '0' COMMENT '阶段',"
                + "`task_id` bigint(20) NOT NULL DEFAULT '0' COMMENT '任务ID',"
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='阶段任务领取奖励日志' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
