...
public class Opt028003QuestDropBO extends BaseOptLogBo {
    ...
    public Opt028003QuestDropBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt028003QuestDropBO(rs));
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_028_003_quest_drop` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='任务-玩家放弃任务' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
