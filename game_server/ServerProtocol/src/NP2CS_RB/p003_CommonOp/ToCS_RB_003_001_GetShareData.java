package NP2CS_RB.p003_CommonOp;

import java.nio.ByteBuffer;
public class ToCS_RB_003_001_GetShareData implements ALBasicProtocolPack._IALProtocolStructure {
private byte[] data;


public ToCS_RB_003_001_GetShareData() {
	data = null;
}
