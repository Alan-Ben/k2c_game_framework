...
import PayCenter.Http.Core.QuestNode.NPOutBoundHttpQuestNode_PostJson;
import PayCenter.Http.Core.QuestNode.NPOutBoundHttpQuestNode_PostUrl;
import PayCenter.Http.Core.QuestNode._ANPOutBoundHttpQuestNode;
import PayCenter.Http.Core.Task.NPHttpSynTask_Tick;
import PayCenter.Http.HttpContorller.PayCenterHttpController;
 ...
 */
public class PayCenterHttpServiceCore
{
    /**
     * http服务
     */
    ...
    /// ///单例的//////
    private static final PayCenterHttpServiceCore _s_instance = new PayCenterHttpServiceCore();

    public static PayCenterHttpServiceCore getInstance()
    {
        return _s_instance;
    }

    private PayCenterHttpServiceCore()
    {
    ...
    public boolean init(int _port)
    {
        ...
        try
        {
            ...
            //获取指定包路径
            String pack = PayCenterHttpController.class.getPackage().getName();
     ...
     * @param _callBack        回包
     */
    public void httpPostJson(String _api, ArrayList<BasicHeader> _headerParamList, String _jsonObjStr, _IHttpCallBack _callBack)
    {
    ...
    public void httpPostUrlEntity(String _api, ArrayList<BasicHeader> _headerParamList,
                                  ArrayList<BasicNameValuePair> _paramList, _IHttpCallBack _callBack)
    {
