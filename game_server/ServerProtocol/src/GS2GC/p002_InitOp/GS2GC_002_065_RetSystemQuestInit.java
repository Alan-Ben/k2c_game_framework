 ...
 * 系统任务初始化
 **/
public class GS2GC_002_065_RetSystemQuestInit implements ALBasicProtocolPack._IALProtocolStructure {
/** 系统任务列表 */
private java.util.ArrayList<Common.QuestObj.SystemQuest_Info> infoList;


public GS2GC_002_065_RetSystemQuestInit() {
	infoList = new java.util.ArrayList<Common.QuestObj.SystemQuest_Info>();
}

public GS2GC_002_065_RetSystemQuestInit(
	 java.util.ArrayList<Common.QuestObj.SystemQuest_Info> _infoList
) {	infoList = _infoList;
}
...
/** 系统任务列表 */
public java.util.ArrayList<Common.QuestObj.SystemQuest_Info> getInfoList() { return infoList; }
/** 系统任务列表 */
