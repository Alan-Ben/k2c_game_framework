...
@RefBo(isIdAuto= true)
public class PlayerRoomSkinBO extends BaseBO {
    ...
    public static final int FIELD_roomSkinId =1;
    @DataBaseField(type = "bigint(20)", fieldname = "roomSkinId", comment = "房间皮肤ID")
    private long roomSkinId;

    public static final int FIELD_expireTimeS =2;
    @DataBaseField(type = "int(11)", fieldname = "expireTimeS", comment = "超时时间戳，0以下表示永久")
    ...
    public PlayerRoomSkinBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        roomSkinId = rs.getLong(3);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new PlayerRoomSkinBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `roomSkinId`, `expireTimeS`, `viewed`, `need_check_send_mail`";
    }

    @Override
    public String getTableName() {
        return "`player_room_skin`";
    }
    ...
    public String getItemsValue() {
        ...
        strBuf.append("'").append(roomSkinId).append("', ");
    ...
    // 房间皮肤ID
    public long getRoomSkinId() { return this.roomSkinId; }
    public void setRoomSkinId(BM _bm, long roomSkinId) {
        if(roomSkinId==this.roomSkinId) 
            return;
        this.roomSkinId = roomSkinId; 
        markField(_bm, FIELD_roomSkinId); 
    }
    public void saveRoomSkinId(BM _bm, long roomSkinId) {
        if(roomSkinId==this.roomSkinId) 
            return;
        this.roomSkinId = roomSkinId;
        saveField(_bm, "roomSkinId", roomSkinId);
    }
    ...
    public String getUpdateKeyValue() {
        ...
        sBuilder.append(" `roomSkinId` = '").append(roomSkinId).append("',");
    ...
    public String getMarkedUpdateKeyValue() {
        ...
        if(isFieldMarked(FIELD_roomSkinId)) sBuilder.append(" `roomSkinId` = '").append(roomSkinId).append("',");
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `player_room_skin` ("
                + "`id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',"
                + "`cid` bigint(20) NOT NULL DEFAULT '0' COMMENT '玩家CID',"
                + "`roomSkinId` bigint(20) NOT NULL DEFAULT '0' COMMENT '房间皮肤ID',"
                + "`expireTimeS` int(11) NOT NULL DEFAULT '0' COMMENT '超时时间戳，0以下表示永久',"
                ...
                + "KEY `cid` (`cid`),"
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='User Info 玩家房间皮肤数据' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
