...
namespace GOE
{
    ...
    /// 冲榜详情奖励页面
    /// </summary>
    public class GGUIWndRankRushDetailRewardPage : _ATALBasicLoadPrefabSubUIWnd<GGUIMonoRankRushDetailRewardPage>
    {
        private string _m_sAssetPath;//窗口对象的资源 加载路径
        private string _m_sObjName;//窗口对象的资源 名字
        private long _m_lSelfRank;//自己的排名
        private GGUIWndRankRushDetailRewardContainer _m_wRewardContainer;//奖励列表

        public GGUIWndRankRushDetailRewardPage(NPCommonAssetPathInfo _assetPathInfo, Transform _parent) : base(_parent)
        {
        ...
        protected override void _onWndInitDone()
        {
            ...
            if (wnd.monoRewardContainer != null)
                _m_wRewardContainer = new GGUIWndRankRushDetailRewardContainer(wnd.monoRewardContainer);
        }
