...
public class ALBasicResIndexInfo
{
    ...
    public ALBasicResIndexInfo()
    {
        
    }
    public ALBasicResIndexInfo(int _mainId, int _subId)
    {
        mainId = _mainId;
        subId = _subId;
    }
    public ALBasicResIndexInfo(string _str, string _columnName = "")
    {
     ...
     * 从字符串初始化数据
     **/
    public virtual void readIndex(string _str, string _columnName = "")
    {
...
//            Debug.LogError($"{_columnName}是空");
    ...
    public static bool operator ==(ALBasicResIndexInfo _a, ALBasicResIndexInfo _b)
    {
...
{
    public static string ToStringExt(this ALBasicResIndexInfo _self)
    {
        if(_self == null)
        {
            return "Null";
