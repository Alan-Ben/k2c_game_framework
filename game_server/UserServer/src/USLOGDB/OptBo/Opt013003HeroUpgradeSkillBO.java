...
public class Opt013003HeroUpgradeSkillBO extends BaseOptLogBo {
    ...
    public static final int FIELD_skill_id =8;
    @DataBaseField(type = "bigint(20)", fieldname = "skill_id", comment = "技能ID")
    private long skill_id;

    public Opt013003HeroUpgradeSkillBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt013003HeroUpgradeSkillBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
        ...
        skill_id = rs.getLong(10);
    }

    @Override
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt013003HeroUpgradeSkillBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `hero_id`, `skill_id`";
    }

    @Override
    public String getTableName() {
        return "`opt_013_003_hero_upgrade_skill`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_013_003_hero_upgrade_skill` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='大臣-大臣升级技能' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
