...
/// 请求CD组件初始化
/// </summary>
public class GS2GC_002_032_RetPlayerLazyCDList : ALBasicProtocolPack._IALProtocolStructure {
/// <summary>
/// cd数据列表
/// </summary>
private List<NPCommon.NPCommon_PlayerLazyCD> cdList;


public GS2GC_002_032_RetPlayerLazyCDList() {
	cdList = new List<NPCommon.NPCommon_PlayerLazyCD>();
}

public GS2GC_002_032_RetPlayerLazyCDList(
	List<NPCommon.NPCommon_PlayerLazyCD> _cdList
) {	cdList = _cdList;
}
...
/// cd数据列表
/// </summary>
public List<NPCommon.NPCommon_PlayerLazyCD> getCdList() { return cdList; }
/// <summary>
/// cd数据列表
/// </summary>
