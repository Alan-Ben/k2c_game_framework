...
{
    unsafe class ALPackage__ATALBasicUISubWnd_1_GGUIMonoCommonSimpleItem_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ALPackage._ATALBasicUISubWnd<GOE.GGUIMonoCommonSimpleItem>);
            args = new Type[]{};
        ...
        static StackObject* showWnd_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ALPackage._ATALBasicUISubWnd<GOE.GGUIMonoCommonSimpleItem> instance_of_this_method = (ALPackage._ATALBasicUISubWnd<GOE.GGUIMonoCommonSimpleItem>)typeof(ALPackage._ATALBasicUISubWnd<GOE.GGUIMonoCommonSimpleItem>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
