...
public class Opt015011ConsortGainCgRewardBO extends BaseOptLogBo {
    ...
    public static final int FIELD_cgId =7;
    @DataBaseField(type = "bigint(20)", fieldname = "cgId", comment = "CG")
    private long cgId;

    public Opt015011ConsortGainCgRewardBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt015011ConsortGainCgRewardBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt015011ConsortGainCgRewardBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `cgId`";
    }

    @Override
    public String getTableName() {
        return "`opt_015_011_consort_gain_cg_reward`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_015_011_consort_gain_cg_reward` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='妃子-领取CG奖励' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
