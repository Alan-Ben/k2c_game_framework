...
namespace GOE
{
    ...
    /// 跟随窗口节点
    /// </summary>
    public class GNodeCommonToolTip_TowerState : BaseQueueNode
    {
        /// <summary>
        ...
        private GGUIWndCommonToolTip_TowerState _m_wndToolTip;

        public GNodeCommonToolTip_TowerState(long _assetPathId, RectTransform _targetTransRoot, float _intervalX, float _intervalY)
        ...
        public override void EnterNode()
        {
            ...
            {
                _m_wndToolTip = new GGUIWndCommonToolTip_TowerState(_m_sAssetPath, _m_sAssetName);
                _m_wndToolTip.load();
