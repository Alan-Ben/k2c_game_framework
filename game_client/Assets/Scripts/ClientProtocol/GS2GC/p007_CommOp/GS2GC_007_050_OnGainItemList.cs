...
public class GS2GC_007_050_OnGainItemList : ALBasicProtocolPack._IALProtocolStructure {
/// <summary>
/// 奖励展示样式
/// </summary>
...
public void ReadUnzipBuf(ALProtocolBuf _buf, int _finalPos) {
	...
	rewardShowType = (NPEnum.ENpRewardShowType)_buf.getInt();
	 if(_finalPos > 0 && _buf.getCurPos() >= _finalPos) return ;
...
public void PutUnzipBuf(ALProtocolBuf _buf) {
	_buf.putInt((int)rewardShowType);
...
public override string ToString() {
	...
	builder.Append("{");
	builder.Append("rewardShowType").Append(":").Append(rewardShowType.ToString()).Append(", ");
