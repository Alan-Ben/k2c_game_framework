...
public class LogFixedCdBO extends BaseLogBo {
    ...
    public LogFixedCdBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        logType = rs.getInt(3);
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `log_fixed_cd` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='固定时间刷新cd数据日志表' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
