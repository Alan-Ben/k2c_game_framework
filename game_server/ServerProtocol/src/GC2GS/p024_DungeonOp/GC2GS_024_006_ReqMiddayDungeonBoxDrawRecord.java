 ...
 * 查询午间副本宝箱领取记录
 **/
public class GC2GS_024_006_ReqMiddayDungeonBoxDrawRecord implements ALBasicProtocolPack._IALProtocolStructure {
/** 宝箱数据ID */
private long dbId;


public GC2GS_024_006_ReqMiddayDungeonBoxDrawRecord() {
	dbId = (long)0;
}
