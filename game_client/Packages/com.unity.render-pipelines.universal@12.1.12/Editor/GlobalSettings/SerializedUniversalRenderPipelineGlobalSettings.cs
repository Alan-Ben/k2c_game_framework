...
namespace UnityEditor.Rendering.Universal
{
    class SerializedUniversalRenderPipelineGlobalSettings
    {
        ...
        public SerializedProperty stripLightCookiesVariants;
        public SerializedProperty forceUseSoftShadowVariants;
        public SerializedProperty stripMainLightShadowsCascade;
        public SerializedProperty universalRenderPipelineCustomVariantCombineSetting;
        ...
        public SerializedUniversalRenderPipelineGlobalSettings(SerializedObject serializedObject)
        {
            ...
            stripLightCookiesVariants = serializedObject.FindProperty("m_StripLightCookiesVariants");
            forceUseSoftShadowVariants = serializedObject.FindProperty("m_ForceUseSoftShadowVariants");
            stripMainLightShadowsCascade = serializedObject.FindProperty("m_StripMainLightShadowsCascade");
            universalRenderPipelineCustomVariantCombineSetting =
                serializedObject.FindProperty("m_UniversalRenderPipelineCustomVariantCombineSetting");
        }
    }
}
