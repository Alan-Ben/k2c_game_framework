...
/**
 * 火星建筑:建筑id:min(:max) CS_MARS_BUILDING_LVL
 * @author mark
 */
public class NPPlayerCondition_CS_MARS_BUILDING_LVL extends _ANPBasicPlayerCondition
{
    private long _m_lId;
    ...
    public static NPPlayerCondition_CS_MARS_BUILDING_LVL readStr(NPStringReader _reader)
    {
        ...
        {
            ALServerLog.Error("Can not read str for ENPPlayerConditionType.CS_MARS_BUILDING_LVL[" + _reader.getSrcString() + "]");
            return null;
        }
