...
public class GS2GC_016_006_RetDealChapterDispatchEvent : ALBasicProtocolPack._IALProtocolStructure {
/// <summary>
/// 达成数量
/// </summary>
...
public GS2GC_016_006_RetDealChapterDispatchEvent() {
	reachNum = 0;
...
/// 达成数量
/// </summary>
public int getReachNum() { return reachNum; }
/// <summary>
/// 达成数量
/// </summary>
public void setReachNum(int _reachNum) { reachNum = _reachNum; }
/// <summary>
/// 物品列表
/// </summary>
...
public override string ToString() {
	...
	builder.Append("{");
	builder.Append("reachNum").Append(":").Append(reachNum.ToString()).Append(", ");
