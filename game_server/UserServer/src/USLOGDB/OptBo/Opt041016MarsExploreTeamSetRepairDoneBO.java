...
public class Opt041016MarsExploreTeamSetRepairDoneBO extends BaseOptLogBo {
    ...
    public Opt041016MarsExploreTeamSetRepairDoneBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt041016MarsExploreTeamSetRepairDoneBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt041016MarsExploreTeamSetRepairDoneBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `teamId`";
    }

    @Override
    public String getTableName() {
        return "`opt_041_016_mars_explore_team_set_repair_done`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_041_016_mars_explore_team_set_repair_done` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='火星-火星队伍设置修复完成' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
