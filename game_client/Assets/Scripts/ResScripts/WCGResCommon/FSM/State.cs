...
namespace fsm {
    ...
    public class State {
        ...
        public static long g_serialize = 1;

        protected long m_serialize;

        public long Serialize { get { return m_serialize; } }
        ...
        public System.Action<State> onEnter = null;
        public System.Action<State> onExit = null;
        ...
        public virtual void EnterStates ( State _toEnter, State _toExit ) {
