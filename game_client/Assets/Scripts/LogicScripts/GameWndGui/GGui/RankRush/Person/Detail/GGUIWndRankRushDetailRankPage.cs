...
namespace GOE
{
    ...
    /// 冲榜详情排行榜页面
    /// </summary>
    public class GGUIWndRankRushDetailRankPage : _ATALBasicLoadPrefabSubUIWnd<GGUIMonoRankRushDetailRankPage>
    {
        private string _m_sAssetPath;//窗口对象的资源 加载路径
        private string _m_sObjName;//窗口对象的资源 名字
        private GGUIWndRankRushDetailRankGrid _m_wRankGrid;//排行榜列表

        public GGUIWndRankRushDetailRankPage(NPCommonAssetPathInfo _assetPathInfo, Transform _parent) : base(_parent)
        {
        ...
        protected override void _onWndInitDone()
        {
            ...
            if (wnd.monoRankGrid != null)
                _m_wRankGrid = new GGUIWndRankRushDetailRankGrid(wnd.monoRankGrid);
        }
        ...
        public void setInfo(ActivityRankRushRefObj _rankRushRef, List<NPRankCommonShowInfo> _rankShowInfoList)
        {
            if(wnd == null)
                return;
