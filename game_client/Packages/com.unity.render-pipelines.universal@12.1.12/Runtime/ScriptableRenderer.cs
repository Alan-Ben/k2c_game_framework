...
namespace UnityEngine.Rendering.Universal
{
    ...
    public abstract partial class ScriptableRenderer : IDisposable
    {
        ...
        /// <summary>
        /// m_FirstTimeCameraColorTargetIsBound时如果第一次绑定相机目标对象，则需要Clear。因为我们overlay UI相机做了直接往buffer里渲染，所以ui相机渲染的时候要开启这个参数，来触发ui相机的clear操作
        /// </summary>
        internal void setFirstTimeCameraColorTargetIsBound()
        {
