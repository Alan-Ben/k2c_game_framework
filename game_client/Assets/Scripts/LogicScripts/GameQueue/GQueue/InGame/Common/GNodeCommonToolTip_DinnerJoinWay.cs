...
namespace GOE
{
    ...
    /// 跟随窗口节点
    /// </summary>
    public class GNodeCommonToolTip_DinnerJoinWay : BaseQueueNode
    {
        /// <summary>
        ...
        private GGUIWndCommonToolTip_DinnerJoinWay _m_wndToolTip;
        private DinnerJoinWayDetail _m_dinnerJoinWayDetail;

        public GNodeCommonToolTip_DinnerJoinWay(DinnerJoinWayDetail _joinWayDetail, long _assetPathId, RectTransform _targetTransRoot, float _intervalX, float _intervalY)
            : base(EUIQueueStageType.NONE)
        {
            _m_dinnerJoinWayDetail = _joinWayDetail;
        ...
        public override void EnterNode()
        {
            ...
            {
                _m_wndToolTip = new GGUIWndCommonToolTip_DinnerJoinWay(_m_dinnerJoinWayDetail, _m_sAssetPath, _m_sAssetName);
                _m_wndToolTip.load();
