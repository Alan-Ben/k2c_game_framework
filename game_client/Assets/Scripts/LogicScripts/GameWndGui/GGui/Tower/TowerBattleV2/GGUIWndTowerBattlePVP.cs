...
namespace GOE
{
    ...
    /// 
    /// </summary>
    public class GGUIWndTowerBattlePVP : _ATALBasicUIWnd<GGUIMonoTowerBattlePVP>
    {
        private static GGUIWndTowerBattlePVP _g_instance = new GGUIWndTowerBattlePVP();
    
        public static GGUIWndTowerBattlePVP instance
        {
            get
            {
                if (null == _g_instance)
                    _g_instance = new GGUIWndTowerBattlePVP();
                return _g_instance;
            }
        }
        ...
        private NPCommonSimplePlayerInfo _m_bossPlayerInfo; // 对手玩家信息 
        ...
        private GGUISubWndCommonBlood _m_heroPowerProgress;
        private NPGGUIWndPlayerIcon _m_bossInfo; //敌方信息
        ...
        public GGUIWndTowerBattlePVP() : base(EALUIWndLayer.NORMAL)
        {
        }
    
        protected override string _monoAssetPath { get => GGUIMonoTowerBattlePVP.assetPath; }
        protected override string _monoObjName { get => GGUIMonoTowerBattlePVP.objName; }
        ...
        protected override void _onWndInitDone()
        {
            ...
            if (wnd.bossInfo != null) _m_bossInfo = new NPGGUIWndPlayerIcon(wnd.bossInfo);
            ...
            {
                _m_heroPowerProgress = new GGUISubWndCommonBlood(wnd.heroPowerSlider);
            }
        ...
        {
            if(null == wnd || null == _m_chapter || _m_result == null)
                return;
            ...
            GCommon.reqPlayerInfo(_m_result.targetPlayerCid, _info =>
            {
                _m_bossPlayerInfo = _info;
                if (_m_bossPlayerInfo != null)
                {
                    if (_m_bossInfo != null)
                    {
                        _m_bossInfo.showWnd();
                        _m_bossInfo.setPlayerInfo(_m_bossPlayerInfo);
                    }

                    if (_m_bossHpProgress != null)
                    {
                        _m_bossHpProgress.showWnd();
                        _m_bossHpProgress.setBloodData(_m_bossPlayerInfo.totalPower, _m_bossPlayerInfo.totalPower);
                    }
                }
            });
            ...
            if (_m_heroPowerProgress != null)
            {
                ...
                _m_heroPowerProgress.setBloodData(totalPower, totalPower);
            }
            ...
            if (null != _m_showCaseVideoBoss )
            {
                ...
                _m_showCaseVideoBoss.setVideoClip(_m_chapter.pvp_boss_go_index.GetRandomItem());
        ...
        private void _onEventReduceHp(float _percentage)
        {
            ...
            _m_heroPowerProgress?.damage(thisRoundDamage);
        ...
        private void _endBattle(Action _onComplete)
        {
            ...
            QueueMgr.instance.forceCloseNodeByTag(UINodeTagConst.C_TOWER_BATTLE_PVP);
            _onComplete?.Invoke();
        }
