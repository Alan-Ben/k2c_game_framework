...
public class GS2GC_002_035_RetCommonRefreshInit : ALBasicProtocolPack._IALProtocolStructure {
/// <summary>
/// 通用刷新信息列表
/// </summary>
private List<Common.CommonFuncObj.CommonFunc_Refresh> infoList;


public GS2GC_002_035_RetCommonRefreshInit() {
	infoList = new List<Common.CommonFuncObj.CommonFunc_Refresh>();
}

public GS2GC_002_035_RetCommonRefreshInit(
	List<Common.CommonFuncObj.CommonFunc_Refresh> _infoList
) {	infoList = _infoList;
}
...
/// 通用刷新信息列表
/// </summary>
public List<Common.CommonFuncObj.CommonFunc_Refresh> getInfoList() { return infoList; }
/// <summary>
/// 通用刷新信息列表
/// </summary>
