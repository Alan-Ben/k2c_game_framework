...
namespace Hotfix
{
    ...
    /// Map & List结构的数据集
    /// </summary>
    public class HotfixRefMapListCore<T> : _ATHotfixBasicRefMapListCore<T> where T : _IBaseHotfixRefObj, new()
    {
        private _AALResourceCore _m_rcResCore;
        private string _m_sAssetPath;
        private string _m_sObjName;

        public HotfixRefMapListCore(_AALResourceCore _resCore, string _assetPath, string _objName)
        {
