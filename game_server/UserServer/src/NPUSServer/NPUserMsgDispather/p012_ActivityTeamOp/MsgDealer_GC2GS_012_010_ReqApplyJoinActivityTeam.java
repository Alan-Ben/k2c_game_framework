...
import GC2GS.p012_ActivityTeamOp.GC2GS_012_010_ReqApplyJoinActivityTeam;
...
public class MsgDealer_GC2GS_012_010_ReqApplyJoinActivityTeam extends NPUserMsgDealer<GC2GS_012_010_ReqApplyJoinActivityTeam>
{
    @Override
    protected void _dealMessage(_ANPUSUserBasicMsgItem _commiter, GC2GS_012_010_ReqApplyJoinActivityTeam _msg)
    {
        ...
        dealer.applyJoinTeam(_msg.getTeamId(), userData.getCid(), userData.makeCrossTeamApplyValueList(), (_result) ->
        {
            if (!_result.isSucc())
            {
            ...
            //返回结果
            _commiter.commitSucRes(US2GCWriter_012_ActivityTeamOp.make_010_RetApplyJoinActivityTeam());
        });
    }
}
