    ...
    internal partial class UniversalGlobalSettingsPanelIMGUI
    {
        ...
        static void DrawMiscSettings(SerializedUniversalRenderPipelineGlobalSettings serialized, Editor owner)
        {
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                ...
                EditorGUILayout.PropertyField(serialized.stripLightCookiesVariants, Styles.stripLightCookiesVariants);
                EditorGUILayout.PropertyField(serialized.forceUseSoftShadowVariants, Styles.forceUseSoftShadowVariants);
                EditorGUILayout.PropertyField(serialized.stripMainLightShadowsCascade, Styles.stripMainLightShadowsCascade);
                EditorGUILayout.PropertyField(serialized.universalRenderPipelineCustomVariantCombineSetting, Styles.universalRenderPipelineCustomVariantCombineSetting);
            }
