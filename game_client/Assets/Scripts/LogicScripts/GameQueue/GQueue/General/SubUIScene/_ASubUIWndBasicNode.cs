...
namespace GOE
{
    ...
    /// </summary>
    public abstract class _ASubUIWndBasicNode : BaseQueueNode
    {
        /// <summary>
        ...
        public _ASubUIWndBasicNode()
            : base(EUIQueueStageType.MAIN)
        {
        }
        public _ASubUIWndBasicNode(string _nodeUITag)
            : base(EUIQueueStageType.MAIN, _nodeUITag)
        {
        }
        public _ASubUIWndBasicNode(EUIQueueStageType _stageType)
            : base(_stageType)
        {
        }
        public _ASubUIWndBasicNode(EUIQueueStageType _stageType, string _nodeUITag)
