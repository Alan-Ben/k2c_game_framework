...
namespace TextureTool
{
    ...
    ***********************************************************************************/
    ...
    {
        // テクスチャ読み込み対象のディレクトリ
        public readonly static string[] TargetDirectories = new string[] { 
            "Assets/Resources/GameRes" ,
            "Assets/Resources/GUI",
        };  
        ...
        public static readonly TextureColumn[] HeaderColumns = new[] {
            ...
            new TextureColumn("Format", 80f), // 8
            new TextureColumn("Sprite Atlas", 105f), // 9
            new TextureColumn("Origin Size", 105f), // 10
