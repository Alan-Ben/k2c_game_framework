...
public class Opt004001PlayerLevelUpBO extends BaseOptLogBo {
    ...
    public static final int FIELD_oriLvl =7;
    @DataBaseField(type = "int(11)", fieldname = "oriLvl", comment = "原先等级")
    private int oriLvl;

    public static final int FIELD_curLvl =8;
    @DataBaseField(type = "int(11)", fieldname = "curLvl", comment = "当前等级")
    private int curLvl;

    public Opt004001PlayerLevelUpBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt004001PlayerLevelUpBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt004001PlayerLevelUpBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `oriLvl`, `curLvl`";
    }

    @Override
    public String getTableName() {
        return "`opt_004_001_player_level_up`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_004_001_player_level_up` ("
                ...
                + "`oriLvl` int(11) NOT NULL DEFAULT '0' COMMENT '原先等级',"
                + "`curLvl` int(11) NOT NULL DEFAULT '0' COMMENT '当前等级',"
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='玩家-升级' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
