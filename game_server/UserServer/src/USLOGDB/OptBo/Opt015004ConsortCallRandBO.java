...
public class Opt015004ConsortCallRandBO extends BaseOptLogBo {
    ...
    public Opt015004ConsortCallRandBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt015004ConsortCallRandBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt015004ConsortCallRandBO(rs));
    }
    ...
    public String getTableName() {
        return "`opt_015_004_consort_call_rand`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_015_004_consort_call_rand` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='妃子-随机邀约' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
