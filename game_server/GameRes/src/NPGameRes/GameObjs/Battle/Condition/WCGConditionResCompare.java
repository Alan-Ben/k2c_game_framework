...
/// </summary>
public class WCGConditionResCompare extends _AWCGBasicBothCondition
{
    ...
    {
        return EWCGBothConditionType.S_COMP;
    }

    public static WCGConditionResCompare readCond(String _str)
    {
        WCGConditionResCompare cond = new WCGConditionResCompare();
