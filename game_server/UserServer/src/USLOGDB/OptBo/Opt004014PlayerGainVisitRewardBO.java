...
public class Opt004014PlayerGainVisitRewardBO extends BaseOptLogBo {
    ...
    public static final int FIELD_curDay =7;
    @DataBaseField(type = "int(11)", fieldname = "curDay", comment = "拜访日期")
    private int curDay;

    public Opt004014PlayerGainVisitRewardBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt004014PlayerGainVisitRewardBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt004014PlayerGainVisitRewardBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `curDay`";
    }

    @Override
    public String getTableName() {
        return "`opt_004_014_player_gain_visit_reward`";
    }
    ...
    public String getItemsValue() {
        ...
        strBuf.append("'").append(curDay).append("', ");
   ...
   @Override
    ...
    // 拜访日期
    public int getCurDay() { return this.curDay; }
    public void setCurDay(BM _bm, int curDay) {
        if(curDay==this.curDay) 
            return;
        this.curDay = curDay; 
        markField(_bm, FIELD_curDay); 
    }
    public void saveCurDay(BM _bm, int curDay) {
        if(curDay==this.curDay) 
            return;
        this.curDay = curDay;
        saveField(_bm, "curDay", curDay);
    }
    ...
    protected String getUpdateKeyValue() {
        ...
        sBuilder.append(" `curDay` = '").append(curDay).append("',");
    ...
    public String getMarkedUpdateKeyValue() {
        ...
        if(isFieldMarked(FIELD_curDay)) sBuilder.append(" `curDay` = '").append(curDay).append("',");
        sBuilder.deleteCharAt(sBuilder.length() - 1);
        return sBuilder.toString();
    }
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_004_014_player_gain_visit_reward` ("
                ...
                + "`curDay` int(11) NOT NULL DEFAULT '0' COMMENT '拜访日期',"
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='玩家-领取拜访奖励' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
