package NPRecordServer.NPGeneralListener;
...
public class NPRCSBasicServerListener extends _AWCGBSReceiverListener
{
    public NPRCSBasicServerListener(_AWCGBasicServer _server, EServerType _serverType, int _serverTypeId)
    {
    ...
    {
        NPRCSGeneralMsgDispather.getInstance().DealProtocol(this, _buf);
    }
    ...
    {
        NPRCSGeneralRequestDispather.getInstance().DealProtocol(_commiter, _buf);
    }
