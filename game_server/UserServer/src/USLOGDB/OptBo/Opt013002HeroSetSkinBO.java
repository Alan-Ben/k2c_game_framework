...
public class Opt013002HeroSetSkinBO extends BaseOptLogBo {
    ...
    public Opt013002HeroSetSkinBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt013002HeroSetSkinBO(rs));
    }
    ...
    public String getTableName() {
        return "`opt_013_002_hero_set_skin`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_013_002_hero_set_skin` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='大臣-大臣设置皮肤' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
