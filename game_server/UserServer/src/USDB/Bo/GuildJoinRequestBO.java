...
@RefBo(isIdAuto= true)
public class GuildJoinRequestBO extends BaseBO {
    ...
    public GuildJoinRequestBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new GuildJoinRequestBO(rs));
    }
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `guild_join_request` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='联盟入盟请求数据' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
