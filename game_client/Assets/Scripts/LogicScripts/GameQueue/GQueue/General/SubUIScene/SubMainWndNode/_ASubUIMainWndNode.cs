...
namespace GOE
{
    ...
    /// </summary>
    public abstract class _ASubUIMainWndNode : _ASubUIWndBasicNode
    {
        //是否纯UI界面
        ...
        public _ASubUIMainWndNode()
            : base()
        {
            _m_bIsOnlyUINode = true;
        }
        public _ASubUIMainWndNode(string _nodeUITag)
            : base(_nodeUITag)
        {
            _m_bIsOnlyUINode = true;
        }
        public _ASubUIMainWndNode(string _nodeUITag, bool _isOnlyUINode)
            : base(_nodeUITag)
        {
            _m_bIsOnlyUINode = _isOnlyUINode;
        }
        public _ASubUIMainWndNode(EUIQueueStageType _stageType, string _nodeUITag)
            : base(_stageType, _nodeUITag)
        {
            _m_bIsOnlyUINode = true;
        }
        public _ASubUIMainWndNode(EUIQueueStageType _stageType, string _nodeUITag, bool _isOnlyUINode)
            : base(_stageType, _nodeUITag)
        {
            _m_bIsOnlyUINode = _isOnlyUINode;
        }
