...
public class Opt019008DinnerJoinBO extends BaseOptLogBo {
    ...
    public Opt019008DinnerJoinBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
        ...
        instanceId = rs.getLong(9);
        costId = rs.getLong(10);
        gainCoin = rs.getLong(11);
        gainScore = rs.getLong(12);
    }

    @Override
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt019008DinnerJoinBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `instanceId`, `costId`, `gainCoin`, `gainScore`";
    }

    @Override
    public String getTableName() {
        return "`opt_019_008_dinner_join`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_019_008_dinner_join` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='宴会-玩家赴宴日志）' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
