...
import NP2SS_RB.p001_ScheduleOp.NP2SS_RB_001_016_ReportUsActivitySchedulePlaying;
 ...
 * @author mj
 */
public class UsActivityReportPlayingToSsTask implements _IALSynTask
{
    ...
    public UsActivityReportPlayingToSsTask(NPUserServer _server, UsActivityScheduleInfo _usSchedule)
    {
        _m_server = _server;
    ...
    public void run()
    {
        ...
        UsActivityReportPlayingToSsTask task = this;

        NP2SS_R_001_016_ReportUsActivitySchedulePlaying proto = new NP2SS_R_001_016_ReportUsActivitySchedulePlaying();
                ...
                ENPSingleServerType.SCHEDULE.ordinal(), proto, new _IWCGCallbackDealer()
        {
            ...
            {
                USLog.error(getUSServer(), "UsActivityReportPlayingToSsTask dealFail, scheduleId:{} errorCode:{}", _m_lScheduleId, _errorCode);
