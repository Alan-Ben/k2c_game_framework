...
namespace ALPackage
{
    class ALCoroutineDealerMgr
    {
        private static ALCoroutineDealerMgr _g_instance = new ALCoroutineDealerMgr();
        public static ALCoroutineDealerMgr instance
        {
            get
            {
                if (null == _g_instance)
                    _g_instance = new ALCoroutineDealerMgr();
        ...
        protected ALCoroutineDealerMgr()
        {
