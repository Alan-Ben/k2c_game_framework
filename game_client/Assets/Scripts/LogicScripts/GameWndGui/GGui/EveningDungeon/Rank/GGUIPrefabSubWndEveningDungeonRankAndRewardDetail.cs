...
namespace GOE
{
    public class GGUIPrefabSubWndEveningDungeonRankAndRewardDetail : _ANPGGUIBasicLoadPrefabSubWnd<GGUIPrefabSubMonoEveningDungeonRankAndRewardDetail>
    {
        ...
        public GGUIPrefabSubWndEveningDungeonRankAndRewardDetail(NPCommonAssetPathInfo _assetPathInfo, Transform _parent) : base(_parent)
        {
        ...
        private void _onCDRefresh()
        {
            ...
            switch (activityState)
            {
                ...
                case EEveningDungeonActivityState.CLOSE:
                    ...
                    transKey = TransKeyConst.eveningDungeon_closing_str;
                    break;
            ...
            {
                ALUGUICommon.setLabelTxt(wnd.txtCD, string.Empty);
            }
            else
            {
