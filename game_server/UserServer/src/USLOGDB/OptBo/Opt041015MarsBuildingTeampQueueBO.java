...
public class Opt041015MarsBuildingTeampQueueBO extends BaseOptLogBo {
    ...
    public Opt041015MarsBuildingTeampQueueBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt041015MarsBuildingTeampQueueBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt041015MarsBuildingTeampQueueBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`";
    }

    @Override
    public String getTableName() {
        return "`opt_041_015_mars_building_teamp_queue`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_041_015_mars_building_teamp_queue` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='火星-火星建筑增加临时建筑队列' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
