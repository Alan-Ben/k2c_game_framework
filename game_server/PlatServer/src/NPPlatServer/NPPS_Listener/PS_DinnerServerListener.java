...
public class PS_DinnerServerListener extends _ANPPSBasicServerListener
{
    private static PS_DinnerServerListener _g_instance = null;

    public static PS_DinnerServerListener getObj()
    {
        return _g_instance;
    }
    ...
    public PS_DinnerServerListener()
    {
        super(EServerType.SINGLE, ENPSingleServerType.DINNER.ordinal());
    }
    ...
    public void login()
    {
        ...
        ALServerLog.Sys("Dinner Server: " + getServerTypeId() + " Login!");
        _g_instance = this;
    }
    ...
    {
        ALServerLog.Sys("Dinner Server: " + getServerTypeId() + " Disconnect!");
        //设置全局变量
        _g_instance = null;
    }
