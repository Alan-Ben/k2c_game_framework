...
public class LogArenaPlayerLeaveBO extends BaseLogBo {
    ...
    public LogArenaPlayerLeaveBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new LogArenaPlayerLeaveBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `event_id`, `guid`, `date_time`, `timestamp`, `instance_id`, `ref_id`, `cid`";
    }

    @Override
    public String getTableName() {
        return "`log_arena_player_leave`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `log_arena_player_leave` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='擂台-主动退出日志' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
