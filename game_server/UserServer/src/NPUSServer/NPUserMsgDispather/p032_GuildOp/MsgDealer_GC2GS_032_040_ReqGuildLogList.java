...
public class MsgDealer_GC2GS_032_040_ReqGuildLogList extends NPUserMsgDealer<GC2GS_032_040_ReqGuildLogList>
{
    @Override
    protected void _dealMessage(_ANPUSUserBasicMsgItem _committer, GC2GS_032_040_ReqGuildLogList  _msg)
    {
        //转化为统一跨服消息进行处理
