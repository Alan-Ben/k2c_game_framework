...
@RefBo(isIdAuto= true)
public class FirstTeamActivityTeamBO extends BaseBO {
    ...
    public FirstTeamActivityTeamBO() {
        id = 0;
        group_id = 0L;
        team_id = 0L;
    }

    public FirstTeamActivityTeamBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new FirstTeamActivityTeamBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `group_id`, `team_id`";
    }

    @Override
    public String getTableName() {
        return "`first_team_activity_team`";
    }
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `first_team_activity_team` ("
