...
import GC2GS.p033_SimpleActivityOp.GC2GS_033_003_ReqEarningsGoalDrawHonorReward;
...
public class MsgDealer_GC2GS_033_003_ReqEarningsGoalDrawHonorReward extends NPUserMsgDealer<GC2GS_033_003_ReqEarningsGoalDrawHonorReward>
{
    @Override
    protected void _dealMessage(_ANPUSUserBasicMsgItem _committer, GC2GS_033_003_ReqEarningsGoalDrawHonorReward _msg)
    {
        ...
        NPPlayerContext context = NPPlayerContext.createNew(ENPGameEvent.DRAW_EARNINGS_GOAL_HONOR_REWARD);
        Result result = activity.drawReward(_committer.getUserData(), EEarningsGoalType.HONOR_REWARD, _msg.getRefId(), context);
        if (!result.isSucc())
        {
        ...
        _committer.commitSucRes(US2GCWriter_033_SimpleActivityOp.make_003_RetEarningsGoalDrawHonorReward());
    }
}
