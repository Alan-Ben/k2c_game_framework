...
public class Opt014015AdultAgreeGroupBO extends BaseOptLogBo {
    ...
    public static final int FIELD_adultId =7;
    @DataBaseField(type = "bigint(20)", fieldname = "adultId", comment = "成年子嗣实例ID")
    private long adultId;

    public static final int FIELD_applyCid =8;
    @DataBaseField(type = "bigint(20)", fieldname = "applyCid", comment = "全服子嗣玩家CID")
    private long applyCid;

    public static final int FIELD_applyAdultId =9;
    @DataBaseField(type = "bigint(20)", fieldname = "applyAdultId", comment = "全服子嗣实例ID")
    private long applyAdultId;

    public Opt014015AdultAgreeGroupBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt014015AdultAgreeGroupBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
        ...
        adultId = rs.getLong(9);
        applyCid = rs.getLong(10);
        applyAdultId = rs.getLong(11);
    }

    @Override
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt014015AdultAgreeGroupBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `adultId`, `applyCid`, `applyAdultId`";
    }

    @Override
    public String getTableName() {
        return "`opt_014_015_adult_agree_group`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_014_015_adult_agree_group` ("
                ...
                + "`applyCid` bigint(20) NOT NULL DEFAULT '0' COMMENT '全服子嗣玩家CID',"
                + "`applyAdultId` bigint(20) NOT NULL DEFAULT '0' COMMENT '全服子嗣实例ID',"
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='成年子嗣-同意全服联姻池' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
