...
namespace GOE
{
    ...
    /// 对话主窗体
    /// </summary>
    public class NPGGUIWndSubDialogue : _ANPGGUIBasicSubWnd<NPGGUIMonoSubDialogue>
    {
        //空列表，用于showcase只加载舞台
        ...
        private Action _m_aDialogEndAction;//对话展示完成回调
        ...
        private long _m_bgMusicInstanceId;//背景音乐实例id
        ...
        public NPGGUIWndSubDialogue(NPGGUIMonoSubDialogue _wnd) : base(_wnd)
        {
            initWnd();
        }
        ...
        public void setInfo(NPDialogueRefObj _refObj, Action _dialogEndAction = null, bool _needAutoPlay = false)
        {
            if (_refObj == null)
            {
                _m_refObj = null;
        ...
        public void setInfo(long _storyId, Action _dialogEndAction = null, bool _needAutoPlay = false)
        {
            _m_refObj = GRefdataCoreMgr.instance.dialogueMap.getRef(_storyId);
            setInfo(_m_refObj, _dialogEndAction, _needAutoPlay);
        }
