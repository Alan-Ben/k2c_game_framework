...
public class LogOfflineRewardTakeBO extends BaseLogBo {
    ...
    public LogOfflineRewardTakeBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        logType = rs.getInt(2);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new LogOfflineRewardTakeBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `logType`, `event_id`, `guid`, `date_time`, `timestamp`, `cid`, `instance_id`";
    }

    @Override
    public String getTableName() {
        return "`log_offline_reward_take`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `log_offline_reward_take` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='离线奖励-领取离线奖励' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
