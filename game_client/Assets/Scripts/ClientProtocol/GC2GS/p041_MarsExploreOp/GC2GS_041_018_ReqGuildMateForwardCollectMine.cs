...
/// 请求攻击联盟分享矿
/// </summary>
public class GC2GS_041_018_ReqGuildMateForwardCollectMine : ALBasicProtocolPack._IALProtocolStructure {
/// <summary>
/// 分享矿数据库ID
/// </summary>
...
public override string ToString() {
	...
	builder.Append("{");
	builder.Append("shareMineDbId").Append(":").Append(shareMineDbId.ToString()).Append(", ");
