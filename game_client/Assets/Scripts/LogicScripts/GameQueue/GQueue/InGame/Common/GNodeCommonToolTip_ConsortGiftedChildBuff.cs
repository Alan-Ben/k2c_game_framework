...
namespace GOE
{
    ...
    /// 妃子卷王子嗣buff通用ToolTip
    /// </summary>
    public class GNodeCommonToolTip_ConsortGiftedChildBuff : BaseQueueNode
    {
        /// <summary>
        ...
        private GGUIWndCommonToolTip_ConsortGiftedChildBuff _m_wndToolTip;
        ...
        public GNodeCommonToolTip_ConsortGiftedChildBuff(long _assetPathId, RectTransform _targetTransRoot, float _intervalX, float _intervalY)
        ...
        public override void EnterNode()
        {
            ...
            {
                _m_wndToolTip = new GGUIWndCommonToolTip_ConsortGiftedChildBuff(_m_sAssetPath, _m_sAssetName);
                _m_wndToolTip.load();
