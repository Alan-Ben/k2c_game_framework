...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    public class PostProcessPass : ScriptableRenderPass
    {
        ...
        private bool m_DirectRenderToFrameBuffer = false;
        ...
        public void Setup(in RenderTextureDescriptor baseDescriptor, in RenderTargetHandle source, bool resolveToScreen, in RenderTargetHandle depth, in RenderTargetHandle internalLut, bool hasFinalPass, bool enableSRGBConversion)
        {
            ...
            m_DirectRenderToFrameBuffer = false;
        }

        public void Setup(in RenderTextureDescriptor baseDescriptor, in RenderTargetHandle source, in RenderTargetHandle dest, bool resolveToScreen, in RenderTargetHandle depth, in RenderTargetHandle internalLut, bool hasFinalPass, bool enableSRGBConversion)
        {
            m_Descriptor = baseDescriptor;
            m_Descriptor.useMipMap = false;
            m_Descriptor.autoGenerateMips = false;
            ...
            m_ResolveToScreen = resolveToScreen;
            m_Destination = dest;
            m_DirectRenderToFrameBuffer = true;
        ...
        void Render(CommandBuffer cmd, ref RenderingData renderingData)
        {
            ...
            using (new ProfilingScope(cmd, ProfilingSampler.Get(URPProfileId.UberPostProcess)))
            {
...
#endif
                {
                    ...
                    // 如果是直接往FrameBuffer里渲染，则需要先清理一下FrameBuffer的深度，否则有些机器深度默认为0的，则会出错
                    if (m_DirectRenderToFrameBuffer)
                    {
                        cmd.ClearRenderTarget(RTClearFlags.DepthStencil, clearColor, 1.0f, 0x00);
                    }
