...
namespace ALPackage
{
     ...
     * 缓存池模板对象
     **/
    public abstract class _AALCacheController<T, TEMP>
    {
        ...
        protected _AALCacheController(int _minCount, int _maxCount)
        {
        ...
        protected _AALCacheController(int _minCount, int _maxCount, int _addUnit)
        {
            _m_tTemplateObj = default(TEMP);
