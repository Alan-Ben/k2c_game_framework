...
namespace GOE
{
    ...
    /// </summary>
    [Serializable]
    public class CommonEventPlotDialogRefObj : _ICommonEventInstanceSubRefObj
    {
        [Ignore]
        public ECommonEventType eventType { get { return ECommonEventType.PLOT_DIALOG; } }
        ...
        public long dialogId { get { return dialog_id; } set { dialog_id = value; } }
        ...
        public static string objName { get { return "refdata_db/common_event_plot_dialog.txt"; } }
        public static string tableName { get { return "common_event_plot_dialog"; } }
    }
}