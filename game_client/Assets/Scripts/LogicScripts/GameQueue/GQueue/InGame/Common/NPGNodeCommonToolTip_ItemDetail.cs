...
namespace GOE
{
    public class NPGNodeCommonToolTip_ItemDetail : BaseQueueNode
    {
        /// <summary>
        ...
        private NPGGUIWndCommonItemToolTip_ItemDetail _m_wndToolTip;

        public NPGNodeCommonToolTip_ItemDetail(string _assetPath, string _assetName, ENPItemType _itemType, long _itemId, RectTransform _targetTransRoot, float _interval)
        ...
        public NPGNodeCommonToolTip_ItemDetail(long _assetPathId, ENPItemType _itemType, long _itemId, RectTransform _targetTransRoot, float _interval)
            : base(EUIQueueStageType.NONE)
        {
        ...
        public override void EnterNode()
        {
            ...
            {
                _m_wndToolTip = new NPGGUIWndCommonItemToolTip_ItemDetail(_m_sAssetPath, _m_sAssetName);
                _m_wndToolTip.load();
                _m_wndToolTip.regLoadDoneDelegate(() =>
                {
                    _m_wndToolTip.showWnd();
                    _m_wndToolTip.setShowData(_m_itemType, _m_itemId, _m_targetTransRoot, _m_interval);
                });
            }
