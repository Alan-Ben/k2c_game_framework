 ...
 *
 */
public class NPGS2US_RB_Callback_RegUserGate implements _IWCGCallbackDealer
{
    ...
    public NPGS2US_RB_Callback_RegUserGate(NPGSGCUSInfo _usInfo)
    {
    ...
    public void dealFail(int _errCode)
    {
        ...
        //返回失败
        _m_glGCListener.send(NPGS2GCWriter_001_BasicOp.make_004_OnUSEnterDone(_errCode, _m_iUSId, _m_lClientInitSerialize));
    }
    ...
    public void dealSuc(_IALProtocolStructure _protocol)
    {
        ...
        //设置用户对应服务器已连接
        _m_glGCListener.onUSRegGSDone(_m_lInfoSerialize, protocolObj.getNewSerialize());
    }
