...
namespace GOE
{
    ...
    /// 物品点击查看详情弹窗
    /// </summary>
    public class NPGGUIWndCommonItemDetail : _ANPGGUIBasicWnd<NPGGUIMonoCommonItemDetail>
    {
        private static NPGGUIWndCommonItemDetail _g_instance;
        public static NPGGUIWndCommonItemDetail instance
        {
            get
            {
                if (_g_instance == null)
                    _g_instance = new NPGGUIWndCommonItemDetail();
                return _g_instance;
            }
        }
        ...
        private NPGGUIWndCommonItemDetail() : base(EALUIWndLayer.ADDITION)
        {

        }

        protected override string _monoAssetPath { get { return NPGGUIMonoCommonItemDetail.assetPath; } }
        protected override string _monoObjName { get { return NPGGUIMonoCommonItemDetail.objName; } }
        ...
        private void _refreshWnd()
        {
            ...
            //持有数量
            ALUGUICommon.setLabelTxt(wnd.txtNum, TextTranslate.instance.getLanguage(TransKeyConst.common_resource_haveNum, GCommon.getItemCount(_m_eItemType, _m_lItemId)));
            //获取途径
