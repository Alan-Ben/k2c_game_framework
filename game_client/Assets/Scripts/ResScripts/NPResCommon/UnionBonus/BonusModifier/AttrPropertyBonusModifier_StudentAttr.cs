...
namespace GOE
{
    ...
    /// 指定相性学生属性加成
    /// </summary>
    public class AttrPropertyBonusModifier_StudentAttr : _AAttrPropertyBonusModifier
    {
         ...
         * @return
         */
        public override EBonusFilterType getFilterType() { return EBonusFilterType.STUDENT_ATTR; }
