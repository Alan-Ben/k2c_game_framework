...
{
	[CustomPropertyDrawer(typeof(RenderObjectsEx.RenderObjectsExSettings), true)]
    internal class RenderObjectsPassExFeatureEditor : PropertyDrawer
    {
	    ...
	    private int m_FilterLines = 6;
	    private int m_FilterLinesSortingLayerAll = 4;
        ...
        private void Init(SerializedProperty property)
        {
            ...
            m_SortingLayerAll = m_FilterSettings.FindPropertyRelative("SortingLayerAll");
            m_FrontSortingLayerID = m_FilterSettings.FindPropertyRelative("FrontSortingLayerID");
            m_BackSortingLayerID = m_FilterSettings.FindPropertyRelative("BackSortingLayerID");
	    ...
	    public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
	    {
		    ...
		    Init(property);
            height += Styles.defaultLineSpace * (m_FiltersFoldout.value ? (m_SortingLayerAll.boolValue ? m_FilterLinesSortingLayerAll:m_FilterLines) : 1);
