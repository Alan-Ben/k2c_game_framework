...
/// 大臣推荐事件初始化
/// </summary>
public class GS2GC_002_024_RetHeroRecommendInit : ALBasicProtocolPack._IALProtocolStructure {
private List<Common.HeroRecommendObj.HeroRecommend_Info> infoList;


public GS2GC_002_024_RetHeroRecommendInit() {
	infoList = new List<Common.HeroRecommendObj.HeroRecommend_Info>();
}

public GS2GC_002_024_RetHeroRecommendInit(
	List<Common.HeroRecommendObj.HeroRecommend_Info> _infoList
) {	infoList = _infoList;
}
...
public List<Common.HeroRecommendObj.HeroRecommend_Info> getInfoList() { return infoList; }
