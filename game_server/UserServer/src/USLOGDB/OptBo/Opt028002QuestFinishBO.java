...
public class Opt028002QuestFinishBO extends BaseOptLogBo {
    ...
    public Opt028002QuestFinishBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt028002QuestFinishBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `quest_id`";
    }

    @Override
    public String getTableName() {
        return "`opt_028_002_quest_finish`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_028_002_quest_finish` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='任务-玩家结束任务' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
