...
public class LogExampleTestBO extends BaseLogBo {
    ...
    public static final int FIELD_date_time =1;
    ...
    public LogExampleTestBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        date_time = rs.getInt(3);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new LogExampleTestBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `date_time`, `timestamp`, `event_id`, `guid`";
    }

    @Override
    public String getTableName() {
        return "`log_example_test`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `log_example_test` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='test' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
