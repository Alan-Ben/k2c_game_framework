...
public class Opt013005HeroUpgradeSkinBO extends BaseOptLogBo {
    ...
    public Opt013005HeroUpgradeSkinBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
        ...
        skin_id = rs.getLong(10);
    }

    @Override
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt013005HeroUpgradeSkinBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `hero_id`, `skin_id`";
    }

    @Override
    public String getTableName() {
        return "`opt_013_005_hero_upgrade_skin`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_013_005_hero_upgrade_skin` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='大臣-大臣升级皮肤' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
