...
namespace GOE
{
    ...
    /// 太空寻宝主页面入口场景
    /// </summary>
    public class MainAdditionTreasureHuntMainEntryTDScene : _ABaseHomeEntryAdditionTDScene
    {
        private static MainAdditionTreasureHuntMainEntryTDScene _g_instance;
        [NotNull] public static MainAdditionTreasureHuntMainEntryTDScene instance { get { return _g_instance ??= new MainAdditionTreasureHuntMainEntryTDScene(); } }
        ...
        public override SceneInfoRefObj sceneRefObj
        {
            get
            {
                return GRefdataCoreMgr.instance.sceneInfoRefCore.getRef(GRefdataCoreMgr.instance.npGeneral.dinner_entry_scene_id);
            }
        }
