...
namespace GOE
{
    ...
    /// 互助建筑操作按钮控制器
    /// </summary>
    public class GGUIWndMarsBuildingAssistOperationBtnsFollowerController : _ATALGGUICommonFollowItemController<GGUIMonoMarsBuildingAssistOperationBtns, GGUIWndMarsBuildingAssistOperationBtnsFollower>
    {
        private readonly GResPathIndex _m_resIndex;
        private _IMarsBuildingView _m_buildingView;


        public GGUIWndMarsBuildingAssistOperationBtnsFollowerController()
        {
            _m_resIndex = new GResPathIndex(7317); // 火星拓展-互助建筑hud
        }
        public GGUIWndMarsBuildingAssistOperationBtnsFollowerController(GResPathIndex _resIndex)
        {
        ...
        protected override GGUIWndMarsBuildingAssistOperationBtnsFollower _createItemWnd(GGUIMonoMarsBuildingAssistOperationBtns _wndMono)
        {
            GGUIWndMarsBuildingAssistOperationBtnsFollower wnd = new GGUIWndMarsBuildingAssistOperationBtnsFollower(_wndMono);
    ...
    /// 互助建筑操作按钮跟随窗口
    /// </summary>
    public class GGUIWndMarsBuildingAssistOperationBtnsFollower : _ATALGGUIWndCommonFollowItem<GGUIMonoMarsBuildingAssistOperationBtns>
    {
        private _IMarsBuildingView _m_buildingView;


        public GGUIWndMarsBuildingAssistOperationBtnsFollower(GGUIMonoMarsBuildingAssistOperationBtns _wnd) : base(_wnd)
        {
            initWnd();
        }
