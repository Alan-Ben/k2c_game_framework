...
namespace GOE
{
    ...
    /// 火星实力变化上浮提示窗体
    /// </summary>
    public class GGUIWndMarsPowerTip : _ANPGGUIBasicWnd<GGUIMonoMarsPowerTip>
    {
        private static GGUIWndMarsPowerTip _g_instance = new GGUIWndMarsPowerTip();
        public static GGUIWndMarsPowerTip instance
        {
            get
            {
                if (null == _g_instance)
                    _g_instance = new GGUIWndMarsPowerTip();
                return _g_instance;
            }
        }

        private long _m_lOpSerialize;
        private Queue<long> _m_insAudioIdQueue;
        private long _m_lCurAddValue;
        private long _m_lTargetAddValue;

        protected GGUIWndMarsPowerTip() : base(EALUIWndLayer.NOTICE)
        {

        }


        protected override string _monoAssetPath { get { return GGUIMonoMarsPowerTip.assetPath; } }
        protected override string _monoObjName { get { return GGUIMonoMarsPowerTip.objName; } }
        ...
        public void setInfo(long _oriValue, long _curValue)
        {
            ...
            ALUGUICommon.setLabelTxt(wnd.txtMarsPower, TextTranslate.instance.getLanguage(key, _curValue.ToLargeString(PrimitiveExtension.ELargeStringType.DEFAULT)));
        ...
        private void _showValueLerp(long _start, long _end)
        {
            ...
            if (_m_lCurAddValue == 0)
                ...
                ALUGUICommon.setLabelTxt(wnd.txtReduceNum, _m_lCurAddValue.ToLargeString(PrimitiveExtension.ELargeStringType.DEFAULT));
            ...
            NPMonoTaskLerpStartEndValueByTime.startLerpTask(() => { return wnd == null || !isShow; }
                ...
                , value =>
                {
                    ...
                    if (value > 0)
                        ALUGUICommon.setLabelTxt(wnd.txtAddNum, value.ToLargeString(PrimitiveExtension.ELargeStringType.DEFAULT));
                    else
                        ALUGUICommon.setLabelTxt(wnd.txtReduceNum, value.ToLargeString(PrimitiveExtension.ELargeStringType.DEFAULT));
                }
