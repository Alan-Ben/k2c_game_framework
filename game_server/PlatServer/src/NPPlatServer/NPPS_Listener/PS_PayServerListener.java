...
public class PS_PayServerListener extends _ANPPSBasicServerListener
{
    private static PS_PayServerListener _g_instance = null;

    public static PS_PayServerListener getObj()
    {
        return _g_instance;
    }
    ...
    public PS_PayServerListener()
    {
        super(EServerType.SINGLE, ENPSingleServerType.PAY.ordinal());
    }
    ...
    public void login()
    {
        ...
        ALServerLog.Sys("Pay Server: " + getServerTypeId() + " Login!");
        _g_instance = this;
    }
    ...
    {
        ALServerLog.Sys("Pay Server: " + getServerTypeId() + " Disconnect!");
        //设置全局变量
        _g_instance = null;
    }
