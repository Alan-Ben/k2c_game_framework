...
import GC2GS.p012_ActivityTeamOp.GC2GS_012_014_ReqRefuseActivityTeamApply;
...
public class MsgDealer_GC2GS_012_014_ReqRefuseActivityTeamApply extends NPUserMsgDealer<GC2GS_012_014_ReqRefuseActivityTeamApply>
{
    @Override
    protected void _dealMessage(_ANPUSUserBasicMsgItem _commiter, GC2GS_012_014_ReqRefuseActivityTeamApply _msg)
    {
        ...
        // 拒绝申请
        dealer.refuseTeamApply(_msg.getTeamId(), userData.getCid(), _msg.getApplyCid(), result ->
        {
            if (!result.isSucc())
            {
            ...
            _commiter.commitSucRes(US2GCWriter_012_ActivityTeamOp.make_014_RetRefuseActivityTeamApply());
        });
    }
}
