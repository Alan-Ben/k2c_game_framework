...
{
    //奖励预览跟随Node
    public class GNodeCommonToolTip_RewardPreview : BaseQueueNode
    {
        /// <summary>
        ...
        private GGUIWndCommonItemToolTip_RewardPreview _m_wndToolTip;

        public GNodeCommonToolTip_RewardPreview(long _resPathId,string _titleStr, string _contentStr, List<NPCommonCostItem> _itemList, RectTransform _targetTransRoot, Vector2 _interval)
        ...
        public override void EnterNode()
        {
            ...
            {
                _m_wndToolTip = new GGUIWndCommonItemToolTip_RewardPreview(
                ...
                {
                    _m_wndToolTip.setData(_m_titleStr, _m_contentStr, _m_itemList, _m_targetTransRoot, _m_interval);
                });
            }
