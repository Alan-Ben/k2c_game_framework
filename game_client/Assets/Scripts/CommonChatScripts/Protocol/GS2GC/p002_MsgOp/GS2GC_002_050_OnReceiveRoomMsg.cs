...
/// 推送聊天消息
/// </summary>
public class GS2GC_002_050_OnReceiveRoomMsg : ALBasicProtocolPack._IALProtocolStructure {
/// <summary>
/// 消息内容
/// </summary>
private Common.CommObj.RoomMsg msg;


public GS2GC_002_050_OnReceiveRoomMsg() {
	msg = new Common.CommObj.RoomMsg();
}

public GS2GC_002_050_OnReceiveRoomMsg(
	Common.CommObj.RoomMsg _msg
) {	msg = _msg;
}
...
/// 消息内容
/// </summary>
public Common.CommObj.RoomMsg getMsg() { return msg; }
/// <summary>
/// 消息内容
/// </summary>
public void setMsg(Common.CommObj.RoomMsg _msg) { msg = _msg; }
