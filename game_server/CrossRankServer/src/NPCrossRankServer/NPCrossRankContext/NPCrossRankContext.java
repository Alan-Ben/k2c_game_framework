package NPCrossRankServer.NPCrossRankContext;
...
// * 
////////////// */
public class NPCrossRankContext implements _IContext
{
     ...
     * @return
     */
    public static NPCrossRankContext createNew(ENPGameEvent _event)
    {
        NPCrossRankContext newContext = new NPCrossRankContext();
        //初始化上下文
     ...
     * @return
     */
    public NPCrossRankContext duplicate()
    {
        NPCrossRankContext context = new NPCrossRankContext();
