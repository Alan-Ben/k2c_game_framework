package NPHttpServer.NPGeneralListener;
...
public class NPHSBasicServerListener extends _AWCGBSReceiverListener
{
    public NPHSBasicServerListener(_AWCGBasicServer _server, EServerType _serverType, int _serverTypeId)
    {
    ...
    {
        NPHSGeneralMsgDispather.getInstance().DealProtocol(this, _buf);
    }
    ...
    {
        NPHSGeneralRequestDispather.getInstance().DealProtocol(_commiter, _buf);
    }
