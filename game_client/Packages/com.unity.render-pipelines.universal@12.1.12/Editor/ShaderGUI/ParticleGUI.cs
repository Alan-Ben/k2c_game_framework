    ...
    public static class ParticleGUI
    {
        ...
        public struct ParticleProperties
        {
            ...
            public ParticleProperties(MaterialProperty[] properties)
            {
                ...
                // Advanced Props
                flipbookMode = BaseShaderGUI.FindProperty("_FlipbookBlending", properties, false);
                softParticlesEnabled = BaseShaderGUI.FindProperty("_SoftParticlesEnabled", properties, false);
                cameraFadingEnabled = BaseShaderGUI.FindProperty("_CameraFadingEnabled", properties, false);
                distortionEnabled = BaseShaderGUI.FindProperty("_DistortionEnabled", properties, false);
                softParticlesNearFadeDistance = BaseShaderGUI.FindProperty("_SoftParticlesNearFadeDistance", properties, false);
                softParticlesFarFadeDistance = BaseShaderGUI.FindProperty("_SoftParticlesFarFadeDistance", properties, false);
                cameraNearFadeDistance = BaseShaderGUI.FindProperty("_CameraNearFadeDistance", properties, false);
                cameraFarFadeDistance = BaseShaderGUI.FindProperty("_CameraFarFadeDistance", properties, false);
