...
import GC2GS.p012_ActivityTeamOp.GC2GS_012_012_ReqSelfActivityTeamApplyList;
...
public class MsgDealer_GC2GS_012_012_ReqSelfActivityTeamApplyList extends NPUserMsgDealer<GC2GS_012_012_ReqSelfActivityTeamApplyList>
{
    @Override
    protected void _dealMessage(_ANPUSUserBasicMsgItem _commiter, GC2GS_012_012_ReqSelfActivityTeamApplyList _msg)
    {
        ...
        dealer.getPlayerTeamApplyList(userData.getCid(), (_result, _applyList) ->
        {
            if (!_result.isSucc())
            {
            ...
            _commiter.commitSucRes(US2GCWriter_012_ActivityTeamOp.make_012_RetSelfActivityTeamApplyList(_applyList));
        });
    }
}
