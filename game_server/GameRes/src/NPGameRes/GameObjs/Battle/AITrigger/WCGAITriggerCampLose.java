...
/// </summary>
public class WCGAITriggerCampLose extends _AWCGBasicAITrigger
{
    ...
    public static WCGAITriggerCampLose read(String _infoStr)
    {
        WCGAITriggerCampLose obj = new WCGAITriggerCampLose();
        try
        {
        ...
        {
            CommLog.error("ai camp_lose配置错误 正确配置:阵营id");
            return null;
        }
    }
}