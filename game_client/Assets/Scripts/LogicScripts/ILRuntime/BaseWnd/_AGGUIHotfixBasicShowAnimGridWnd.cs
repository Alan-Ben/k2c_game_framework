...
namespace GOE
{
    public abstract class _AGGUIHotfixBasicShowAnimGridWnd<_T_ITEM_WND> : _AGGUIHotfixBasicGridWnd<_T_ITEM_WND> where _T_ITEM_WND : _AGGUIHotfixBasicGridItemWnd
    {
        public _AGGUIHotfixBasicShowAnimGridWnd(GGUIHotfixGridMono _wnd) : base(_wnd)
        {
