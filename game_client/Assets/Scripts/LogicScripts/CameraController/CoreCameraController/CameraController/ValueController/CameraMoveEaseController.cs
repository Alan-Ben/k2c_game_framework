...
namespace GOE
{
    public class CameraMoveEaseController : _ACameraMoveController
    {
        ...
        public CameraMoveEaseController(Vector3 _targetPos, EaseType _easeType, float _totalTime, Action _complete = null)
        {
        ...
        public CameraMoveEaseController(Vector3 _targetPos, float _totalTime, Action _complete = null)
        {
            _m_targetPos = _targetPos;
