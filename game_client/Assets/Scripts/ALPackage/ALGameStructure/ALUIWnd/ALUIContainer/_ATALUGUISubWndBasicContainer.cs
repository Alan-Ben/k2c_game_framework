...
namespace ALPackage
{
    public abstract class _ATALUGUISubWndBasicContainer<_T_ITEM_MONO, _T_CONTAINER_MONO, _T_ITEM_WND> : _ATALBasicUISubWnd<_T_CONTAINER_MONO>
        ...
        where _T_ITEM_WND : _ATALBasicUISubWnd<_T_ITEM_MONO>
    {
        ...
        protected _ATALUGUISubWndBasicContainer(_T_CONTAINER_MONO _containerMono)
            : base(_containerMono)
        {
        ...
        {
            return addItemWnd(wnd.itemTemplate);
        }
        public _T_ITEM_WND addItemWnd(_T_ITEM_MONO _templateWndMono)
        {
            //判断对应数据是否有效
            ...
            //实例化一个子窗口对象
            _T_ITEM_MONO itemWndObj = _instantiateItemMono(_templateWndMono);
            //创建一个子窗口管理对象
