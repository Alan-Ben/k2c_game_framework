...
public class GS2GC_012_011_RetActivityTeamApplyList : ALBasicProtocolPack._IALProtocolStructure {
private List<Common.CrossTeamObj.CrossTeam_ApplyInfo> applyList;


public GS2GC_012_011_RetActivityTeamApplyList() {
	applyList = new List<Common.CrossTeamObj.CrossTeam_ApplyInfo>();
}

public GS2GC_012_011_RetActivityTeamApplyList(
	List<Common.CrossTeamObj.CrossTeam_ApplyInfo> _applyList
...
public List<Common.CrossTeamObj.CrossTeam_ApplyInfo> getApplyList() { return applyList; }
