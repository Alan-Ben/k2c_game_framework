...
namespace GOE
{
    ...
    /// 联盟排行前几名信息附加窗口
    /// </summary>
    public class GGUIWndGuildRankFixedTopGuildInfo : _AGGUIWndBaseSubRankGuildInfo<GGUIMonoGuildRankFixedTopGuildInfo, GuildRankInfo>
    {
        public GGUIWndGuildRankFixedTopGuildInfo(GGUIMonoGuildRankFixedTopGuildInfo _wnd) : base(_wnd)
        {
            initWnd();
        }
