...
public class GS2GC_007_017_RetStageGoalFirstReachBaseInfo implements ALBasicProtocolPack._IALProtocolStructure {
/** 顶级玩家信息 */
...
public final void ReadUnzipBuf(ByteBuffer _buf, int _finalPos) {
	...
	int _topInfoCurPos = _buf.position();
	topInfo.ReadUnzipBuf(_buf, _topInfoCurPos + _topInfoCustLen);
	_buf.position(_topInfoCurPos + _topInfoCustLen);
