...
import GC2GS.p007_CommOp.GC2GS_007_033_ReqStoreReviewsRecordRoast;
...
public class MsgDealer_GC2GS_007_033_ReqStoreReviewsRecordRoast extends NPUserMsgDealer<GC2GS_007_033_ReqStoreReviewsRecordRoast> 
{
	@Override
	protected void _dealMessage(_ANPUSUserBasicMsgItem _commiter, GC2GS_007_033_ReqStoreReviewsRecordRoast _msg) 
	{
		...
		//记录玩家评价内容
		userData.getPlayerComponent().setStoreReviewsContent(_msg.getContent());
		...
		_commiter.commitSucRes(US2GCWriter_007_CommOp.make_033_RetStoreReviewsRecordRoast());
	}
}
