...
{
#if AL_SQLITE
    public class ALBasicSqliteListCacheRefCore<T> : _ATALBasicSqliteListCacheCore<T> where T : new()
    {
        ...
        public ALBasicSqliteListCacheRefCore(_AALSqliteMgr _sqliteMgr, string _assetPath, string _objName, string _tableName, string _keyName)
        {
