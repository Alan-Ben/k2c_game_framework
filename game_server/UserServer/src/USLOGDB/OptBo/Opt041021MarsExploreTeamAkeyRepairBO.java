...
public class Opt041021MarsExploreTeamAkeyRepairBO extends BaseOptLogBo {
    ...
    public Opt041021MarsExploreTeamAkeyRepairBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt041021MarsExploreTeamAkeyRepairBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt041021MarsExploreTeamAkeyRepairBO(rs));
    }
    ...
    public String getTableName() {
        return "`opt_041_021_mars_explore_team_akey_repair`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_041_021_mars_explore_team_akey_repair` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='火星-火星队伍一键修复' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
