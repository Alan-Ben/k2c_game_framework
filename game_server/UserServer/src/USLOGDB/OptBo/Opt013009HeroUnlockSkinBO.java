...
public class Opt013009HeroUnlockSkinBO extends BaseOptLogBo {
    ...
    public Opt013009HeroUnlockSkinBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt013009HeroUnlockSkinBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt013009HeroUnlockSkinBO(rs));
    }
    ...
    public String getTableName() {
        return "`opt_013_009_hero_unlock_skin`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_013_009_hero_unlock_skin` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='大臣-大臣解锁皮肤' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
