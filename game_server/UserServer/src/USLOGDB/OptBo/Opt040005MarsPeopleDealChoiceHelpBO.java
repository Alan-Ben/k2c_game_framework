...
public class Opt040005MarsPeopleDealChoiceHelpBO extends BaseOptLogBo {
    ...
    public static final int FIELD_helpId =7;
    @DataBaseField(type = "bigint(20)", fieldname = "helpId", comment = "帮助ID")
    private long helpId;

    public Opt040005MarsPeopleDealChoiceHelpBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt040005MarsPeopleDealChoiceHelpBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt040005MarsPeopleDealChoiceHelpBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `helpId`";
    }

    @Override
    public String getTableName() {
        return "`opt_040_005_mars_people_deal_choice_help`";
    }
    ...
    public String getItemsValue() {
        ...
        strBuf.append("'").append(helpId).append("', ");
   ...
   @Override
    ...
    // 帮助ID
    public long getHelpId() { return this.helpId; }
    public void setHelpId(BM _bm, long helpId) {
        if(helpId==this.helpId) 
            return;
        this.helpId = helpId; 
        markField(_bm, FIELD_helpId); 
    }
    public void saveHelpId(BM _bm, long helpId) {
        if(helpId==this.helpId) 
            return;
        this.helpId = helpId;
        saveField(_bm, "helpId", helpId);
    }
    ...
    protected String getUpdateKeyValue() {
        ...
        sBuilder.append(" `helpId` = '").append(helpId).append("',");
    ...
    public String getMarkedUpdateKeyValue() {
        ...
        if(isFieldMarked(FIELD_helpId)) sBuilder.append(" `helpId` = '").append(helpId).append("',");
        sBuilder.deleteCharAt(sBuilder.length() - 1);
        return sBuilder.toString();
    }
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_040_005_mars_people_deal_choice_help` ("
                ...
                + "`helpId` bigint(20) NOT NULL DEFAULT '0' COMMENT '帮助ID',"
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='火星-处理帮助事件（选择）' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
