...
public class LogArenaUnlockBO extends BaseLogBo {
    ...
    @DataBaseField(type = "bigint(20)", fieldname = "earnings", comment = "收益")
    private long earnings;

    public static final int FIELD_power =8;
    @DataBaseField(type = "bigint(20)", fieldname = "power", comment = "战力")
    private long power;

    public LogArenaUnlockBO() {
        id = 0;
        cid = 0L;
        logType = 0;
        event_id = 0;
    ...
    public LogArenaUnlockBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        logType = rs.getInt(3);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new LogArenaUnlockBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `logType`, `event_id`, `guid`, `date_time`, `timestamp`, `level`, `earnings`, `power`";
    }

    @Override
    public String getTableName() {
        return "`log_arena_unlock`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `log_arena_unlock` ("
                ...
                + "`earnings` bigint(20) NOT NULL DEFAULT '0' COMMENT '收益',"
                + "`power` bigint(20) NOT NULL DEFAULT '0' COMMENT '战力',"
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='竞技场解锁日志' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
