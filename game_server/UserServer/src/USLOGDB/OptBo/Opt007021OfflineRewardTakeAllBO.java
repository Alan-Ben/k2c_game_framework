...
public class Opt007021OfflineRewardTakeAllBO extends BaseOptLogBo {
    ...
    public static final int FIELD_instance_id_list =7;
    @DataBaseField(type = "text", fieldname = "instance_id_list", comment = "实例id列表")
    private String instance_id_list;

    public Opt007021OfflineRewardTakeAllBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt007021OfflineRewardTakeAllBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
        ...
        instance_id_list = rs.getString(9);
    }

    @Override
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt007021OfflineRewardTakeAllBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `instance_id_list`";
    }

    @Override
    public String getTableName() {
        return "`opt_007_021_offline_reward_take_all`";
    }
    ...
    public String getItemsValue() {
        ...
        strBuf.append("'").append(instance_id_list == null ? null : instance_id_list.replace("'","''").replace("\\","\\\\")).append("', ");
   ...
   @Override
    ...
    // 实例id列表
    public String getInstanceIdList() { return this.instance_id_list; }
    public void setInstanceIdList(BM _bm, String instance_id_list) {
        if(instance_id_list.equals(this.instance_id_list)) 
            return;
        this.instance_id_list = instance_id_list; 
        markField(_bm, FIELD_instance_id_list); 
    }
    public void saveInstanceIdList(BM _bm, String instance_id_list) {
        if(instance_id_list.equals(this.instance_id_list)) 
            return;
        this.instance_id_list = instance_id_list;
        saveField(_bm, "instance_id_list", instance_id_list);
    }
    ...
    protected String getUpdateKeyValue() {
        ...
        sBuilder.append(" `instance_id_list` = '").append(instance_id_list == null ? null : instance_id_list.replace("'","''").replace("\\","\\\\")).append("',");
    ...
    public String getMarkedUpdateKeyValue() {
        ...
        if(isFieldMarked(FIELD_instance_id_list)) sBuilder.append(" `instance_id_list` = '").append(instance_id_list == null ? null : instance_id_list.replace("'","''").replace("\\","\\\\")).append("',");
        sBuilder.deleteCharAt(sBuilder.length() - 1);
        return sBuilder.toString();
    }
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_007_021_offline_reward_take_all` ("
                ...
                + "`instance_id_list` text NULL COMMENT '实例id列表',"
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='离线奖励-玩家领取离线奖励' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
    ...
    private int getBufferSize()
    {
        ...
        _size+=4;//date_time
        _size+=4;//timestamp
        _size += ALBasicProtocolPack.ALProtocolCommon.GetStringBufSize(instance_id_list);//instance_id_list
         return _size;
    }
    ...
    public ByteBuffer toByteBuffer()
    {
        ...
        ALBasicProtocolPack.ALProtocolCommon.PutStringIntoBuf(buff, instance_id_list);        
        return buff;
    }
    ...
    protected void readFromByteBuffer(ByteBuffer buff)
    {
        ...
        instance_id_list=ALBasicProtocolPack.ALProtocolCommon.GetStringFromBuf(buff); 
    }
