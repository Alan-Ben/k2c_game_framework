...
public class PS_RCSListener extends _ANPPSBasicServerListener
{
    private static PS_RCSListener _g_instance = null;

    public static PS_RCSListener getObj()
    {
        return _g_instance;
    }
    ...
    public PS_RCSListener()
    {
        super(EServerType.SINGLE, ENPSingleServerType.RECORD.ordinal());
    }
    ...
    public void login()
    {
        ...
        ALServerLog.Sys("Record Server: " + getServerTypeId() + " Login!");
        _g_instance = this;
    }
    ...
    {
        ALServerLog.Sys("Record Server: " + getServerTypeId() + " Disconnect!");
        //设置全局变量
        _g_instance = null;
    }
