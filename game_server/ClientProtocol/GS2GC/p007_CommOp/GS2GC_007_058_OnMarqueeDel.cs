...
public class GS2GC_007_058_OnMarqueeDel : ALBasicProtocolPack._IALProtocolStructure {
...
public override string ToString() {
	...
	builder.Append("{");
	builder.Append("marqueeDbid").Append(":").Append(marqueeDbid.ToString()).Append(", ");
	builder.Append("}");
