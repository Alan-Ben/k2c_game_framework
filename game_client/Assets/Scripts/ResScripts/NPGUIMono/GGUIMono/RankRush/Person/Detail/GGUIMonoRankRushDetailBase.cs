...
namespace GOE
{
    ...
    /// 页签类型
    /// </summary>
    public enum ERankRushDetailTabType
    {
    ...
    /// </summary>
    [System.Serializable]
    public class GGUIRankRushDetailTabMono
    {
        [ALHeader("页签类型")]
        public ERankRushDetailTabType tabType;
        [ALHeader("通用页签脚本")]
    ...
    /// 冲榜详情主界面
    /// </summary>
    public class GGUIMonoRankRushDetailBase : _ANPBasicUIWndResBarMono
    {
        [ALHeader("关闭按钮")]
        ...
        public List<GGUIMonoRankRushTopPlayerInfo> monoTopPlayerList;
        [ALHeader("倒计时")]
        public Text txtCD;
        [ALHeader("我的排名")]
