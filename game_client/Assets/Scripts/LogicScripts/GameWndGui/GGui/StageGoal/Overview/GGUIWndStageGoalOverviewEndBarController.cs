...
namespace GOE
{
    ...
    /// 阶段目标预览结束bar控制器
    /// </summary>
    public class GGUIWndStageGoalOverviewEndBarController : _AALUGUIGridBarController
    {
        private GGUIWndStageGoalOverviewEndBar _m_wBarWnd;//显示的窗体

        public GGUIWndStageGoalOverviewEndBarController(Transform _parent) : base()
        {
            _m_wBarWnd = new GGUIWndStageGoalOverviewEndBar(_parent);
            _m_wBarWnd.load();
        }
