...
public class Opt039021MarsTechConfirmUpgradeBO extends BaseOptLogBo {
    ...
    public static final int FIELD_pre_lvl =8;
    @DataBaseField(type = "int(11)", fieldname = "pre_lvl", comment = "升级前等级")
    private int pre_lvl;

    public static final int FIELD_cur_lvl =9;
    @DataBaseField(type = "int(11)", fieldname = "cur_lvl", comment = "升级后等级")
    private int cur_lvl;

    public Opt039021MarsTechConfirmUpgradeBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt039021MarsTechConfirmUpgradeBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
        ...
        pre_lvl = rs.getInt(10);
        cur_lvl = rs.getInt(11);
    }

    @Override
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt039021MarsTechConfirmUpgradeBO(rs));
    }

    @Override
    public String getItemsName() {
        return "`id`, `cid`, `level`, `vip_lvl`, `event_id`, `guid`, `date_time`, `timestamp`, `tech_id`, `pre_lvl`, `cur_lvl`";
    }

    @Override
    public String getTableName() {
        return "`opt_039_021_mars_tech_confirm_upgrade`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_039_021_mars_tech_confirm_upgrade` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='火星-科技确认升级' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
