 ...
 * 处理博彩游历事件请求
 */
public class MsgDealer_GC2GS_008_011_ReqDealGamblingTravel extends NPUserMsgDealer<GC2GS_008_011_ReqDealGamblingTravel>
{
    @Override
    protected void _dealMessage(_ANPUSUserBasicMsgItem _commiter, GC2GS_008_011_ReqDealGamblingTravel _msg)
    {
        ...
        // 处理博彩游历事件
        TravelEventDealerResult result = TravelEventDealerMgr.getInstance().dealEvent(ETravelEventType.GAMBLING, info, _msg, context);
        if (!result.isSucc())
        {
        ...
        _commiter.commitSucRes(US2GCWriter_008_TravelOp.make_011_RetDealGamblingTravel(result.getEventResult()));
