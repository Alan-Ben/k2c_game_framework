...
/// 联盟火星求助信息
/// </summary>
public class Guild_MarsHelpInfo : ALBasicProtocolPack._IALProtocolStructure {
/// <summary>
/// 求助实例ID
/// </summary>
private long id;
...
public override string ToString() {
	...
	builder.Append("dealSecs").Append(":").Append(dealSecs.ToString()).Append(", ");
