...
namespace GOE
{
    public class ScrollerSmoothMoveTaskVertical : _IALBaseMonoTask
    {
        // 相对缓冲
        ...
        public ScrollerSmoothMoveTaskVertical(_IScrollerSmoothMovable _gridCtrl, float _targetVerticalRate, float _smoothTime = 0.25f, Action _complete = null)
        {
            // 防止组件移动导致滑动失效
            _gridCtrl.scrollRect.StopMovement();
            //_gridCtrl.scrollRect.verticalNormalizedPosition = Mathf.Clamp01(_gridCtrl.scrollRect.verticalNormalizedPosition);

            _m_fSmoothVelocity = 0;
            _m_fSmoothTime = _smoothTime;
            _m_fTargetValue = _targetVerticalRate;
            _m_complete = _complete;
            _m_fCurrentValue = _gridCtrl.scrollRect.verticalNormalizedPosition;
        ...
        public void deal()
        {
            if (null == _m_wndGridCtrl
                ...
                || !_approximately(_m_fCurrentValue, _m_wndGridCtrl.scrollRect.verticalNormalizedPosition)
            ...
            if (!_isOver())
            {
                ...
                _m_wndGridCtrl.scrollRect.verticalNormalizedPosition = _m_fCurrentValue;
            ...
            {
                _m_wndGridCtrl.scrollRect.verticalNormalizedPosition = _m_fTargetValue;
                _m_complete?.Invoke();
            }
        }
    ...
    public class ScrollerEaseMoveTaskVertical : _IALBaseMonoTask
    {
        ...
        public ScrollerEaseMoveTaskVertical(_IScrollerSmoothMovable _gridCtrl, float _targetVerticalRate, EaseType _easeType, float _totalTime = 0.3f, Action _complete = null)
        {
            _gridCtrl.scrollRect.StopMovement();
            ...
            _m_targetValue = _targetVerticalRate;
            _m_startValue = _gridCtrl.scrollRect.verticalNormalizedPosition;
            _m_lSerialize = _gridCtrl.serialize;
        ...
        public void deal()
        {
            ...
            if (_m_curTime < _m_totalTime)
            {
                ...
                _m_gridCtrl.scrollRect.verticalNormalizedPosition = value;
            ...
            {
                _m_gridCtrl.scrollRect.verticalNormalizedPosition = _m_targetValue;
                _m_complete?.Invoke();
            }
        }
    }
