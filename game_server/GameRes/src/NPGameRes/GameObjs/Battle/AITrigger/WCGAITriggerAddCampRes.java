...
//增加阵营资源
public class WCGAITriggerAddCampRes extends _AWCGBasicAITrigger
{
    //资源枚举
    ...
    {
        return EWCGAITriggerType.ADD_CAMP_RES;
    }


    public static WCGAITriggerAddCampRes read(String _str)
    {
        WCGAITriggerAddCampRes effectObj = new WCGAITriggerAddCampRes();
        //解析字符串
