...
public class Opt013006HeroUpgradeTalentSkillBO extends BaseOptLogBo {
    ...
    public Opt013006HeroUpgradeTalentSkillBO() {
        id = 0;
        cid = 0L;
        level = 0;
        vip_lvl = 0;
    ...
    public Opt013006HeroUpgradeTalentSkillBO(ResultSet rs) throws Exception {
        id = rs.getLong(1);
        cid = rs.getLong(2);
        level = rs.getInt(3);
        vip_lvl = rs.getInt(4);
    ...
    public void getFromResultSet(ResultSet rs, List list) throws Exception {
        list.add(new Opt013006HeroUpgradeTalentSkillBO(rs));
    }
    ...
    public String getTableName() {
        return "`opt_013_006_hero_upgrade_talent_skill`";
    }
   ...
   @Override
    ...
    public static String getSql_TableCreate() {
        String sql = "CREATE TABLE IF NOT EXISTS `opt_013_006_hero_upgrade_talent_skill` ("
                ...
                + "PRIMARY KEY (`id`)"
                + ") COMMENT='大臣-大臣升级天赋技能' engine=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci AUTO_INCREMENT=1";
        return sql;
    }
