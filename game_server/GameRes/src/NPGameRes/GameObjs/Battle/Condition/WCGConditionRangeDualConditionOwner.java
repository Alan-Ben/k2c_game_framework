...
/// </summary>
public class WCGConditionRangeDualConditionOwner extends _AWCGBasicSingleCondition
{
    ...
    {
        return EWCGSingleConditionType.RNG_D_O_COND;
    }

    public static WCGConditionRangeDualConditionOwner read(String _infoStr)
    {
        WCGConditionRangeDualConditionOwner obj = new WCGConditionRangeDualConditionOwner();
        ...
        {
            CommLog.error("条件配置错误 - RNG_D_O_COND example: enum:range:enemy_type:conditionStr Error Str: " + _infoStr, e);
            return null;
        }
    }
}